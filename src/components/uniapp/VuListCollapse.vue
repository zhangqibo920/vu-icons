...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M10 5h11m-11 7h11m-11 7h11M3 10l3-3-3-3m0 16l3-3-3-3"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 5h11m-11 7h11m-11 7h11M3 10l3-3-3-3m0 16l3-3-3-3"/>
  </svg>
  <!-- #endif -->
