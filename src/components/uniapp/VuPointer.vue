...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M22 14a8 8 0 01-8 8m4-11v-1a2 2 0 00-2-2 2 2 0 00-2 2m0 0V9a2 2 0 00-2-2 2 2 0 00-2 2v1m0-.5V4a2 2 0 00-2-2 2 2 0 00-2 2v10"/><path d="M18 11a2 2 0 114 0v3a8 8 0 01-8 8h-2c-2.8 0-4.5-.86-5.99-2.34l-3.6-3.6a2 2 0 012.83-2.82L7 15"/>`
...
<template>
  ...
  >
    ...
    <path d="M22 14a8 8 0 01-8 8m4-11v-1a2 2 0 00-2-2 2 2 0 00-2 2m0 0V9a2 2 0 00-2-2 2 2 0 00-2 2v1m0-.5V4a2 2 0 00-2-2 2 2 0 00-2 2v10"/><path d="M18 11a2 2 0 114 0v3a8 8 0 01-8 8h-2c-2.8 0-4.5-.86-5.99-2.34l-3.6-3.6a2 2 0 012.83-2.82L7 15"/>
  </svg>
  <!-- #endif -->
