...
const bgStyle = computed(() => {
  ...
  const svgContent = `<circle cx="5" cy="6" r="3"/><path d="M12 6h5a2 2 0 012 2v7"/><path d="M15 9l-3-3 3-3"/><circle cx="19" cy="18" r="3"/><path d="M12 18H7a2 2 0 01-2-2V9"/><path d="M9 15l3 3-3 3"/>`
...
<template>
  ...
  >
    ...
    <circle cx="5" cy="6" r="3"/><path d="M12 6h5a2 2 0 012 2v7"/><path d="M15 9l-3-3 3-3"/><circle cx="19" cy="18" r="3"/><path d="M12 18H7a2 2 0 01-2-2V9"/><path d="M9 15l3 3-3 3"/>
  </svg>
  <!-- #endif -->
