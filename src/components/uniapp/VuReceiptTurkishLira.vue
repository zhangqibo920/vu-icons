...
const name = 'VuReceiptTurkishLira'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M10 6.5v11a5.5 5.5 0 005.5-5.5M14 8l-6 3"/><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1z"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 6.5v11a5.5 5.5 0 005.5-5.5M14 8l-6 3"/><path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1z"/>
  </svg>
  <!-- #endif -->
