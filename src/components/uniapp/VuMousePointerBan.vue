...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M2.034 2.681a.498.498 0 01.647-.647l9 3.5a.5.5 0 01-.033.944L8.204 7.545a1 1 0 00-.66.66l-1.066 3.443a.5.5 0 01-.944.033z"/><circle cx="16" cy="16" r="6"/><path d="M11.8 11.8l8.4 8.4"/>`
...
<template>
  ...
  >
    ...
    <path d="M2.034 2.681a.498.498 0 01.647-.647l9 3.5a.5.5 0 01-.033.944L8.204 7.545a1 1 0 00-.66.66l-1.066 3.443a.5.5 0 01-.944.033z"/><circle cx="16" cy="16" r="6"/><path d="M11.8 11.8l8.4 8.4"/>
  </svg>
  <!-- #endif -->
