...
const name = 'VuCircleArrowOutDownRight'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 22a10 10 0 1110-10m0 10L12 12m10 4v6h-6"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 22a10 10 0 1110-10m0 10L12 12m10 4v6h-6"/>
  </svg>
  <!-- #endif -->
