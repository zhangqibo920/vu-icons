...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M16 13l5.223 3.482a.5.5 0 00.777-.416V7.87a.5.5 0 00-.752-.432L16 10.5"/><rect width="14" height="12" x="2" y="6" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M16 13l5.223 3.482a.5.5 0 00.777-.416V7.87a.5.5 0 00-.752-.432L16 10.5"/><rect width="14" height="12" x="2" y="6" rx="2"/>
  </svg>
  <!-- #endif -->
