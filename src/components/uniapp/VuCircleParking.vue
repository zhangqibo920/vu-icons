...
const bgStyle = computed(() => {
  ...
  const svgContent = `<circle cx="12" cy="12" r="10"/><path d="M9 17V7h4a3 3 0 010 6H9"/>`
...
<template>
  ...
  >
    ...
    <circle cx="12" cy="12" r="10"/><path d="M9 17V7h4a3 3 0 010 6H9"/>
  </svg>
  <!-- #endif -->
