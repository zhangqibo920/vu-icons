...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M18.977 14C19.6 12.701 20 11.343 20 10a8 8 0 00-16 0c0 4.993 5.539 10.193 7.399 11.799a1 1 0 001.202 0 32 32 0 00.824-.738"/><circle cx="12" cy="10" r="3"/><path d="M16 18h6"/>`
...
<template>
  ...
  >
    ...
    <path d="M18.977 14C19.6 12.701 20 11.343 20 10a8 8 0 00-16 0c0 4.993 5.539 10.193 7.399 11.799a1 1 0 001.202 0 32 32 0 00.824-.738"/><circle cx="12" cy="10" r="3"/><path d="M16 18h6"/>
  </svg>
  <!-- #endif -->
