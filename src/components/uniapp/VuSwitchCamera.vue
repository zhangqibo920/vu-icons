...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M11 19H4a2 2 0 01-2-2V7a2 2 0 012-2h5m4 0h7a2 2 0 012 2v10a2 2 0 01-2 2h-5"/><circle cx="12" cy="12" r="3"/><path d="M18 22l-3-3 3-3M6 2l3 3-3 3"/>`
...
<template>
  ...
  >
    ...
    <path d="M11 19H4a2 2 0 01-2-2V7a2 2 0 012-2h5m4 0h7a2 2 0 012 2v10a2 2 0 01-2 2h-5"/><circle cx="12" cy="12" r="3"/><path d="M18 22l-3-3 3-3M6 2l3 3-3 3"/>
  </svg>
  <!-- #endif -->
