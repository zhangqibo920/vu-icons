...
const name = 'VuCirclePoundSterling'
...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M10 16V9.5a1 1 0 015 0M8 12h4m-4 4h7"/><circle cx="12" cy="12" r="10"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 16V9.5a1 1 0 015 0M8 12h4m-4 4h7"/><circle cx="12" cy="12" r="10"/>
  </svg>
  <!-- #endif -->
