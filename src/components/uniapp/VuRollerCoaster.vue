...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M6 19V5m4 14V6.8M14 19v-7.8M18 5v4m0 10v-6m4 6V9M2 19V9a4 4 0 014-4c2 0 4 1.33 6 4s4 4 6 4a4 4 0 10-3-6.65"/>`
...
<template>
  ...
  >
    ...
    <path d="M6 19V5m4 14V6.8M14 19v-7.8M18 5v4m0 10v-6m4 6V9M2 19V9a4 4 0 014-4c2 0 4 1.33 6 4s4 4 6 4a4 4 0 10-3-6.65"/>
  </svg>
  <!-- #endif -->
