...
const name = 'VuBetweenHorizontalEnd'
...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<rect width="13" height="7" x="3" y="3" rx="1"/><path d="M22 15l-3-3 3-3"/><rect width="13" height="7" x="3" y="14" rx="1"/>`
...
<template>
  ...
  >
    ...
    <rect width="13" height="7" x="3" y="3" rx="1"/><path d="M22 15l-3-3 3-3"/><rect width="13" height="7" x="3" y="14" rx="1"/>
  </svg>
  <!-- #endif -->
