...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M14 13V8.5C14 7 15 7 15 5a3 3 0 00-6 0c0 2 1 2 1 3.5V13m10 2.5a2.5 2.5 0 00-2.5-2.5h-11A2.5 2.5 0 004 15.5V17a1 1 0 001 1h14a1 1 0 001-1zM5 22h14"/>`
...
<template>
  ...
  >
    ...
    <path d="M14 13V8.5C14 7 15 7 15 5a3 3 0 00-6 0c0 2 1 2 1 3.5V13m10 2.5a2.5 2.5 0 00-2.5-2.5h-11A2.5 2.5 0 004 15.5V17a1 1 0 001 1h14a1 1 0 001-1zM5 22h14"/>
  </svg>
  <!-- #endif -->
