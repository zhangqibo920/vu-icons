...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 019.9-1"/>`
...
<template>
  ...
  >
    ...
    <rect width="18" height="11" x="3" y="11" rx="2" ry="2"/><path d="M7 11V7a5 5 0 019.9-1"/>
  </svg>
  <!-- #endif -->
