...
const name = 'VuAlignHorizontalDistributeCenter'
...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<rect width="6" height="14" x="4" y="5" rx="2"/><rect width="6" height="10" x="14" y="7" rx="2"/><path d="M17 22v-5m0-10V2M7 22v-3M7 5V2"/>`
...
<template>
  ...
  >
    ...
    <rect width="6" height="14" x="4" y="5" rx="2"/><rect width="6" height="10" x="14" y="7" rx="2"/><path d="M17 22v-5m0-10V2M7 22v-3M7 5V2"/>
  </svg>
  <!-- #endif -->
