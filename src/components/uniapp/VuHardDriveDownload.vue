...
const name = 'VuHardDriveDownload'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 2v8m4-4l-4 4-4-4"/><rect width="20" height="8" x="2" y="14" rx="2"/><path d="M6 18h.01M10 18h.01"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 2v8m4-4l-4 4-4-4"/><rect width="20" height="8" x="2" y="14" rx="2"/><path d="M6 18h.01M10 18h.01"/>
  </svg>
  <!-- #endif -->
