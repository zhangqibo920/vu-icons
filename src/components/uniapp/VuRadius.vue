...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M20.34 17.52a10 10 0 10-2.82 2.82"/><circle cx="19" cy="19" r="2"/><path d="M13.41 13.41l4.18 4.18"/><circle cx="12" cy="12" r="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M20.34 17.52a10 10 0 10-2.82 2.82"/><circle cx="19" cy="19" r="2"/><path d="M13.41 13.41l4.18 4.18"/><circle cx="12" cy="12" r="2"/>
  </svg>
  <!-- #endif -->
