...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<circle cx="4" cy="4" r="2"/><path d="M14 5l3-3 3 3m-6 5l3-3 3 3m-3 4V2m0 12H7l-5 8h20zm-9 0v8m1-8l5 8"/>`
...
<template>
  ...
  >
    ...
    <circle cx="4" cy="4" r="2"/><path d="M14 5l3-3 3 3m-6 5l3-3 3 3m-3 4V2m0 12H7l-5 8h20zm-9 0v8m1-8l5 8"/>
  </svg>
  <!-- #endif -->
