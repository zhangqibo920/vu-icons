...
const name = 'VuAlignVerticalSpaceAround'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<rect width="10" height="6" x="7" y="9" rx="2"/><path d="M22 20H2M22 4H2"/>`
...
<template>
  ...
  >
    ...
    <rect width="10" height="6" x="7" y="9" rx="2"/><path d="M22 20H2M22 4H2"/>
  </svg>
  <!-- #endif -->
