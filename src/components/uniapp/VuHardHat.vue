...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M10 10V5a1 1 0 011-1h2a1 1 0 011 1v5m0-4a6 6 0 016 6v3M4 15v-3a6 6 0 016-6"/><rect width="20" height="4" x="2" y="15" rx="1"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 10V5a1 1 0 011-1h2a1 1 0 011 1v5m0-4a6 6 0 016 6v3M4 15v-3a6 6 0 016-6"/><rect width="20" height="4" x="2" y="15" rx="1"/>
  </svg>
  <!-- #endif -->
