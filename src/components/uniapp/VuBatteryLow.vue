...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M22 14v-4M6 14v-4"/><rect width="16" height="12" x="2" y="6" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M22 14v-4M6 14v-4"/><rect width="16" height="12" x="2" y="6" rx="2"/>
  </svg>
  <!-- #endif -->
