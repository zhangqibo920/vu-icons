...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M10 9H4L2 7l2-2h6m4 0h6l2 2-2 2h-6m-4 13V4a2 2 0 114 0v18m-6 0h8"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 9H4L2 7l2-2h6m4 0h6l2 2-2 2h-6m-4 13V4a2 2 0 114 0v18m-6 0h8"/>
  </svg>
  <!-- #endif -->
