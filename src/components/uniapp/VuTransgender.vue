...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 16v6m2-2h-4m8-18h4v4M2 2l7.17 7.17M2 5.355V2h3.357M22 2l-7.17 7.17M8 5L5 8"/><circle cx="12" cy="12" r="4"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 16v6m2-2h-4m8-18h4v4M2 2l7.17 7.17M2 5.355V2h3.357M22 2l-7.17 7.17M8 5L5 8"/><circle cx="12" cy="12" r="4"/>
  </svg>
  <!-- #endif -->
