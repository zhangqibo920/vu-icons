...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M15 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V7zm-3 7v4m0 4h.01"/>`
...
<template>
  ...
  >
    ...
    <path d="M15 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V7zm-3 7v4m0 4h.01"/>
  </svg>
  <!-- #endif -->
