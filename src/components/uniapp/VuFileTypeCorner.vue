...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 22h6a2 2 0 002-2V8a2.4 2.4 0 00-.706-1.706l-3.588-3.588A2.4 2.4 0 0014 2H6a2 2 0 00-2 2v6"/><path d="M14 2v5a1 1 0 001 1h5M3 16v-1.5a.5.5 0 01.5-.5h7a.5.5 0 01.5.5V16m-5 6h2m-1-8v8"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 22h6a2 2 0 002-2V8a2.4 2.4 0 00-.706-1.706l-3.588-3.588A2.4 2.4 0 0014 2H6a2 2 0 00-2 2v6"/><path d="M14 2v5a1 1 0 001 1h5M3 16v-1.5a.5.5 0 01.5-.5h7a.5.5 0 01.5.5V16m-5 6h2m-1-8v8"/>
  </svg>
  <!-- #endif -->
