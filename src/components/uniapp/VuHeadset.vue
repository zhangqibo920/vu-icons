...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M3 11h3a2 2 0 012 2v3a2 2 0 01-2 2H5a2 2 0 01-2-2zm0 0a9 9 0 1118 0m0 0v5a2 2 0 01-2 2h-1a2 2 0 01-2-2v-3a2 2 0 012-2z"/><path d="M21 16v2a4 4 0 01-4 4h-5"/>`
...
<template>
  ...
  >
    ...
    <path d="M3 11h3a2 2 0 012 2v3a2 2 0 01-2 2H5a2 2 0 01-2-2zm0 0a9 9 0 1118 0m0 0v5a2 2 0 01-2 2h-1a2 2 0 01-2-2v-3a2 2 0 012-2z"/><path d="M21 16v2a4 4 0 01-4 4h-5"/>
  </svg>
  <!-- #endif -->
