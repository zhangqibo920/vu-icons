...
const name = 'VuBanknoteArrowDown'
...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 18H4a2 2 0 01-2-2V8a2 2 0 012-2h16a2 2 0 012 2v5m-6 6l3 3 3-3m-4-7h.01m.99 4v6M6 12h.01"/><circle cx="12" cy="12" r="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 18H4a2 2 0 01-2-2V8a2 2 0 012-2h16a2 2 0 012 2v5m-6 6l3 3 3-3m-4-7h.01m.99 4v6M6 12h.01"/><circle cx="12" cy="12" r="2"/>
  </svg>
  <!-- #endif -->
