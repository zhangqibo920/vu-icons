...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M14 21v-3a2 2 0 00-4 0v3m8-16v16M4 6l7.106-3.79a2 2 0 011.788 0L20 6"/><path d="M6 11l-3.52 2.147a1 1 0 00-.48.854V19a2 2 0 002 2h16a2 2 0 002-2v-5a1 1 0 00-.48-.853L18 11M6 5v16"/><circle cx="12" cy="9" r="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M14 21v-3a2 2 0 00-4 0v3m8-16v16M4 6l7.106-3.79a2 2 0 011.788 0L20 6"/><path d="M6 11l-3.52 2.147a1 1 0 00-.48.854V19a2 2 0 002 2h16a2 2 0 002-2v-5a1 1 0 00-.48-.853L18 11M6 5v16"/><circle cx="12" cy="9" r="2"/>
  </svg>
  <!-- #endif -->
