...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 12h.01M14 15.464a4 4 0 01-4 0l-2.472 4.282a1 1 0 00.465 1.416 10 10 0 008.014 0 1 1 0 00.465-1.416zM16 12a4 4 0 00-2-3.464l2.472-4.282a1 1 0 011.46-.305 10 10 0 014.006 6.94A1 1 0 0121 12zm-8 0a4 4 0 012-3.464L7.528 4.254a1 1 0 00-1.46-.305 10 10 0 00-4.006 6.94A1 1 0 003 12z"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 12h.01M14 15.464a4 4 0 01-4 0l-2.472 4.282a1 1 0 00.465 1.416 10 10 0 008.014 0 1 1 0 00.465-1.416zM16 12a4 4 0 00-2-3.464l2.472-4.282a1 1 0 011.46-.305 10 10 0 014.006 6.94A1 1 0 0121 12zm-8 0a4 4 0 012-3.464L7.528 4.254a1 1 0 00-1.46-.305 10 10 0 00-4.006 6.94A1 1 0 003 12z"/>
  </svg>
  <!-- #endif -->
