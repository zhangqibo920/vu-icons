...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M10 12.01h.01M18 8v4a8 8 0 01-1.07 4"/><circle cx="10" cy="12" r="4"/><rect width="20" height="16" x="2" y="4" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 12.01h.01M18 8v4a8 8 0 01-1.07 4"/><circle cx="10" cy="12" r="4"/><rect width="20" height="16" x="2" y="4" rx="2"/>
  </svg>
  <!-- #endif -->
