...
const bgStyle = computed(() => {
  ...
  const svgContent = `<ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5v14a9 3 0 0012 2.84M21 5v3m0 4l-3 5h4l-3 5M3 12a9 3 0 0011.59 2.87"/>`
...
<template>
  ...
  >
    ...
    <ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5v14a9 3 0 0012 2.84M21 5v3m0 4l-3 5h4l-3 5M3 12a9 3 0 0011.59 2.87"/>
  </svg>
  <!-- #endif -->
