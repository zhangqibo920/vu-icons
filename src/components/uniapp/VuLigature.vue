...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M14 12h2v8m-2 0h4M6 12h4m-4 8h4m-2 0V8a4 4 0 017.464-2"/>`
...
<template>
  ...
  >
    ...
    <path d="M14 12h2v8m-2 0h4M6 12h4m-4 8h4m-2 0V8a4 4 0 017.464-2"/>
  </svg>
  <!-- #endif -->
