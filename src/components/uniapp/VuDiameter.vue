...
const bgStyle = computed(() => {
  ...
  const svgContent = `<circle cx="19" cy="19" r="2"/><circle cx="5" cy="5" r="2"/><path d="M6.48 3.66a10 10 0 0113.86 13.86M6.41 6.41l11.18 11.18M3.66 6.48a10 10 0 0013.86 13.86"/>`
...
<template>
  ...
  >
    ...
    <circle cx="19" cy="19" r="2"/><circle cx="5" cy="5" r="2"/><path d="M6.48 3.66a10 10 0 0113.86 13.86M6.41 6.41l11.18 11.18M3.66 6.48a10 10 0 0013.86 13.86"/>
  </svg>
  <!-- #endif -->
