...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M14 11l4-4 4 4m-4 5V7M2 16l4.039-9.69a.5.5 0 01.923 0L11 16m-7.696-3h6.392"/>`
...
<template>
  ...
  >
    ...
    <path d="M14 11l4-4 4 4m-4 5V7M2 16l4.039-9.69a.5.5 0 01.923 0L11 16m-7.696-3h6.392"/>
  </svg>
  <!-- #endif -->
