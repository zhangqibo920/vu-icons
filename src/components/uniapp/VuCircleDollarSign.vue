...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<circle cx="12" cy="12" r="10"/><path d="M16 8h-6a2 2 0 100 4h4a2 2 0 110 4H8m4 2V6"/>`
...
<template>
  ...
  >
    ...
    <circle cx="12" cy="12" r="10"/><path d="M16 8h-6a2 2 0 100 4h4a2 2 0 110 4H8m4 2V6"/>
  </svg>
  <!-- #endif -->
