...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M3.173 8.18l11-5a2 2 0 012.647.993L18.56 8M6 10V8m0 6v1m0 4v2"/><rect width="20" height="13" x="2" y="8" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M3.173 8.18l11-5a2 2 0 012.647.993L18.56 8M6 10V8m0 6v1m0 4v2"/><rect width="20" height="13" x="2" y="8" rx="2"/>
  </svg>
  <!-- #endif -->
