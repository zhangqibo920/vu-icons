...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M2 3h20m-1 0v11a2 2 0 01-2 2H5a2 2 0 01-2-2V3m4 18l5-5 5 5"/>`
...
<template>
  ...
  >
    ...
    <path d="M2 3h20m-1 0v11a2 2 0 01-2 2H5a2 2 0 01-2-2V3m4 18l5-5 5 5"/>
  </svg>
  <!-- #endif -->
