...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M14 15l-5 5-5-5"/><path d="M20 4h-7a4 4 0 00-4 4v12"/>`
...
<template>
  ...
  >
    ...
    <path d="M14 15l-5 5-5-5"/><path d="M20 4h-7a4 4 0 00-4 4v12"/>
  </svg>
  <!-- #endif -->
