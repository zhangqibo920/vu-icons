...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M10 2h4m-2 12v-4m-8 3a8 8 0 018-7 8 8 0 11-5.3 14L4 17.6"/><path d="M9 17H4v5"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 2h4m-2 12v-4m-8 3a8 8 0 018-7 8 8 0 11-5.3 14L4 17.6"/><path d="M9 17H4v5"/>
  </svg>
  <!-- #endif -->
