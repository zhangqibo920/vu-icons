...
const bgStyle = computed(() => {
  ...
  const svgContent = `<rect width="8" height="8" x="3" y="3" rx="2"/><path d="M7 11v4a2 2 0 002 2h4"/><rect width="8" height="8" x="13" y="13" rx="2"/>`
...
<template>
  ...
  >
    ...
    <rect width="8" height="8" x="3" y="3" rx="2"/><path d="M7 11v4a2 2 0 002 2h4"/><rect width="8" height="8" x="13" y="13" rx="2"/>
  </svg>
  <!-- #endif -->
