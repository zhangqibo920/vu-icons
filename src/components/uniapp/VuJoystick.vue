...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M21 17a2 2 0 00-2-2H5a2 2 0 00-2 2v2a2 2 0 002 2h14a2 2 0 002-2zM6 15v-2m6 2V9"/><circle cx="12" cy="6" r="3"/>`
...
<template>
  ...
  >
    ...
    <path d="M21 17a2 2 0 00-2-2H5a2 2 0 00-2 2v2a2 2 0 002 2h14a2 2 0 002-2zM6 15v-2m6 2V9"/><circle cx="12" cy="6" r="3"/>
  </svg>
  <!-- #endif -->
