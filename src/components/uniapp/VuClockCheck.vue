...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 6v6l4 2M22 12a10 10 0 10-11 9.95"/><path d="M22 16l-5.5 5.5L14 19"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 6v6l4 2M22 12a10 10 0 10-11 9.95"/><path d="M22 16l-5.5 5.5L14 19"/>
  </svg>
  <!-- #endif -->
