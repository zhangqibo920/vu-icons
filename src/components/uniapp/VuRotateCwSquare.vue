...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 5H6a2 2 0 00-2 2v3"/><path d="M9 8l3-3-3-3M4 14v4a2 2 0 002 2h12a2 2 0 002-2V7a2 2 0 00-2-2h-2"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 5H6a2 2 0 00-2 2v3"/><path d="M9 8l3-3-3-3M4 14v4a2 2 0 002 2h12a2 2 0 002-2V7a2 2 0 00-2-2h-2"/>
  </svg>
  <!-- #endif -->
