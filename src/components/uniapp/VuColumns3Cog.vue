...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M10.5 21H5a2 2 0 01-2-2V5a2 2 0 012-2h14a2 2 0 012 2v5.5m-6.7 9.1l1-.4M15 3v7.5m.2 6.4l-.9-.3m2.3 5.1l.3-.9m-.1-5.5l-.4-1m2.7.9l.3-.9m.2 7.4l-.4-1m1.5-3.9l1-.4m0 3l-.9-.3M9 3v18"/><circle cx="18" cy="18" r="3"/>`
...
<template>
  ...
  >
    ...
    <path d="M10.5 21H5a2 2 0 01-2-2V5a2 2 0 012-2h14a2 2 0 012 2v5.5m-6.7 9.1l1-.4M15 3v7.5m.2 6.4l-.9-.3m2.3 5.1l.3-.9m-.1-5.5l-.4-1m2.7.9l.3-.9m.2 7.4l-.4-1m1.5-3.9l1-.4m0 3l-.9-.3M9 3v18"/><circle cx="18" cy="18" r="3"/>
  </svg>
  <!-- #endif -->
