...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M16 4H9a3 3 0 00-2.83 4M14 12a4 4 0 010 8H6m-2-8h16"/>`
...
<template>
  ...
  >
    ...
    <path d="M16 4H9a3 3 0 00-2.83 4M14 12a4 4 0 010 8H6m-2-8h16"/>
  </svg>
  <!-- #endif -->
