...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M11.264 2.205A4 4 0 006.42 4.211l-4 8a4 4 0 001.359 5.117l6 4a4 4 0 004.438 0l6-4a4 4 0 001.576-4.592l-2-6a4 4 0 00-2.53-2.53z"/><path d="M11.99 22L14 12l7.822 3.184M14 12L8.47 2.302"/>`
...
<template>
  ...
  >
    ...
    <path d="M11.264 2.205A4 4 0 006.42 4.211l-4 8a4 4 0 001.359 5.117l6 4a4 4 0 004.438 0l6-4a4 4 0 001.576-4.592l-2-6a4 4 0 00-2.53-2.53z"/><path d="M11.99 22L14 12l7.822 3.184M14 12L8.47 2.302"/>
  </svg>
  <!-- #endif -->
