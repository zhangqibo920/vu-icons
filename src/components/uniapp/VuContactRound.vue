...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M16 2v2m1.915 18a6 6 0 00-12 0M8 2v2"/><circle cx="12" cy="12" r="4"/><rect width="18" height="18" x="3" y="4" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M16 2v2m1.915 18a6 6 0 00-12 0M8 2v2"/><circle cx="12" cy="12" r="4"/><rect width="18" height="18" x="3" y="4" rx="2"/>
  </svg>
  <!-- #endif -->
