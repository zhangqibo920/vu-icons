...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M8 2v4m8-4v4"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M3 10h18M9 16l2 2 4-4"/>`
...
<template>
  ...
  >
    ...
    <path d="M8 2v4m8-4v4"/><rect width="18" height="18" x="3" y="4" rx="2"/><path d="M3 10h18M9 16l2 2 4-4"/>
  </svg>
  <!-- #endif -->
