...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<rect width="18" height="18" x="3" y="3" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="M9.561 9.561L12 12m5 5l-2.18-2.18"/><circle cx="8.5" cy="15.5" r="1.5"/><path d="M9.561 14.439L17 7"/>`
...
<template>
  ...
  >
    ...
    <rect width="18" height="18" x="3" y="3" rx="2"/><circle cx="8.5" cy="8.5" r="1.5"/><path d="M9.561 9.561L12 12m5 5l-2.18-2.18"/><circle cx="8.5" cy="15.5" r="1.5"/><path d="M9.561 14.439L17 7"/>
  </svg>
  <!-- #endif -->
