...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 20h.01M5 12.859a10 10 0 0114 0m-10.5 3.57a5 5 0 017 0"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 20h.01M5 12.859a10 10 0 0114 0m-10.5 3.57a5 5 0 017 0"/>
  </svg>
  <!-- #endif -->
