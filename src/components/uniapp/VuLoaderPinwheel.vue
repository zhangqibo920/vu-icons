...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M22 12a1 1 0 01-10 0 1 1 0 00-10 0"/><path d="M7 20.7a1 1 0 115-8.7 1 1 0 105-8.6"/><path d="M7 3.3a1 1 0 115 8.6 1 1 0 105 8.6"/><circle cx="12" cy="12" r="10"/>`
...
<template>
  ...
  >
    ...
    <path d="M22 12a1 1 0 01-10 0 1 1 0 00-10 0"/><path d="M7 20.7a1 1 0 115-8.7 1 1 0 105-8.6"/><path d="M7 3.3a1 1 0 115 8.6 1 1 0 105 8.6"/><circle cx="12" cy="12" r="10"/>
  </svg>
  <!-- #endif -->
