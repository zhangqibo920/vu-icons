...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1zm8 4.5v11M15 9.4a4 4 0 100 5.2"/>`
...
<template>
  ...
  >
    ...
    <path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1zm8 4.5v11M15 9.4a4 4 0 100 5.2"/>
  </svg>
  <!-- #endif -->
