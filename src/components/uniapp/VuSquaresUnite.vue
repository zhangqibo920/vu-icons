...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M4 16a2 2 0 01-2-2V4a2 2 0 012-2h10a2 2 0 012 2v3a1 1 0 001 1h3a2 2 0 012 2v10a2 2 0 01-2 2H10a2 2 0 01-2-2v-3a1 1 0 00-1-1z"/>`
...
<template>
  ...
  >
    ...
    <path d="M4 16a2 2 0 01-2-2V4a2 2 0 012-2h10a2 2 0 012 2v3a1 1 0 001 1h3a2 2 0 012 2v10a2 2 0 01-2 2H10a2 2 0 01-2-2v-3a1 1 0 00-1-1z"/>
  </svg>
  <!-- #endif -->
