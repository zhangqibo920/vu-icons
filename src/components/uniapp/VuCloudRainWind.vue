...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M4 14.899A7 7 0 1115.71 8h1.79a4.5 4.5 0 012.5 8.242M9.2 22l3-7M9 13l-3 7m11-7l-3 7"/>`
...
<template>
  ...
  >
    ...
    <path d="M4 14.899A7 7 0 1115.71 8h1.79a4.5 4.5 0 012.5 8.242M9.2 22l3-7M9 13l-3 7m11-7l-3 7"/>
  </svg>
  <!-- #endif -->
