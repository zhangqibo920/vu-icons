...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M10.3 21H5a2 2 0 01-2-2V5a2 2 0 012-2h14a2 2 0 012 2v10l-3.1-3.1a2 2 0 00-2.814.014L6 21"/><path d="M14 19.5l3-3 3 3M17 22v-5.5"/><circle cx="9" cy="9" r="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M10.3 21H5a2 2 0 01-2-2V5a2 2 0 012-2h14a2 2 0 012 2v10l-3.1-3.1a2 2 0 00-2.814.014L6 21"/><path d="M14 19.5l3-3 3 3M17 22v-5.5"/><circle cx="9" cy="9" r="2"/>
  </svg>
  <!-- #endif -->
