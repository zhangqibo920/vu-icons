...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M10.293 2.293a1 1 0 011.414 0l2.5 2.5 5.994 1.227a1 1 0 01.506 1.687l-7 7a1 1 0 01-1.687-.506l-1.227-5.994-2.5-2.5a1 1 0 010-1.414zm3.914 2.5l-3.414 3.414M3 20a2 2 0 012-2h4a2 2 0 012 2v1a1 1 0 01-1 1H4a1 1 0 01-1-1z"/><path d="M9.086 6.5l-4.793 4.793a1 1 0 00-.18 1.17L7 18"/>`
...
<template>
  ...
  >
    ...
    <path d="M10.293 2.293a1 1 0 011.414 0l2.5 2.5 5.994 1.227a1 1 0 01.506 1.687l-7 7a1 1 0 01-1.687-.506l-1.227-5.994-2.5-2.5a1 1 0 010-1.414zm3.914 2.5l-3.414 3.414M3 20a2 2 0 012-2h4a2 2 0 012 2v1a1 1 0 01-1 1H4a1 1 0 01-1-1z"/><path d="M9.086 6.5l-4.793 4.793a1 1 0 00-.18 1.17L7 18"/>
  </svg>
  <!-- #endif -->
