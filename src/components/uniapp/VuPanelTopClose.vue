...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18M9 16l3-3 3 3"/>`
...
<template>
  ...
  >
    ...
    <rect width="18" height="18" x="3" y="3" rx="2"/><path d="M3 9h18M9 16l3-3 3 3"/>
  </svg>
  <!-- #endif -->
