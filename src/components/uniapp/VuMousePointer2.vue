...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M4.037 4.688a.495.495 0 01.651-.651l16 6.5a.5.5 0 01-.063.947l-6.124 1.58a2 2 0 00-1.438 1.435l-1.579 6.126a.5.5 0 01-.947.063z"/>`
...
<template>
  ...
  >
    ...
    <path d="M4.037 4.688a.495.495 0 01.651-.651l16 6.5a.5.5 0 01-.063.947l-6.124 1.58a2 2 0 00-1.438 1.435l-1.579 6.126a.5.5 0 01-.947.063z"/>
  </svg>
  <!-- #endif -->
