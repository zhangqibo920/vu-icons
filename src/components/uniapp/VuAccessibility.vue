...
const bgStyle = computed(() => {
  ...
  const svgContent = `<circle cx="16" cy="4" r="1"/><path d="M18 19l1-7-6 1M5 8l3-3 5.5 3-2.36 3.5m-6.9 3a5 5 0 006.88 6M13.76 17.5a5 5 0 00-6.88-6"/>`
...
<template>
  ...
  >
    ...
    <circle cx="16" cy="4" r="1"/><path d="M18 19l1-7-6 1M5 8l3-3 5.5 3-2.36 3.5m-6.9 3a5 5 0 006.88 6M13.76 17.5a5 5 0 00-6.88-6"/>
  </svg>
  <!-- #endif -->
