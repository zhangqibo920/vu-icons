...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M14.828 14.828L21 21m0-5v5h-5m5-18l-9 9-4-4-6 6"/><path d="M21 8V3h-5"/>`
...
<template>
  ...
  >
    ...
    <path d="M14.828 14.828L21 21m0-5v5h-5m5-18l-9 9-4-4-6 6"/><path d="M21 8V3h-5"/>
  </svg>
  <!-- #endif -->
