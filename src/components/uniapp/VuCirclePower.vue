...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 7v4M7.998 9.003a5 5 0 108-.005"/><circle cx="12" cy="12" r="10"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 7v4M7.998 9.003a5 5 0 108-.005"/><circle cx="12" cy="12" r="10"/>
  </svg>
  <!-- #endif -->
