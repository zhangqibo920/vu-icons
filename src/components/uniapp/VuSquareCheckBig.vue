...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M21 10.656V19a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h12.344"/><path d="M9 11l3 3L22 4"/>`
...
<template>
  ...
  >
    ...
    <path d="M21 10.656V19a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h12.344"/><path d="M9 11l3 3L22 4"/>
  </svg>
  <!-- #endif -->
