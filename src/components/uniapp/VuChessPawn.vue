...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M5 20a2 2 0 012-2h10a2 2 0 012 2v1a1 1 0 01-1 1H6a1 1 0 01-1-1zm9.5-10l1.5 8m-9-8h10m-9 8l1.5-8"/><circle cx="12" cy="6" r="4"/>`
...
<template>
  ...
  >
    ...
    <path d="M5 20a2 2 0 012-2h10a2 2 0 012 2v1a1 1 0 01-1 1H6a1 1 0 01-1-1zm9.5-10l1.5 8m-9-8h10m-9 8l1.5-8"/><circle cx="12" cy="6" r="4"/>
  </svg>
  <!-- #endif -->
