...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M16 14v2.2l1.6 1M16 4h2a2 2 0 012 2v.832M8 4H6a2 2 0 00-2 2v14a2 2 0 002 2h2"/><circle cx="16" cy="16" r="6"/><rect width="8" height="4" x="8" y="2" rx="1"/>`
...
<template>
  ...
  >
    ...
    <path d="M16 14v2.2l1.6 1M16 4h2a2 2 0 012 2v.832M8 4H6a2 2 0 00-2 2v14a2 2 0 002 2h2"/><circle cx="16" cy="16" r="6"/><rect width="8" height="4" x="8" y="2" rx="1"/>
  </svg>
  <!-- #endif -->
