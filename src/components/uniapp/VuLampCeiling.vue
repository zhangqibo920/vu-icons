...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 2v5m2.829 8.998a3 3 0 11-5.658 0"/><path d="M20.92 14.606A1 1 0 0120 16H4a1 1 0 01-.92-1.394l3-7A1 1 0 017 7h10a1 1 0 01.92.606z"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 2v5m2.829 8.998a3 3 0 11-5.658 0"/><path d="M20.92 14.606A1 1 0 0120 16H4a1 1 0 01-.92-1.394l3-7A1 1 0 017 7h10a1 1 0 01.92.606z"/>
  </svg>
  <!-- #endif -->
