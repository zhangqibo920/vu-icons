...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M2 2l8 8m12-8l-8 8"/><ellipse cx="12" cy="9" rx="10" ry="5"/><path d="M7 13.4v7.9m5-7.3v8m5-8.6v7.9M2 9v8a10 5 0 0020 0V9"/>`
...
<template>
  ...
  >
    ...
    <path d="M2 2l8 8m12-8l-8 8"/><ellipse cx="12" cy="9" rx="10" ry="5"/><path d="M7 13.4v7.9m5-7.3v8m5-8.6v7.9M2 9v8a10 5 0 0020 0V9"/>
  </svg>
  <!-- #endif -->
