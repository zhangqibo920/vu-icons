...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12.99 6.74l1.93 3.44M19.136 12a10 10 0 01-14.271 0M21 21l-2.16-3.84M3 21l8.02-14.26"/><circle cx="12" cy="5" r="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M12.99 6.74l1.93 3.44M19.136 12a10 10 0 01-14.271 0M21 21l-2.16-3.84M3 21l8.02-14.26"/><circle cx="12" cy="5" r="2"/>
  </svg>
  <!-- #endif -->
