...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M17 3l-5 5-5-5zm0 18l-5-5-5 5zM4 12H2m8 0H8m8 0h-2m8 0h-2"/>`
...
<template>
  ...
  >
    ...
    <path d="M17 3l-5 5-5-5zm0 18l-5-5-5 5zM4 12H2m8 0H8m8 0h-2m8 0h-2"/>
  </svg>
  <!-- #endif -->
