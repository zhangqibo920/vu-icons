...
const name = 'VuChartColumnIncreasing'
...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M13 17V9m5 8V5M3 3v16a2 2 0 002 2h16M8 17v-3"/>`
...
<template>
  ...
  >
    ...
    <path d="M13 17V9m5 8V5M3 3v16a2 2 0 002 2h16M8 17v-3"/>
  </svg>
  <!-- #endif -->
