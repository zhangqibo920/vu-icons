...
const name = 'VuMessageSquareMore'
...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M22 17a2 2 0 01-2 2H6.828a2 2 0 00-1.414.586l-2.202 2.202A.71.71 0 012 21.286V5a2 2 0 012-2h16a2 2 0 012 2zm-10-6h.01M16 11h.01M8 11h.01"/>`
...
<template>
  ...
  >
    ...
    <path d="M22 17a2 2 0 01-2 2H6.828a2 2 0 00-1.414.586l-2.202 2.202A.71.71 0 012 21.286V5a2 2 0 012-2h16a2 2 0 012 2zm-10-6h.01M16 11h.01M8 11h.01"/>
  </svg>
  <!-- #endif -->
