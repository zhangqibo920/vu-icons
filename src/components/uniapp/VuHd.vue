...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M10 12H6m4 3V9m4 5.5a.5.5 0 00.5.5h1a2.5 2.5 0 002.5-2.5v-1A2.5 2.5 0 0015.5 9h-1a.5.5 0 00-.5.5zM6 15V9"/><rect width="20" height="14" x="2" y="5" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 12H6m4 3V9m4 5.5a.5.5 0 00.5.5h1a2.5 2.5 0 002.5-2.5v-1A2.5 2.5 0 0015.5 9h-1a.5.5 0 00-.5.5zM6 15V9"/><rect width="20" height="14" x="2" y="5" rx="2"/>
  </svg>
  <!-- #endif -->
