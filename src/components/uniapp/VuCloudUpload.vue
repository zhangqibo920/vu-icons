...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 13v8m-8-6.101A7 7 0 1115.71 8h1.79a4.5 4.5 0 012.5 8.242"/><path d="M8 17l4-4 4 4"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 13v8m-8-6.101A7 7 0 1115.71 8h1.79a4.5 4.5 0 012.5 8.242"/><path d="M8 17l4-4 4 4"/>
  </svg>
  <!-- #endif -->
