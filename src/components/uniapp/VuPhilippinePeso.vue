...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M20 11H4m16-4H4m3 14V4a1 1 0 011-1h4a1 1 0 010 12H7"/>`
...
<template>
  ...
  >
    ...
    <path d="M20 11H4m16-4H4m3 14V4a1 1 0 011-1h4a1 1 0 010 12H7"/>
  </svg>
  <!-- #endif -->
