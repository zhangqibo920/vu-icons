...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M17.586 11.414l-5.93 5.93a1 1 0 01-8-8l3.137-3.137a.707.707 0 011.207.5V10m12.414-1.414L22 7"/><circle cx="19" cy="10" r="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M17.586 11.414l-5.93 5.93a1 1 0 01-8-8l3.137-3.137a.707.707 0 011.207.5V10m12.414-1.414L22 7"/><circle cx="19" cy="10" r="2"/>
  </svg>
  <!-- #endif -->
