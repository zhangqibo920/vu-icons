...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M4 14.899A7 7 0 1115.71 8h1.79a4.5 4.5 0 012.5 8.242M16 17H7m10 4H9"/>`
...
<template>
  ...
  >
    ...
    <path d="M4 14.899A7 7 0 1115.71 8h1.79a4.5 4.5 0 012.5 8.242M16 17H7m10 4H9"/>
  </svg>
  <!-- #endif -->
