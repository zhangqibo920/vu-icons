...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M2 9a3 3 0 110 6v2a2 2 0 002 2h16a2 2 0 002-2v-2a3 3 0 110-6V7a2 2 0 00-2-2H4a2 2 0 00-2 2zm7 0h.01M15 9l-6 6m6 0h.01"/>`
...
<template>
  ...
  >
    ...
    <path d="M2 9a3 3 0 110 6v2a2 2 0 002 2h16a2 2 0 002-2v-2a3 3 0 110-6V7a2 2 0 00-2-2H4a2 2 0 00-2 2zm7 0h.01M15 9l-6 6m6 0h.01"/>
  </svg>
  <!-- #endif -->
