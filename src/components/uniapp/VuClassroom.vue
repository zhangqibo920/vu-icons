...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M2 3h6a4 4 0 014 4v14a3 3 0 00-3 3H2a3 3 0 00-3-3V6a4 4 0 014-4zM22 3h-6a4 4 0 00-4 4v14a3 3 0 003 3h7a3 3 0 003-3V6a4 4 0 00-4-4z"/>`
...
<template>
  ...
  >
    ...
    <path d="M2 3h6a4 4 0 014 4v14a3 3 0 00-3 3H2a3 3 0 00-3-3V6a4 4 0 014-4zM22 3h-6a4 4 0 00-4 4v14a3 3 0 003 3h7a3 3 0 003-3V6a4 4 0 00-4-4z"/>
  </svg>
  <!-- #endif -->
