...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M21 7L6.82 21.18a2.83 2.83 0 01-3.99-.01 2.83 2.83 0 010-4L17 3m-1-1l6 6m-10 8H4"/>`
...
<template>
  ...
  >
    ...
    <path d="M21 7L6.82 21.18a2.83 2.83 0 01-3.99-.01 2.83 2.83 0 010-4L17 3m-1-1l6 6m-10 8H4"/>
  </svg>
  <!-- #endif -->
