...
const name = 'VuChartColumnDecreasing'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M13 17V9m5 8v-3M3 3v16a2 2 0 002 2h16M8 17V5"/>`
...
<template>
  ...
  >
    ...
    <path d="M13 17V9m5 8v-3M3 3v16a2 2 0 002 2h16M8 17V5"/>
  </svg>
  <!-- #endif -->
