...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12.8 19.6A2 2 0 1014 16H2m15.5-8a2.5 2.5 0 112 4H2m7.8-7.6A2 2 0 1111 8H2"/>`
...
<template>
  ...
  >
    ...
    <path d="M12.8 19.6A2 2 0 1014 16H2m15.5-8a2.5 2.5 0 112 4H2m7.8-7.6A2 2 0 1111 8H2"/>
  </svg>
  <!-- #endif -->
