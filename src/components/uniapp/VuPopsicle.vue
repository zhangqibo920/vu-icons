...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M18.6 14.4c.8-.8.8-2 0-2.8l-8.1-8.1a4.95 4.95 0 10-7.1 7.1l8.1 8.1c.9.7 2.1.7 2.9-.1zM22 22l-5.5-5.5"/>`
...
<template>
  ...
  >
    ...
    <path d="M18.6 14.4c.8-.8.8-2 0-2.8l-8.1-8.1a4.95 4.95 0 10-7.1 7.1l8.1 8.1c.9.7 2.1.7 2.9-.1zM22 22l-5.5-5.5"/>
  </svg>
  <!-- #endif -->
