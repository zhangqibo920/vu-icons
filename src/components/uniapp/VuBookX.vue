...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M14.5 7l-5 5M4 19.5v-15A2.5 2.5 0 016.5 2H19a1 1 0 011 1v18a1 1 0 01-1 1H6.5a1 1 0 010-5H20M9.5 7l5 5"/>`
...
<template>
  ...
  >
    ...
    <path d="M14.5 7l-5 5M4 19.5v-15A2.5 2.5 0 016.5 2H19a1 1 0 011 1v18a1 1 0 01-1 1H6.5a1 1 0 010-5H20M9.5 7l5 5"/>
  </svg>
  <!-- #endif -->
