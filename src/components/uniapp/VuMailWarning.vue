...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M22 10.5V6a2 2 0 00-2-2H4a2 2 0 00-2 2v12c0 1.1.9 2 2 2h12.5"/><path d="M22 7l-8.97 5.7a1.94 1.94 0 01-2.06 0L2 7m18 7v4m0 4v.01"/>`
...
<template>
  ...
  >
    ...
    <path d="M22 10.5V6a2 2 0 00-2-2H4a2 2 0 00-2 2v12c0 1.1.9 2 2 2h12.5"/><path d="M22 7l-8.97 5.7a1.94 1.94 0 01-2.06 0L2 7m18 7v4m0 4v.01"/>
  </svg>
  <!-- #endif -->
