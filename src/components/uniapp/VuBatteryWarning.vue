...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M10 17h.01M10 7v6m4-7h2a2 2 0 012 2v8a2 2 0 01-2 2h-2m8-4v-4M6 18H4a2 2 0 01-2-2V8a2 2 0 012-2h2"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 17h.01M10 7v6m4-7h2a2 2 0 012 2v8a2 2 0 01-2 2h-2m8-4v-4M6 18H4a2 2 0 01-2-2V8a2 2 0 012-2h2"/>
  </svg>
  <!-- #endif -->
