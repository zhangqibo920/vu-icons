...
const name = 'VuDecimalsArrowRight'
...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M10 18h10m-3 3l3-3-3-3M3 11h.01"/><rect width="5" height="8" x="15" y="3" rx="2.5"/><rect width="5" height="8" x="6" y="3" rx="2.5"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 18h10m-3 3l3-3-3-3M3 11h.01"/><rect width="5" height="8" x="15" y="3" rx="2.5"/><rect width="5" height="8" x="6" y="3" rx="2.5"/>
  </svg>
  <!-- #endif -->
