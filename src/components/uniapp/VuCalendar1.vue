...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M11 14h1v4m4-16v4M3 10h18M8 2v4"/><rect width="18" height="18" x="3" y="4" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M11 14h1v4m4-16v4M3 10h18M8 2v4"/><rect width="18" height="18" x="3" y="4" rx="2"/>
  </svg>
  <!-- #endif -->
