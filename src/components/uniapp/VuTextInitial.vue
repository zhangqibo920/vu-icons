...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M15 5h6m-6 7h6M3 19h18M3 12l3.553-7.724a.5.5 0 01.894 0L11 12m-7.08-2h6.16"/>`
...
<template>
  ...
  >
    ...
    <path d="M15 5h6m-6 7h6M3 19h18M3 12l3.553-7.724a.5.5 0 01.894 0L11 12m-7.08-2h6.16"/>
  </svg>
  <!-- #endif -->
