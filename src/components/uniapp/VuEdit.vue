...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path fill="currentColor" d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04a.996.996 0 000-1.41lNaN 1.83 NaN 3.75 NaN-1.83a.996.996 0 00NaN-1.41lNaN-2.34z"/>`
...
<template>
  ...
  >
    ...
    <path fill="currentColor" d="M3 17.25V21h3.75L17.81 9.94l-3.75-3.75L3 17.25zM20.71 7.04a.996.996 0 000-1.41lNaN 1.83 NaN 3.75 NaN-1.83a.996.996 0 00NaN-1.41lNaN-2.34z"/>
  </svg>
  <!-- #endif -->
