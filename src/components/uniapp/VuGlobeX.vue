...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M16 3l5 5M2 12h20A10 10 0 1112 2a14.5 14.5 0 000 20 14.5 14.5 0 004-10m5-9l-5 5"/>`
...
<template>
  ...
  >
    ...
    <path d="M16 3l5 5M2 12h20A10 10 0 1112 2a14.5 14.5 0 000 20 14.5 14.5 0 004-10m5-9l-5 5"/>
  </svg>
  <!-- #endif -->
