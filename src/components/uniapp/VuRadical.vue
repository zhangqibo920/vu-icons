...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M3 12h3.28a1 1 0 01.948.684l2.298 7.934a.5.5 0 00.96-.044L13.82 4.771A1 1 0 0114.792 4H21"/>`
...
<template>
  ...
  >
    ...
    <path d="M3 12h3.28a1 1 0 01.948.684l2.298 7.934a.5.5 0 00.96-.044L13.82 4.771A1 1 0 0114.792 4H21"/>
  </svg>
  <!-- #endif -->
