...
const bgStyle = computed(() => {
  ...
  const svgContent = `<rect width="20" height="16" x="2" y="4" rx="2"/><circle cx="8" cy="10" r="2"/><path d="M8 12h8"/><circle cx="16" cy="10" r="2"/><path d="M6 20l.7-2.9A1.4 1.4 0 018.1 16h7.8a1.4 1.4 0 011.4 1l.7 3"/>`
...
<template>
  ...
  >
    ...
    <rect width="20" height="16" x="2" y="4" rx="2"/><circle cx="8" cy="10" r="2"/><path d="M8 12h8"/><circle cx="16" cy="10" r="2"/><path d="M6 20l.7-2.9A1.4 1.4 0 018.1 16h7.8a1.4 1.4 0 011.4 1l.7 3"/>
  </svg>
  <!-- #endif -->
