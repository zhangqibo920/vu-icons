...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<rect width="8" height="8" x="8" y="8" rx="2"/><path d="M4 10a2 2 0 01-2-2V4a2 2 0 012-2h4a2 2 0 012 2m4 16a2 2 0 002 2h4a2 2 0 002-2v-4a2 2 0 00-2-2"/>`
...
<template>
  ...
  >
    ...
    <rect width="8" height="8" x="8" y="8" rx="2"/><path d="M4 10a2 2 0 01-2-2V4a2 2 0 012-2h4a2 2 0 012 2m4 16a2 2 0 002 2h4a2 2 0 002-2v-4a2 2 0 00-2-2"/>
  </svg>
  <!-- #endif -->
