...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M18 8a2 2 0 000-4 2 2 0 00-4 0 2 2 0 00-4 0 2 2 0 00-4 0 2 2 0 000 4m4 14L9 8m5 14l1-14"/><path d="M20 8c.5 0 .9.4.8 1l-2.6 12c-.1.5-.7 1-1.2 1H7c-.6 0-1.1-.4-1.2-1L3.2 9c-.1-.6.3-1 .8-1z"/>`
...
<template>
  ...
  >
    ...
    <path d="M18 8a2 2 0 000-4 2 2 0 00-4 0 2 2 0 00-4 0 2 2 0 00-4 0 2 2 0 000 4m4 14L9 8m5 14l1-14"/><path d="M20 8c.5 0 .9.4.8 1l-2.6 12c-.1.5-.7 1-1.2 1H7c-.6 0-1.1-.4-1.2-1L3.2 9c-.1-.6.3-1 .8-1z"/>
  </svg>
  <!-- #endif -->
