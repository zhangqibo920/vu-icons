...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M11 12h.01M13 22c.5-.5 1.12-1 2.5-1-1.38 0-2-.5-2.5-1m1-18a3.28 3.28 0 01-3.227 1.798l-6.17-.561A2.387 2.387 0 104.387 8H15.5a1 1 0 010 13 1 1 0 000-5H12a7 7 0 01-7-7V8"/><path d="M14 8a8.5 8.5 0 010 8m2 0c2 0 4.5-4 4-6"/>`
...
<template>
  ...
  >
    ...
    <path d="M11 12h.01M13 22c.5-.5 1.12-1 2.5-1-1.38 0-2-.5-2.5-1m1-18a3.28 3.28 0 01-3.227 1.798l-6.17-.561A2.387 2.387 0 104.387 8H15.5a1 1 0 010 13 1 1 0 000-5H12a7 7 0 01-7-7V8"/><path d="M14 8a8.5 8.5 0 010 8m2 0c2 0 4.5-4 4-6"/>
  </svg>
  <!-- #endif -->
