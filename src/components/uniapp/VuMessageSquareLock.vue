...
const name = 'VuMessageSquareLock'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M22 8.5V5a2 2 0 00-2-2H4a2 2 0 00-2 2v16.286a.71.71 0 001.212.502l2.202-2.202A2 2 0 016.828 19H10"/><path d="M20 15v-2a2 2 0 00-4 0v2"/><rect width="8" height="5" x="14" y="15" rx="1"/>`
...
<template>
  ...
  >
    ...
    <path d="M22 8.5V5a2 2 0 00-2-2H4a2 2 0 00-2 2v16.286a.71.71 0 001.212.502l2.202-2.202A2 2 0 016.828 19H10"/><path d="M20 15v-2a2 2 0 00-4 0v2"/><rect width="8" height="5" x="14" y="15" rx="1"/>
  </svg>
  <!-- #endif -->
