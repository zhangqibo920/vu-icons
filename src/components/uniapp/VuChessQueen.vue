...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M4 20a2 2 0 012-2h12a2 2 0 012 2v1a1 1 0 01-1 1H5a1 1 0 01-1-1zm8.474-14.057l1.567 5.34a1 1 0 001.75.328l2.616-3.402M20 9l-3 9M5.594 8.209l2.615 3.403a1 1 0 001.75-.329l1.567-5.34M7 18L4 9"/><circle cx="12" cy="4" r="2"/><circle cx="20" cy="7" r="2"/><circle cx="4" cy="7" r="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M4 20a2 2 0 012-2h12a2 2 0 012 2v1a1 1 0 01-1 1H5a1 1 0 01-1-1zm8.474-14.057l1.567 5.34a1 1 0 001.75.328l2.616-3.402M20 9l-3 9M5.594 8.209l2.615 3.403a1 1 0 001.75-.329l1.567-5.34M7 18L4 9"/><circle cx="12" cy="4" r="2"/><circle cx="20" cy="7" r="2"/><circle cx="4" cy="7" r="2"/>
  </svg>
  <!-- #endif -->
