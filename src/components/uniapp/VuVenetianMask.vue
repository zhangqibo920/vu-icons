...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M18 11c-1.5 0-2.5.5-3 2M4 6a2 2 0 00-2 2v4a5 5 0 005 5 8 8 0 015 2 8 8 0 015-2 5 5 0 005-5V8a2 2 0 00-2-2h-3a8 8 0 00-5 2 8 8 0 00-5-2zM6 11c1.5 0 2.5.5 3 2"/>`
...
<template>
  ...
  >
    ...
    <path d="M18 11c-1.5 0-2.5.5-3 2M4 6a2 2 0 00-2 2v4a5 5 0 005 5 8 8 0 015 2 8 8 0 015-2 5 5 0 005-5V8a2 2 0 00-2-2h-3a8 8 0 00-5 2 8 8 0 00-5-2zM6 11c1.5 0 2.5.5 3 2"/>
  </svg>
  <!-- #endif -->
