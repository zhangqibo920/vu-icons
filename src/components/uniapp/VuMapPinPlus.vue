...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M19.914 11.105A7 7 0 0020 10a8 8 0 00-16 0c0 4.993 5.539 10.193 7.399 11.799a1 1 0 001.202 0 32 32 0 00.824-.738"/><circle cx="12" cy="10" r="3"/><path d="M16 18h6m-3-3v6"/>`
...
<template>
  ...
  >
    ...
    <path d="M19.914 11.105A7 7 0 0020 10a8 8 0 00-16 0c0 4.993 5.539 10.193 7.399 11.799a1 1 0 001.202 0 32 32 0 00.824-.738"/><circle cx="12" cy="10" r="3"/><path d="M16 18h6m-3-3v6"/>
  </svg>
  <!-- #endif -->
