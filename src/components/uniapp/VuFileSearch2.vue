...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M15 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V7z"/><path d="M14 2v4a2 2 0 002 2h4"/><circle cx="11.5" cy="14.5" r="2.5"/><path d="M13.3 16.3L15 18"/>`
...
<template>
  ...
  >
    ...
    <path d="M15 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V7z"/><path d="M14 2v4a2 2 0 002 2h4"/><circle cx="11.5" cy="14.5" r="2.5"/><path d="M13.3 16.3L15 18"/>
  </svg>
  <!-- #endif -->
