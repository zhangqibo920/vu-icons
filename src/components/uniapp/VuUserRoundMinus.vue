...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M2 21a8 8 0 0113.292-6"/><circle cx="10" cy="8" r="5"/><path d="M22 19h-6"/>`
...
<template>
  ...
  >
    ...
    <path d="M2 21a8 8 0 0113.292-6"/><circle cx="10" cy="8" r="5"/><path d="M22 19h-6"/>
  </svg>
  <!-- #endif -->
