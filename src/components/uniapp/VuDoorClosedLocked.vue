...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M10 12h.01M18 9V6a2 2 0 00-2-2H8a2 2 0 00-2 2v14m-4 0h8m10-3v-2a2 2 0 10-4 0v2"/><rect width="8" height="5" x="14" y="17" rx="1"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 12h.01M18 9V6a2 2 0 00-2-2H8a2 2 0 00-2 2v14m-4 0h8m10-3v-2a2 2 0 10-4 0v2"/><rect width="8" height="5" x="14" y="17" rx="1"/>
  </svg>
  <!-- #endif -->
