...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 6v16m7-9l2-1a9 9 0 01-18 0l2 1m4-2h6"/><circle cx="12" cy="4" r="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 6v16m7-9l2-1a9 9 0 01-18 0l2 1m4-2h6"/><circle cx="12" cy="4" r="2"/>
  </svg>
  <!-- #endif -->
