...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M15 3v18M8 9l3 3-3 3"/>`
...
<template>
  ...
  >
    ...
    <rect width="18" height="18" x="3" y="3" rx="2"/><path d="M15 3v18M8 9l3 3-3 3"/>
  </svg>
  <!-- #endif -->
