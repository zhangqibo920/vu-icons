...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M19.5 7a24 24 0 010 10M4.5 7a24 24 0 000 10M7 19.5a24 24 0 0010 0M7 4.5a24 24 0 0110 0"/><rect width="5" height="5" x="17" y="17" rx="1"/><rect width="5" height="5" x="17" y="2" rx="1"/><rect width="5" height="5" x="2" y="17" rx="1"/><rect width="5" height="5" x="2" y="2" rx="1"/>`
...
<template>
  ...
  >
    ...
    <path d="M19.5 7a24 24 0 010 10M4.5 7a24 24 0 000 10M7 19.5a24 24 0 0010 0M7 4.5a24 24 0 0110 0"/><rect width="5" height="5" x="17" y="17" rx="1"/><rect width="5" height="5" x="17" y="2" rx="1"/><rect width="5" height="5" x="2" y="17" rx="1"/><rect width="5" height="5" x="2" y="2" rx="1"/>
  </svg>
  <!-- #endif -->
