...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M7 11l2-2-2-2m4 6h4"/><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M7 11l2-2-2-2m4 6h4"/><rect width="18" height="18" x="3" y="3" rx="2" ry="2"/>
  </svg>
  <!-- #endif -->
