...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M3 16l4 4 4-4M7 4v16m8-16h5l-5 6h5m-5 10v-3.5a2.5 2.5 0 015 0V20m0-2h-5"/>`
...
<template>
  ...
  >
    ...
    <path d="M3 16l4 4 4-4M7 4v16m8-16h5l-5 6h5m-5 10v-3.5a2.5 2.5 0 015 0V20m0-2h-5"/>
  </svg>
  <!-- #endif -->
