...
const name = 'VuGitPullRequestArrow'
...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<circle cx="5" cy="6" r="3"/><path d="M5 9v12"/><circle cx="19" cy="18" r="3"/><path d="M15 9l-3-3 3-3"/><path d="M12 6h5a2 2 0 012 2v7"/>`
...
<template>
  ...
  >
    ...
    <circle cx="5" cy="6" r="3"/><path d="M5 9v12"/><circle cx="19" cy="18" r="3"/><path d="M15 9l-3-3 3-3"/><path d="M12 6h5a2 2 0 012 2v7"/>
  </svg>
  <!-- #endif -->
