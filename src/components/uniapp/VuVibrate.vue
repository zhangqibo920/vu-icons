...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M2 8l2 2-2 2 2 2-2 2m20-8l-2 2 2 2-2 2 2 2"/><rect width="8" height="14" x="8" y="5" rx="1"/>`
...
<template>
  ...
  >
    ...
    <path d="M2 8l2 2-2 2 2 2-2 2m20-8l-2 2 2 2-2 2 2 2"/><rect width="8" height="14" x="8" y="5" rx="1"/>
  </svg>
  <!-- #endif -->
