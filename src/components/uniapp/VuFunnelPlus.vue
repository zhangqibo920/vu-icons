...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M13.354 3H3a1 1 0 00-.742 1.67l7.225 7.989A2 2 0 0110 14v6a1 1 0 00.553.895l2 1A1 1 0 0014 21v-7a2 2 0 01.517-1.341l1.218-1.348M16 6h6m-3-3v6"/>`
...
<template>
  ...
  >
    ...
    <path d="M13.354 3H3a1 1 0 00-.742 1.67l7.225 7.989A2 2 0 0110 14v6a1 1 0 00.553.895l2 1A1 1 0 0014 21v-7a2 2 0 01.517-1.341l1.218-1.348M16 6h6m-3-3v6"/>
  </svg>
  <!-- #endif -->
