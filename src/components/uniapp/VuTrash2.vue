...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M10 11v6m4-6v6m5-11v14a2 2 0 01-2 2H7a2 2 0 01-2-2V6M3 6h18M8 6V4a2 2 0 012-2h4a2 2 0 012 2v2"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 11v6m4-6v6m5-11v14a2 2 0 01-2 2H7a2 2 0 01-2-2V6M3 6h18M8 6V4a2 2 0 012-2h4a2 2 0 012 2v2"/>
  </svg>
  <!-- #endif -->
