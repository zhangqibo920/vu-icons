...
const bgStyle = computed(() => {
  ...
  const svgContent = `<circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1110.34 18M7 6h1v4"/><path d="M16.71 13.88l.7.71-2.82 2.82"/>`
...
<template>
  ...
  >
    ...
    <circle cx="8" cy="8" r="6"/><path d="M18.09 10.37A6 6 0 1110.34 18M7 6h1v4"/><path d="M16.71 13.88l.7.71-2.82 2.82"/>
  </svg>
  <!-- #endif -->
