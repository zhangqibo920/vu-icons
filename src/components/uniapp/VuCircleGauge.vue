...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M15.6 2.7a10 10 0 105.7 5.7"/><circle cx="12" cy="12" r="2"/><path d="M13.4 10.6L19 5"/>`
...
<template>
  ...
  >
    ...
    <path d="M15.6 2.7a10 10 0 105.7 5.7"/><circle cx="12" cy="12" r="2"/><path d="M13.4 10.6L19 5"/>
  </svg>
  <!-- #endif -->
