...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M16 8q6 0 6-6-6 0-6 6M17.41 3.59a10 10 0 103 3"/><path d="M2 2a26.6 26.6 0 0110 20c.9-6.82 1.5-9.5 4-14"/>`
...
<template>
  ...
  >
    ...
    <path d="M16 8q6 0 6-6-6 0-6 6M17.41 3.59a10 10 0 103 3"/><path d="M2 2a26.6 26.6 0 0110 20c.9-6.82 1.5-9.5 4-14"/>
  </svg>
  <!-- #endif -->
