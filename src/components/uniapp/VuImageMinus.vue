...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M21 9v10a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h7m4 2h6"/><circle cx="9" cy="9" r="2"/><path d="M21 15l-3.086-3.086a2 2 0 00-2.828 0L6 21"/>`
...
<template>
  ...
  >
    ...
    <path d="M21 9v10a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h7m4 2h6"/><circle cx="9" cy="9" r="2"/><path d="M21 15l-3.086-3.086a2 2 0 00-2.828 0L6 21"/>
  </svg>
  <!-- #endif -->
