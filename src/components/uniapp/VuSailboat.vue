...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M10 2v15m-3 5a4 4 0 01-4-4 1 1 0 011-1h16a1 1 0 011 1 4 4 0 01-4 4zM9.159 2.46a1 1 0 011.521-.193l9.977 8.98A1 1 0 0120 13H4a1 1 0 01-.824-1.567z"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 2v15m-3 5a4 4 0 01-4-4 1 1 0 011-1h16a1 1 0 011 1 4 4 0 01-4 4zM9.159 2.46a1 1 0 011.521-.193l9.977 8.98A1 1 0 0120 13H4a1 1 0 01-.824-1.567z"/>
  </svg>
  <!-- #endif -->
