...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M17 3a2 2 0 012 2v15a1 1 0 01-1.496.868l-4.512-2.578a2 2 0 00-1.984 0l-4.512 2.578A1 1 0 015 20V5a2 2 0 012-2z"/><path d="M9 10l2 2 4-4"/>`
...
<template>
  ...
  >
    ...
    <path d="M17 3a2 2 0 012 2v15a1 1 0 01-1.496.868l-4.512-2.578a2 2 0 00-1.984 0l-4.512 2.578A1 1 0 015 20V5a2 2 0 012-2z"/><path d="M9 10l2 2 4-4"/>
  </svg>
  <!-- #endif -->
