...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M2 8V6a2 2 0 012-2h16a2 2 0 012 2v12a2 2 0 01-2 2h-6M2 12a9 9 0 018 8m-8-4a5 5 0 014 4m-4 0h.01"/>`
...
<template>
  ...
  >
    ...
    <path d="M2 8V6a2 2 0 012-2h16a2 2 0 012 2v12a2 2 0 01-2 2h-6M2 12a9 9 0 018 8m-8-4a5 5 0 014 4m-4 0h.01"/>
  </svg>
  <!-- #endif -->
