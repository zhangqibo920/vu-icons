...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 18H4a2 2 0 01-2-2V8a2 2 0 012-2h16a2 2 0 012 2v5m-4-1h.01M19 22v-6m3 3l-3-3-3 3M6 12h.01"/><circle cx="12" cy="12" r="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 18H4a2 2 0 01-2-2V8a2 2 0 012-2h16a2 2 0 012 2v5m-4-1h.01M19 22v-6m3 3l-3-3-3 3M6 12h.01"/><circle cx="12" cy="12" r="2"/>
  </svg>
  <!-- #endif -->
