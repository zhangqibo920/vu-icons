...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M16 6l-8.414 8.586a2 2 0 002.829 2.829l8.414-8.586a4 4 0 10-5.657-5.657l-8.379 8.551a6 6 0 108.485 8.485l8.379-8.551"/>`
...
<template>
  ...
  >
    ...
    <path d="M16 6l-8.414 8.586a2 2 0 002.829 2.829l8.414-8.586a4 4 0 10-5.657-5.657l-8.379 8.551a6 6 0 108.485 8.485l8.379-8.551"/>
  </svg>
  <!-- #endif -->
