...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M17.5 12a1 1 0 110 9H9.006a7 7 0 116.702-9z"/><path d="M21.832 9A3 3 0 0019 7h-2.207a5.5 5.5 0 00-10.72.61"/>`
...
<template>
  ...
  >
    ...
    <path d="M17.5 12a1 1 0 110 9H9.006a7 7 0 116.702-9z"/><path d="M21.832 9A3 3 0 0019 7h-2.207a5.5 5.5 0 00-10.72.61"/>
  </svg>
  <!-- #endif -->
