...
const bgStyle = computed(() => {
  ...
  const svgContent = `<rect width="20" height="5" x="2" y="3" rx="1"/><path d="M4 8v11a2 2 0 002 2h2M20 8v11a2 2 0 01-2 2h-2m-7-6l3-3 3 3m-3-3v9"/>`
...
<template>
  ...
  >
    ...
    <rect width="20" height="5" x="2" y="3" rx="1"/><path d="M4 8v11a2 2 0 002 2h2M20 8v11a2 2 0 01-2 2h-2m-7-6l3-3 3 3m-3-3v9"/>
  </svg>
  <!-- #endif -->
