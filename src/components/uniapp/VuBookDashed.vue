...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 17h1.5M12 22h1.5M12 2h1.5m4 20H19a1 1 0 001-1M17.5 2H19a1 1 0 011 1v1.5m0 9.5v3h-2.5M20 8.5V10M4 10V8.5m0 11V14m0-9.5A2.5 2.5 0 016.5 2H8m0 20H6.5a1 1 0 010-5H8"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 17h1.5M12 22h1.5M12 2h1.5m4 20H19a1 1 0 001-1M17.5 2H19a1 1 0 011 1v1.5m0 9.5v3h-2.5M20 8.5V10M4 10V8.5m0 11V14m0-9.5A2.5 2.5 0 016.5 2H8m0 20H6.5a1 1 0 010-5H8"/>
  </svg>
  <!-- #endif -->
