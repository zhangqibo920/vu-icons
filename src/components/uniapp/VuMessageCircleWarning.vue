...
const name = 'VuMessageCircleWarning'
...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M2.992 16.342a2 2 0 01.094 1.167l-1.065 3.29a1 1 0 001.236 1.168l3.413-.998a2 2 0 011.099.092 10 10 0 10-4.777-4.719M12 8v4m0 4h.01"/>`
...
<template>
  ...
  >
    ...
    <path d="M2.992 16.342a2 2 0 01.094 1.167l-1.065 3.29a1 1 0 001.236 1.168l3.413-.998a2 2 0 011.099.092 10 10 0 10-4.777-4.719M12 8v4m0 4h.01"/>
  </svg>
  <!-- #endif -->
