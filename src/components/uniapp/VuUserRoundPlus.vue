...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M2 21a8 8 0 0113.292-6"/><circle cx="10" cy="8" r="5"/><path d="M19 16v6m3-3h-6"/>`
...
<template>
  ...
  >
    ...
    <path d="M2 21a8 8 0 0113.292-6"/><circle cx="10" cy="8" r="5"/><path d="M19 16v6m3-3h-6"/>
  </svg>
  <!-- #endif -->
