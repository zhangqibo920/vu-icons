...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M5 6a4 4 0 014-4h6a4 4 0 014 4v14a2 2 0 01-2 2H7a2 2 0 01-2-2zm0 4h14m-4-3v6"/>`
...
<template>
  ...
  >
    ...
    <path d="M5 6a4 4 0 014-4h6a4 4 0 014 4v14a2 2 0 01-2 2H7a2 2 0 01-2-2zm0 4h14m-4-3v6"/>
  </svg>
  <!-- #endif -->
