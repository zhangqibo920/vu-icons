...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 6v6l2 1M12.337 21.994a10 10 0 119.588-8.767"/><path d="M14 18l4 4 4-4m-4-4v8"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 6v6l2 1M12.337 21.994a10 10 0 119.588-8.767"/><path d="M14 18l4 4 4-4m-4-4v8"/>
  </svg>
  <!-- #endif -->
