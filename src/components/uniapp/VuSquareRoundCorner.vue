...
const name = 'VuSquareRoundCorner'
...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M21 11a8 8 0 00-8-8m8 12v4a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h4"/>`
...
<template>
  ...
  >
    ...
    <path d="M21 11a8 8 0 00-8-8m8 12v4a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h4"/>
  </svg>
  <!-- #endif -->
