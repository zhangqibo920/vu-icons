...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M4 22h14a2 2 0 002-2V7l-5-5H6a2 2 0 00-2 2v4"/><path d="M14 2v4a2 2 0 002 2h4M5 12l-3 3 3 3m4 0l3-3-3-3"/>`
...
<template>
  ...
  >
    ...
    <path d="M4 22h14a2 2 0 002-2V7l-5-5H6a2 2 0 00-2 2v4"/><path d="M14 2v4a2 2 0 002 2h4M5 12l-3 3 3 3m4 0l3-3-3-3"/>
  </svg>
  <!-- #endif -->
