...
const name = 'VuSquareArrowOutUpRight'
...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M21 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h6m10 0l-9 9m3-9h6v6"/>`
...
<template>
  ...
  >
    ...
    <path d="M21 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h6m10 0l-9 9m3-9h6v6"/>
  </svg>
  <!-- #endif -->
