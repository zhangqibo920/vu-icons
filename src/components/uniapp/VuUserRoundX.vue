...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M2 21a8 8 0 0111.873-7"/><circle cx="10" cy="8" r="5"/><path d="M17 17l5 5m0-5l-5 5"/>`
...
<template>
  ...
  >
    ...
    <path d="M2 21a8 8 0 0111.873-7"/><circle cx="10" cy="8" r="5"/><path d="M17 17l5 5m0-5l-5 5"/>
  </svg>
  <!-- #endif -->
