...
const name = 'VuLaptopMinimalCheck'
...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M2 20h20M9 10l2 2 4-4"/><rect width="18" height="12" x="3" y="4" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M2 20h20M9 10l2 2 4-4"/><rect width="18" height="12" x="3" y="4" rx="2"/>
  </svg>
  <!-- #endif -->
