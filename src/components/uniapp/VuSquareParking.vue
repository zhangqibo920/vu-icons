...
const bgStyle = computed(() => {
  ...
  const svgContent = `<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M9 17V7h4a3 3 0 010 6H9"/>`
...
<template>
  ...
  >
    ...
    <rect width="18" height="18" x="3" y="3" rx="2"/><path d="M9 17V7h4a3 3 0 010 6H9"/>
  </svg>
  <!-- #endif -->
