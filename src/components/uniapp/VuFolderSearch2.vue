...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<circle cx="11.5" cy="12.5" r="2.5"/><path d="M20 20a2 2 0 002-2V8a2 2 0 00-2-2h-7.9a2 2 0 01-1.69-.9L9.6 3.9A2 2 0 007.93 3H4a2 2 0 00-2 2v13a2 2 0 002 2zm-6.7-5.7L15 16"/>`
...
<template>
  ...
  >
    ...
    <circle cx="11.5" cy="12.5" r="2.5"/><path d="M20 20a2 2 0 002-2V8a2 2 0 00-2-2h-7.9a2 2 0 01-1.69-.9L9.6 3.9A2 2 0 007.93 3H4a2 2 0 00-2 2v13a2 2 0 002 2zm-6.7-5.7L15 16"/>
  </svg>
  <!-- #endif -->
