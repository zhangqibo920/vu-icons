...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 13v7a2 2 0 004 0M12 2v2"/><path d="M20.992 13a1 1 0 00.97-1.274 10.284 10.284 0 00-19.923 0A1 1 0 003 13z"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 13v7a2 2 0 004 0M12 2v2"/><path d="M20.992 13a1 1 0 00.97-1.274 10.284 10.284 0 00-19.923 0A1 1 0 003 13z"/>
  </svg>
  <!-- #endif -->
