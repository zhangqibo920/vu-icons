...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 3v17a1 1 0 01-1 1H5a2 2 0 01-2-2V5a2 2 0 012-2h14a2 2 0 012 2v6a1 1 0 01-1 1H3m13 7l2 2 4-4"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 3v17a1 1 0 01-1 1H5a2 2 0 01-2-2V5a2 2 0 012-2h14a2 2 0 012 2v6a1 1 0 01-1 1H3m13 7l2 2 4-4"/>
  </svg>
  <!-- #endif -->
