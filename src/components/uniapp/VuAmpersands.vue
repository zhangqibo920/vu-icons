...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M10 17c-5-3-7-7-7-9a2 2 0 014 0c0 2.5-5 2.5-5 6 0 1.7 1.3 3 3 3 2.8 0 5-2.2 5-5m12 5c-5-3-7-7-7-9a2 2 0 014 0c0 2.5-5 2.5-5 6 0 1.7 1.3 3 3 3 2.8 0 5-2.2 5-5"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 17c-5-3-7-7-7-9a2 2 0 014 0c0 2.5-5 2.5-5 6 0 1.7 1.3 3 3 3 2.8 0 5-2.2 5-5m12 5c-5-3-7-7-7-9a2 2 0 014 0c0 2.5-5 2.5-5 6 0 1.7 1.3 3 3 3 2.8 0 5-2.2 5-5"/>
  </svg>
  <!-- #endif -->
