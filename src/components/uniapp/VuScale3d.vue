...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M5 7v11a1 1 0 001 1h11m-11.707-.293L11 13"/><circle cx="19" cy="19" r="2"/><circle cx="5" cy="5" r="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M5 7v11a1 1 0 001 1h11m-11.707-.293L11 13"/><circle cx="19" cy="19" r="2"/><circle cx="5" cy="5" r="2"/>
  </svg>
  <!-- #endif -->
