...
const bgStyle = computed(() => {
  ...
  const svgContent = `<rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><path d="M3 15h18"/>`
...
<template>
  ...
  >
    ...
    <rect width="18" height="18" x="3" y="3" rx="2" ry="2"/><path d="M3 15h18"/>
  </svg>
  <!-- #endif -->
