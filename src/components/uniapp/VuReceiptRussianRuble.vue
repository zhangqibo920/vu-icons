...
const name = 'VuReceiptRussianRuble'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1zm4 13h5"/><path d="M8 11h5a2 2 0 100-4h-3v10"/>`
...
<template>
  ...
  >
    ...
    <path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1zm4 13h5"/><path d="M8 11h5a2 2 0 100-4h-3v10"/>
  </svg>
  <!-- #endif -->
