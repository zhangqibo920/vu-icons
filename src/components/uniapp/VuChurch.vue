...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M10 9h4m-2-2v5m2 9v-3a2 2 0 00-4 0v3"/><path d="M18 9l3.52 2.147a1 1 0 01.48.854V19a2 2 0 01-2 2H4a2 2 0 01-2-2v-6.999a1 1 0 01.48-.854L6 9"/><path d="M6 21V7a1 1 0 01.376-.782l5-3.999a1 1 0 011.249.001l5 4A1 1 0 0118 7v14"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 9h4m-2-2v5m2 9v-3a2 2 0 00-4 0v3"/><path d="M18 9l3.52 2.147a1 1 0 01.48.854V19a2 2 0 01-2 2H4a2 2 0 01-2-2v-6.999a1 1 0 01.48-.854L6 9"/><path d="M6 21V7a1 1 0 01.376-.782l5-3.999a1 1 0 011.249.001l5 4A1 1 0 0118 7v14"/>
  </svg>
  <!-- #endif -->
