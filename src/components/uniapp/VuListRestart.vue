...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M21 5H3m4 7H3m4 7H3m9-1a5 5 0 009-3 4.5 4.5 0 00-4.5-4.5c-1.33 0-2.54.54-3.41 1.41L11 14"/><path d="M11 10v4h4"/>`
...
<template>
  ...
  >
    ...
    <path d="M21 5H3m4 7H3m4 7H3m9-1a5 5 0 009-3 4.5 4.5 0 00-4.5-4.5c-1.33 0-2.54.54-3.41 1.41L11 14"/><path d="M11 10v4h4"/>
  </svg>
  <!-- #endif -->
