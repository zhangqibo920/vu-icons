...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 17v4m10-8.693V15a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h8.693M8 21h8"/><circle cx="19" cy="6" r="3"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 17v4m10-8.693V15a2 2 0 01-2 2H4a2 2 0 01-2-2V5a2 2 0 012-2h8.693M8 21h8"/><circle cx="19" cy="6" r="3"/>
  </svg>
  <!-- #endif -->
