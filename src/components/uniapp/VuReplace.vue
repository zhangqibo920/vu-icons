...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M14 4a1 1 0 011-1m0 7a1 1 0 01-1-1m7-5a1 1 0 00-1-1m1 6a1 1 0 01-1 1M3 7l3 3 3-3"/><path d="M6 10V5a2 2 0 012-2h2"/><rect width="7" height="7" x="3" y="14" rx="1"/>`
...
<template>
  ...
  >
    ...
    <path d="M14 4a1 1 0 011-1m0 7a1 1 0 01-1-1m7-5a1 1 0 00-1-1m1 6a1 1 0 01-1 1M3 7l3 3 3-3"/><path d="M6 10V5a2 2 0 012-2h2"/><rect width="7" height="7" x="3" y="14" rx="1"/>
  </svg>
  <!-- #endif -->
