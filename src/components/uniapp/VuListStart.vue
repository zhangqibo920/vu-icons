...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M3 5h6m-6 7h13M3 19h13m0-11l-3-3 3-3"/><path d="M21 19V7a2 2 0 00-2-2h-6"/>`
...
<template>
  ...
  >
    ...
    <path d="M3 5h6m-6 7h13M3 19h13m0-11l-3-3 3-3"/><path d="M21 19V7a2 2 0 00-2-2h-6"/>
  </svg>
  <!-- #endif -->
