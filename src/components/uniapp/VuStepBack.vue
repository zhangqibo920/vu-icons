...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M13.971 4.285A2 2 0 0117 6v12a2 2 0 01-3.029 1.715l-9.997-5.998a2 2 0 01-.003-3.432zM21 20V4"/>`
...
<template>
  ...
  >
    ...
    <path d="M13.971 4.285A2 2 0 0117 6v12a2 2 0 01-3.029 1.715l-9.997-5.998a2 2 0 01-.003-3.432zM21 20V4"/>
  </svg>
  <!-- #endif -->
