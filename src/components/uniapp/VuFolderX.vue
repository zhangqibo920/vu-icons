...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M20 20a2 2 0 002-2V8a2 2 0 00-2-2h-7.9a2 2 0 01-1.69-.9L9.6 3.9A2 2 0 007.93 3H4a2 2 0 00-2 2v13a2 2 0 002 2zM9.5 10.5l5 5m0-5l-5 5"/>`
...
<template>
  ...
  >
    ...
    <path d="M20 20a2 2 0 002-2V8a2 2 0 00-2-2h-7.9a2 2 0 01-1.69-.9L9.6 3.9A2 2 0 007.93 3H4a2 2 0 00-2 2v13a2 2 0 002 2zM9.5 10.5l5 5m0-5l-5 5"/>
  </svg>
  <!-- #endif -->
