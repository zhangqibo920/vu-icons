...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M2 9l3-3 3 3"/><path d="M13 18H7a2 2 0 01-2-2V6m17 9l-3 3-3-3"/><path d="M11 6h6a2 2 0 012 2v10"/>`
...
<template>
  ...
  >
    ...
    <path d="M2 9l3-3 3 3"/><path d="M13 18H7a2 2 0 01-2-2V6m17 9l-3 3-3-3"/><path d="M11 6h6a2 2 0 012 2v10"/>
  </svg>
  <!-- #endif -->
