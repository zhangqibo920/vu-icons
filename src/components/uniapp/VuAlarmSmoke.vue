...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M11 21c0-2.5 2-2.5 2-5m3 5c0-2.5 2-2.5 2-5m1-8l-.8 3a1.25 1.25 0 01-1.2 1H7a1.25 1.25 0 01-1.2-1L5 8m16-5a1 1 0 011 1v2a2 2 0 01-2 2H4a2 2 0 01-2-2V4a1 1 0 011-1zM6 21c0-2.5 2-2.5 2-5"/>`
...
<template>
  ...
  >
    ...
    <path d="M11 21c0-2.5 2-2.5 2-5m3 5c0-2.5 2-2.5 2-5m1-8l-.8 3a1.25 1.25 0 01-1.2 1H7a1.25 1.25 0 01-1.2-1L5 8m16-5a1 1 0 011 1v2a2 2 0 01-2 2H4a2 2 0 01-2-2V4a1 1 0 011-1zM6 21c0-2.5 2-2.5 2-5"/>
  </svg>
  <!-- #endif -->
