...
const name = 'VuBetweenHorizontalStart'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<rect width="13" height="7" x="8" y="3" rx="1"/><path d="M2 9l3 3-3 3"/><rect width="13" height="7" x="8" y="14" rx="1"/>`
...
<template>
  ...
  >
    ...
    <rect width="13" height="7" x="8" y="3" rx="1"/><path d="M2 9l3 3-3 3"/><rect width="13" height="7" x="8" y="14" rx="1"/>
  </svg>
  <!-- #endif -->
