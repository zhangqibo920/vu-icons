...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<circle cx="11" cy="11" r="8"/><path d="M21 21l-4.3-4.3M11 11a2 2 0 004 0 4 4 0 00-8 0 6 6 0 0012 0"/>`
...
<template>
  ...
  >
    ...
    <circle cx="11" cy="11" r="8"/><path d="M21 21l-4.3-4.3M11 11a2 2 0 004 0 4 4 0 00-8 0 6 6 0 0012 0"/>
  </svg>
  <!-- #endif -->
