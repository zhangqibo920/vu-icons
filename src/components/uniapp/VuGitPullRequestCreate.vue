...
const name = 'VuGitPullRequestCreate'
...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<circle cx="6" cy="6" r="3"/><path d="M6 9v12m7-15h3a2 2 0 012 2v3m0 4v6m3-3h-6"/>`
...
<template>
  ...
  >
    ...
    <circle cx="6" cy="6" r="3"/><path d="M6 9v12m7-15h3a2 2 0 012 2v3m0 4v6m3-3h-6"/>
  </svg>
  <!-- #endif -->
