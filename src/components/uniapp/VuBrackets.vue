...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M16 3h3a1 1 0 011 1v16a1 1 0 01-1 1h-3m-8 0H5a1 1 0 01-1-1V4a1 1 0 011-1h3"/>`
...
<template>
  ...
  >
    ...
    <path d="M16 3h3a1 1 0 011 1v16a1 1 0 01-1 1h-3m-8 0H5a1 1 0 01-1-1V4a1 1 0 011-1h3"/>
  </svg>
  <!-- #endif -->
