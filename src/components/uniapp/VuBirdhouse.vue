...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 18v4m5-4l1.956-11.468M3 8l7.82-5.615a2 2 0 012.36 0L21 8M4 18h16M7 18L5.044 6.532"/><circle cx="12" cy="10" r="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 18v4m5-4l1.956-11.468M3 8l7.82-5.615a2 2 0 012.36 0L21 8M4 18h16M7 18L5.044 6.532"/><circle cx="12" cy="10" r="2"/>
  </svg>
  <!-- #endif -->
