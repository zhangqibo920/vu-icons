...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 3v18m-9-9h18"/><rect width="18" height="18" x="3" y="3" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 3v18m-9-9h18"/><rect width="18" height="18" x="3" y="3" rx="2"/>
  </svg>
  <!-- #endif -->
