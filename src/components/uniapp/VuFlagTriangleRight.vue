...
const name = 'VuFlagTriangleRight'
...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M6 22V2.8a.8.8 0 011.17-.71l11.38 5.69a.8.8 0 010 1.44L6 15.5"/>`
...
<template>
  ...
  >
    ...
    <path d="M6 22V2.8a.8.8 0 011.17-.71l11.38 5.69a.8.8 0 010 1.44L6 15.5"/>
  </svg>
  <!-- #endif -->
