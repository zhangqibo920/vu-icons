...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M17.5 22h.5a2 2 0 002-2V7l-5-5H6a2 2 0 00-2 2v3"/><path d="M14 2v4a2 2 0 002 2h4M2 19a2 2 0 114 0v1a2 2 0 11-4 0v-4a6 6 0 0112 0v4a2 2 0 11-4 0v-1a2 2 0 114 0"/>`
...
<template>
  ...
  >
    ...
    <path d="M17.5 22h.5a2 2 0 002-2V7l-5-5H6a2 2 0 00-2 2v3"/><path d="M14 2v4a2 2 0 002 2h4M2 19a2 2 0 114 0v1a2 2 0 11-4 0v-4a6 6 0 0112 0v4a2 2 0 11-4 0v-1a2 2 0 114 0"/>
  </svg>
  <!-- #endif -->
