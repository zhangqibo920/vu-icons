...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M5.2 6.2l1.4 1.4M2 13h2m16 0h2m-4.6-5.4l1.4-1.4M22 17H2m20 4H2m14-8a4 4 0 00-8 0m4-8V2.5"/>`
...
<template>
  ...
  >
    ...
    <path d="M5.2 6.2l1.4 1.4M2 13h2m16 0h2m-4.6-5.4l1.4-1.4M22 17H2m20 4H2m14-8a4 4 0 00-8 0m4-8V2.5"/>
  </svg>
  <!-- #endif -->
