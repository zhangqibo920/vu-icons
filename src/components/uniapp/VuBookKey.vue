...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M19 3l1 1m0-2l-4.5 4.5M20 7.898V21a1 1 0 01-1 1H6.5a1 1 0 010-5H20"/><path d="M4 19.5v-15A2.5 2.5 0 016.5 2h7.844"/><circle cx="14" cy="8" r="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M19 3l1 1m0-2l-4.5 4.5M20 7.898V21a1 1 0 01-1 1H6.5a1 1 0 010-5H20"/><path d="M4 19.5v-15A2.5 2.5 0 016.5 2h7.844"/><circle cx="14" cy="8" r="2"/>
  </svg>
  <!-- #endif -->
