...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M3 16l4 4 4-4m-4 4V4"/><rect width="4" height="6" x="15" y="4" ry="2"/><path d="M17 20v-6h-2m0 6h4"/>`
...
<template>
  ...
  >
    ...
    <path d="M3 16l4 4 4-4m-4 4V4"/><rect width="4" height="6" x="15" y="4" ry="2"/><path d="M17 20v-6h-2m0 6h4"/>
  </svg>
  <!-- #endif -->
