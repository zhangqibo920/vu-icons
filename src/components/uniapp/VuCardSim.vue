...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 14v4m2.172-16a2 2 0 011.414.586l3.828 3.828A2 2 0 0120 7.828V20a2 2 0 01-2 2H6a2 2 0 01-2-2V4a2 2 0 012-2zM8 14h8"/><rect width="8" height="8" x="8" y="10" rx="1"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 14v4m2.172-16a2 2 0 011.414.586l3.828 3.828A2 2 0 0120 7.828V20a2 2 0 01-2 2H6a2 2 0 01-2-2V4a2 2 0 012-2zM8 14h8"/><rect width="8" height="8" x="8" y="10" rx="1"/>
  </svg>
  <!-- #endif -->
