...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path fill="currentColor" fill-rule="evenodd" d="M18.874 19.581a6 6 0 11.707-.707l4.273 4.272-.708.708zM20 15a5 5 0 11-10 0 5 5 0 0110 0z" clip-rule="evenodd"/>`
  
  const svg = `<svg viewBox='0 0 32 32' fill='none' stroke='${props.color}' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' xmlns='http://www.w3.org/2000/svg' style='width:100%;height:100%;'>${spinNode}${svgContent}</svg>`
...
<template>
  ...
  >
    ...
    <path fill="currentColor" fill-rule="evenodd" d="M18.874 19.581a6 6 0 11.707-.707l4.273 4.272-.708.708zM20 15a5 5 0 11-10 0 5 5 0 0110 0z" clip-rule="evenodd"/>
  </svg>
  <!-- #endif -->
