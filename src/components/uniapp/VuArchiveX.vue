...
const bgStyle = computed(() => {
  ...
  const svgContent = `<rect width="20" height="5" x="2" y="3" rx="1"/><path d="M4 8v11a2 2 0 002 2h12a2 2 0 002-2V8M9.5 17l5-5m-5 0l5 5"/>`
...
<template>
  ...
  >
    ...
    <rect width="20" height="5" x="2" y="3" rx="1"/><path d="M4 8v11a2 2 0 002 2h12a2 2 0 002-2V8M9.5 17l5-5m-5 0l5 5"/>
  </svg>
  <!-- #endif -->
