...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M13 13H8a1 1 0 00-1 1v7m7-13h1m2 13v-4M2 2l20 20"/><path d="M20.41 20.41A2 2 0 0119 21H5a2 2 0 01-2-2V5a2 2 0 01.59-1.41M29.5 11.5s5 5 4 5M9 3h6.2a2 2 0 011.4.6l3.8 3.8a2 2 0 01.6 1.4V15"/>`
...
<template>
  ...
  >
    ...
    <path d="M13 13H8a1 1 0 00-1 1v7m7-13h1m2 13v-4M2 2l20 20"/><path d="M20.41 20.41A2 2 0 0119 21H5a2 2 0 01-2-2V5a2 2 0 01.59-1.41M29.5 11.5s5 5 4 5M9 3h6.2a2 2 0 011.4.6l3.8 3.8a2 2 0 01.6 1.4V15"/>
  </svg>
  <!-- #endif -->
