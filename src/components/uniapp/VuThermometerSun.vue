...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 2v2m0 4a4 4 0 00-1.645 7.647M2 12h2m16 2.54a4 4 0 11-4 0V4a2 2 0 014 0zM4.93 4.93l1.41 1.41m0 11.32l-1.41 1.41"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 2v2m0 4a4 4 0 00-1.645 7.647M2 12h2m16 2.54a4 4 0 11-4 0V4a2 2 0 014 0zM4.93 4.93l1.41 1.41m0 11.32l-1.41 1.41"/>
  </svg>
  <!-- #endif -->
