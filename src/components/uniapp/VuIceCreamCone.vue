...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M7 11l4.08 10.35a1 1 0 001.84 0L17 11m0-4A5 5 0 007 7m10 0a2 2 0 010 4H7a2 2 0 010-4"/>`
...
<template>
  ...
  >
    ...
    <path d="M7 11l4.08 10.35a1 1 0 001.84 0L17 11m0-4A5 5 0 007 7m10 0a2 2 0 010 4H7a2 2 0 010-4"/>
  </svg>
  <!-- #endif -->
