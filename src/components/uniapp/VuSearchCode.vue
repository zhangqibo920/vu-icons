...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M13 13.5l2-2.5-2-2.5M21 21l-4.3-4.3M9 8.5L7 11l2 2.5"/><circle cx="11" cy="11" r="8"/>`
...
<template>
  ...
  >
    ...
    <path d="M13 13.5l2-2.5-2-2.5M21 21l-4.3-4.3M9 8.5L7 11l2 2.5"/><circle cx="11" cy="11" r="8"/>
  </svg>
  <!-- #endif -->
