...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M3 12a9 9 0 109-9 9.75 9.75 0 00-6.74 2.74L3 8"/><path d="M3 3v5h5m4-1v5l4 2"/>`
...
<template>
  ...
  >
    ...
    <path d="M3 12a9 9 0 109-9 9.75 9.75 0 00-6.74 2.74L3 8"/><path d="M3 3v5h5m4-1v5l4 2"/>
  </svg>
  <!-- #endif -->
