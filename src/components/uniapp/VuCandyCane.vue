...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M5.7 21a2 2 0 01-3.5-2l8.6-14a6 6 0 0110.4 6 2 2 0 11-3.464-2 2 2 0 10-3.464-2zM17.75 7L15 2.1m-4.1 2.7L13 9m-5.1.7l2 4.4m-5 .6L7 18.9"/>`
...
<template>
  ...
  >
    ...
    <path d="M5.7 21a2 2 0 01-3.5-2l8.6-14a6 6 0 0110.4 6 2 2 0 11-3.464-2 2 2 0 10-3.464-2zM17.75 7L15 2.1m-4.1 2.7L13 9m-5.1.7l2 4.4m-5 .6L7 18.9"/>
  </svg>
  <!-- #endif -->
