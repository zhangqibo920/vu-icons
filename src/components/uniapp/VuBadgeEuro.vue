...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M3.85 8.62a4 4 0 014.78-4.77 4 4 0 016.74 0 4 4 0 014.78 4.78 4 4 0 010 6.74 4 4 0 01-4.77 4.78 4 4 0 01-6.75 0 4 4 0 01-4.78-4.77 4 4 0 010-6.76M7 12h5M15 9.4a4 4 0 100 5.2"/>`
...
<template>
  ...
  >
    ...
    <path d="M3.85 8.62a4 4 0 014.78-4.77 4 4 0 016.74 0 4 4 0 014.78 4.78 4 4 0 010 6.74 4 4 0 01-4.77 4.78 4 4 0 01-6.75 0 4 4 0 01-4.78-4.77 4 4 0 010-6.76M7 12h5M15 9.4a4 4 0 100 5.2"/>
  </svg>
  <!-- #endif -->
