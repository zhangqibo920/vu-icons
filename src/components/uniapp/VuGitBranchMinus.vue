...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M15 6a9 9 0 00-9 9V3m15 15h-6"/><circle cx="18" cy="6" r="3"/><circle cx="6" cy="18" r="3"/>`
...
<template>
  ...
  >
    ...
    <path d="M15 6a9 9 0 00-9 9V3m15 15h-6"/><circle cx="18" cy="6" r="3"/><circle cx="6" cy="18" r="3"/>
  </svg>
  <!-- #endif -->
