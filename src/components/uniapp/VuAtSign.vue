...
const bgStyle = computed(() => {
  ...
  const svgContent = `<circle cx="12" cy="12" r="4"/><path d="M16 8v5a3 3 0 006 0v-1a10 10 0 10-4 8"/>`
...
<template>
  ...
  >
    ...
    <circle cx="12" cy="12" r="4"/><path d="M16 8v5a3 3 0 006 0v-1a10 10 0 10-4 8"/>
  </svg>
  <!-- #endif -->
