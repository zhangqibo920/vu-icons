...
const name = 'VuSquareArrowOutDownRight'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M21 11V5a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2h6m10 0l-9-9m9 3v6h-6"/>`
...
<template>
  ...
  >
    ...
    <path d="M21 11V5a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2h6m10 0l-9-9m9 3v6h-6"/>
  </svg>
  <!-- #endif -->
