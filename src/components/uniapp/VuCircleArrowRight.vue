...
const bgStyle = computed(() => {
  ...
  const svgContent = `<circle cx="12" cy="12" r="10"/><path d="M12 16l4-4-4-4m-4 4h8"/>`
...
<template>
  ...
  >
    ...
    <circle cx="12" cy="12" r="10"/><path d="M12 16l4-4-4-4m-4 4h8"/>
  </svg>
  <!-- #endif -->
