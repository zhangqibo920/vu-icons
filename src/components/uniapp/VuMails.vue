...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M17 19a2 2 0 01-2 2H4a2 2 0 01-2-2v-8a2 2 0 011-1.732M22 5.5l-6.419 4.179a2 2 0 01-2.162 0L7 5.5"/><rect width="15" height="12" x="7" y="3" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M17 19a2 2 0 01-2 2H4a2 2 0 01-2-2v-8a2 2 0 011-1.732M22 5.5l-6.419 4.179a2 2 0 01-2.162 0L7 5.5"/><rect width="15" height="12" x="7" y="3" rx="2"/>
  </svg>
  <!-- #endif -->
