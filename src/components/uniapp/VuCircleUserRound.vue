...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M18 20a6 6 0 00-12 0"/><circle cx="12" cy="10" r="4"/><circle cx="12" cy="12" r="10"/>`
...
<template>
  ...
  >
    ...
    <path d="M18 20a6 6 0 00-12 0"/><circle cx="12" cy="10" r="4"/><circle cx="12" cy="12" r="10"/>
  </svg>
  <!-- #endif -->
