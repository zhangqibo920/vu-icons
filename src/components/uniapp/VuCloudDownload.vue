...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 13v8l-4-4m4 4l4-4"/><path d="M4.393 15.269A7 7 0 1115.71 8h1.79a4.5 4.5 0 012.436 8.284"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 13v8l-4-4m4 4l4-4"/><path d="M4.393 15.269A7 7 0 1115.71 8h1.79a4.5 4.5 0 012.436 8.284"/>
  </svg>
  <!-- #endif -->
