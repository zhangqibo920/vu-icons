...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M20 4a2 2 0 012 2m0 0v10.41M7 16h9M9.69 4H20m-6 4h.01M18 8h.01M2 2l20 20m-2-2H4a2 2 0 01-2-2V6a2 2 0 012-2m2 4h.01M8 12h.01"/>`
...
<template>
  ...
  >
    ...
    <path d="M20 4a2 2 0 012 2m0 0v10.41M7 16h9M9.69 4H20m-6 4h.01M18 8h.01M2 2l20 20m-2-2H4a2 2 0 01-2-2V6a2 2 0 012-2m2 4h.01M8 12h.01"/>
  </svg>
  <!-- #endif -->
