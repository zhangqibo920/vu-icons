...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M6 18h8M3 22h18m-7 0a7 7 0 100-14h-1m-4 6h2m-2-2a2 2 0 01-2-2V6h6v4a2 2 0 01-2 2zm3-6V3a1 1 0 00-1-1H9a1 1 0 00-1 1v3"/>`
...
<template>
  ...
  >
    ...
    <path d="M6 18h8M3 22h18m-7 0a7 7 0 100-14h-1m-4 6h2m-2-2a2 2 0 01-2-2V6h6v4a2 2 0 01-2 2zm3-6V3a1 1 0 00-1-1H9a1 1 0 00-1 1v3"/>
  </svg>
  <!-- #endif -->
