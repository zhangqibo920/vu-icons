...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M11 10v4h4"/><path d="M11 14l1.535-1.605a5 5 0 018 1.5M16 2v4m5 12l-1.535 1.605a5 5 0 01-8-1.5"/><path d="M21 22v-4h-4m4-9.5V6a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2h4.3M3 10h4m1-8v4"/>`
...
<template>
  ...
  >
    ...
    <path d="M11 10v4h4"/><path d="M11 14l1.535-1.605a5 5 0 018 1.5M16 2v4m5 12l-1.535 1.605a5 5 0 01-8-1.5"/><path d="M21 22v-4h-4m4-9.5V6a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2h4.3M3 10h4m1-8v4"/>
  </svg>
  <!-- #endif -->
