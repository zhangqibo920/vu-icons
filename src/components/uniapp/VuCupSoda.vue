...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M6 8l1.75 12.28a2 2 0 002 1.72h4.54a2 2 0 002-1.72L18 8M5 8h14"/><path d="M7 15a6.47 6.47 0 015 0 6.47 6.47 0 005 0m-5-7l1-6h2"/>`
...
<template>
  ...
  >
    ...
    <path d="M6 8l1.75 12.28a2 2 0 002 1.72h4.54a2 2 0 002-1.72L18 8M5 8h14"/><path d="M7 15a6.47 6.47 0 015 0 6.47 6.47 0 005 0m-5-7l1-6h2"/>
  </svg>
  <!-- #endif -->
