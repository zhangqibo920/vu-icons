...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M11.1 22H6a2 2 0 01-2-2V4a2 2 0 012-2h8a2.4 2.4 0 011.706.706l3.589 3.588A2.4 2.4 0 0120 8v3.25"/><path d="M14 2v5a1 1 0 001 1h5m1 14l-2.88-2.88"/><circle cx="16" cy="17" r="3"/>`
...
<template>
  ...
  >
    ...
    <path d="M11.1 22H6a2 2 0 01-2-2V4a2 2 0 012-2h8a2.4 2.4 0 011.706.706l3.589 3.588A2.4 2.4 0 0120 8v3.25"/><path d="M14 2v5a1 1 0 001 1h5m1 14l-2.88-2.88"/><circle cx="16" cy="17" r="3"/>
  </svg>
  <!-- #endif -->
