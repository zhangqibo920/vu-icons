...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M15 20l3-3h2a2 2 0 002-2V6a2 2 0 00-2-2H4a2 2 0 00-2 2v9a2 2 0 002 2h2l3 3zM6 8v1m4-1v1m4-1v1m4-1v1"/>`
...
<template>
  ...
  >
    ...
    <path d="M15 20l3-3h2a2 2 0 002-2V6a2 2 0 00-2-2H4a2 2 0 00-2 2v9a2 2 0 002 2h2l3 3zM6 8v1m4-1v1m4-1v1m4-1v1"/>
  </svg>
  <!-- #endif -->
