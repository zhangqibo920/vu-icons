...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M17 18l-1.535 1.605a5 5 0 01-8-1.5"/><path d="M17 22v-4h-4m7.996-2.749A4.5 4.5 0 0017.495 8h-1.79a7 7 0 10-12.709 5.607"/><path d="M7 10v4h4"/><path d="M7 14l1.535-1.605a5 5 0 018 1.5"/>`
...
<template>
  ...
  >
    ...
    <path d="M17 18l-1.535 1.605a5 5 0 01-8-1.5"/><path d="M17 22v-4h-4m7.996-2.749A4.5 4.5 0 0017.495 8h-1.79a7 7 0 10-12.709 5.607"/><path d="M7 10v4h4"/><path d="M7 14l1.535-1.605a5 5 0 018 1.5"/>
  </svg>
  <!-- #endif -->
