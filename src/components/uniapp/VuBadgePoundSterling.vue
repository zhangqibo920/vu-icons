...
const name = 'VuBadgePoundSterling'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M3.85 8.62a4 4 0 014.78-4.77 4 4 0 016.74 0 4 4 0 014.78 4.78 4 4 0 010 6.74 4 4 0 01-4.77 4.78 4 4 0 01-6.75 0 4 4 0 01-4.78-4.77 4 4 0 010-6.76M8 12h4"/><path d="M10 16V9.5a2.5 2.5 0 015 0M8 16h7"/>`
...
<template>
  ...
  >
    ...
    <path d="M3.85 8.62a4 4 0 014.78-4.77 4 4 0 016.74 0 4 4 0 014.78 4.78 4 4 0 010 6.74 4 4 0 01-4.77 4.78 4 4 0 01-6.75 0 4 4 0 01-4.78-4.77 4 4 0 010-6.76M8 12h4"/><path d="M10 16V9.5a2.5 2.5 0 015 0M8 16h7"/>
  </svg>
  <!-- #endif -->
