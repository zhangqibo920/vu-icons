...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M9.31 9.31L5 21l7-4 7 4-1.17-3.17m-3.3-8.95L12 2l-1.17 3.17M2 2l20 20"/>`
...
<template>
  ...
  >
    ...
    <path d="M9.31 9.31L5 21l7-4 7 4-1.17-3.17m-3.3-8.95L12 2l-1.17 3.17M2 2l20 20"/>
  </svg>
  <!-- #endif -->
