...
const name = 'VuSquareArrowOutDownLeft'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M13 21h6a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v6m0 10l9-9m-3 9H3v-6"/>`
...
<template>
  ...
  >
    ...
    <path d="M13 21h6a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v6m0 10l9-9m-3 9H3v-6"/>
  </svg>
  <!-- #endif -->
