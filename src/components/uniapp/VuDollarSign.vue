...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 2v20m5-17H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 2v20m5-17H9.5a3.5 3.5 0 000 7h5a3.5 3.5 0 010 7H6"/>
  </svg>
  <!-- #endif -->
