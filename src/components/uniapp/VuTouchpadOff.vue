...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 20v-6m7.656 0H22M2 14h12M2 2l20 20m-2-2H4a2 2 0 01-2-2V6a2 2 0 012-2m5.656 0H20a2 2 0 012 2v10.344"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 20v-6m7.656 0H22M2 14h12M2 2l20 20m-2-2H4a2 2 0 01-2-2V6a2 2 0 012-2m5.656 0H20a2 2 0 012 2v10.344"/>
  </svg>
  <!-- #endif -->
