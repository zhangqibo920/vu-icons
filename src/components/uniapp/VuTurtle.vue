...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 10l2 4v3a1 1 0 001 1h2a1 1 0 001-1v-3a8 8 0 10-16 0v3a1 1 0 001 1h2a1 1 0 001-1v-3l2-4zM4.82 7.9L8 10m7.18-2.1L12 10"/><path d="M16.93 10H20a2 2 0 010 4H2"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 10l2 4v3a1 1 0 001 1h2a1 1 0 001-1v-3a8 8 0 10-16 0v3a1 1 0 001 1h2a1 1 0 001-1v-3l2-4zM4.82 7.9L8 10m7.18-2.1L12 10"/><path d="M16.93 10H20a2 2 0 010 4H2"/>
  </svg>
  <!-- #endif -->
