...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M13 5h8m-8 7h8m-8 7h8M3 17l2 2 4-4"/><rect width="6" height="6" x="3" y="4" rx="1"/>`
...
<template>
  ...
  >
    ...
    <path d="M13 5h8m-8 7h8m-8 7h8M3 17l2 2 4-4"/><rect width="6" height="6" x="3" y="4" rx="1"/>
  </svg>
  <!-- #endif -->
