...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M17 17l-5 5V12l-5 5M2 2l20 20M14.5 9.5L17 7l-5-5v4.5"/>`
...
<template>
  ...
  >
    ...
    <path d="M17 17l-5 5V12l-5 5M2 2l20 20M14.5 9.5L17 7l-5-5v4.5"/>
  </svg>
  <!-- #endif -->
