...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M9 10l3-3 3 3m-3 3V7"/><rect width="20" height="14" x="2" y="3" rx="2"/><path d="M12 17v4m-4 0h8"/>`
...
<template>
  ...
  >
    ...
    <path d="M9 10l3-3 3 3m-3 3V7"/><rect width="20" height="14" x="2" y="3" rx="2"/><path d="M12 17v4m-4 0h8"/>
  </svg>
  <!-- #endif -->
