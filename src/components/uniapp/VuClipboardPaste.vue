...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M11 14h10M16 4h2a2 2 0 012 2v1.344M17 18l4-4-4-4"/><path d="M8 4H6a2 2 0 00-2 2v14a2 2 0 002 2h12a2 2 0 001.793-1.113"/><rect width="8" height="4" x="8" y="2" rx="1"/>`
...
<template>
  ...
  >
    ...
    <path d="M11 14h10M16 4h2a2 2 0 012 2v1.344M17 18l4-4-4-4"/><path d="M8 4H6a2 2 0 00-2 2v14a2 2 0 002 2h12a2 2 0 001.793-1.113"/><rect width="8" height="4" x="8" y="2" rx="1"/>
  </svg>
  <!-- #endif -->
