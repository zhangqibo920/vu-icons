...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M11 16.586V19a1 1 0 01-1 1H2L18.37 3.63a1 1 0 113 3l-9.663 9.663a1 1 0 01-1.414 0L8 14"/>`
...
<template>
  ...
  >
    ...
    <path d="M11 16.586V19a1 1 0 01-1 1H2L18.37 3.63a1 1 0 113 3l-9.663 9.663a1 1 0 01-1.414 0L8 14"/>
  </svg>
  <!-- #endif -->
