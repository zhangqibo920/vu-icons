...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M7 2h13a2 2 0 012 2v4a2 2 0 01-2 2h-5m-5 0L2.5 2.5C2 2 2 2.5 2 5v3a2 2 0 002 2zm12 7v-1a2 2 0 00-2-2h-1M4 14a2 2 0 00-2 2v4a2 2 0 002 2h16.5l1-.5.5.5-8-8zm2 4h.01M2 2l20 20"/>`
...
<template>
  ...
  >
    ...
    <path d="M7 2h13a2 2 0 012 2v4a2 2 0 01-2 2h-5m-5 0L2.5 2.5C2 2 2 2.5 2 5v3a2 2 0 002 2zm12 7v-1a2 2 0 00-2-2h-1M4 14a2 2 0 00-2 2v4a2 2 0 002 2h16.5l1-.5.5.5-8-8zm2 4h.01M2 2l20 20"/>
  </svg>
  <!-- #endif -->
