...
const bgStyle = computed(() => {
  ...
  const svgContent = `<circle cx="10" cy="8" r="5"/><path d="M2 21a8 8 0 0110.434-7.62"/><circle cx="18" cy="18" r="3"/><path d="M22 22l-1.9-1.9"/>`
...
<template>
  ...
  >
    ...
    <circle cx="10" cy="8" r="5"/><path d="M2 21a8 8 0 0110.434-7.62"/><circle cx="18" cy="18" r="3"/><path d="M22 22l-1.9-1.9"/>
  </svg>
  <!-- #endif -->
