...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M9 17H7A5 5 0 017 7m8 0h2a5 5 0 014 8M8 12h4M2 2l20 20"/>`
...
<template>
  ...
  >
    ...
    <path d="M9 17H7A5 5 0 017 7m8 0h2a5 5 0 014 8M8 12h4M2 2l20 20"/>
  </svg>
  <!-- #endif -->
