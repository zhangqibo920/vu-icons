...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M14 4v16H3a1 1 0 01-1-1V5a1 1 0 011-1z"/><circle cx="14" cy="12" r="8"/>`
...
<template>
  ...
  >
    ...
    <path d="M14 4v16H3a1 1 0 01-1-1V5a1 1 0 011-1z"/><circle cx="14" cy="12" r="8"/>
  </svg>
  <!-- #endif -->
