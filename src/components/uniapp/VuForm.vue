...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M4 14h6M4 2h10"/><rect width="16" height="4" x="4" y="18" rx="1"/><rect width="16" height="4" x="4" y="6" rx="1"/>`
...
<template>
  ...
  >
    ...
    <path d="M4 14h6M4 2h10"/><rect width="16" height="4" x="4" y="18" rx="1"/><rect width="16" height="4" x="4" y="6" rx="1"/>
  </svg>
  <!-- #endif -->
