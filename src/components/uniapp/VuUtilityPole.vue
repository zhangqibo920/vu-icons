...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 2v20M2 5h20M3 3v2m4-2v2m10-2v2m4-2v2m-2 0l-7 7-7-7"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 2v20M2 5h20M3 3v2m4-2v2m10-2v2m4-2v2m-2 0l-7 7-7-7"/>
  </svg>
  <!-- #endif -->
