...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M14 13h2a2 2 0 012 2v2a2 2 0 004 0v-6.998a2 2 0 00-.59-1.42L18 5m-4 16V5a2 2 0 00-2-2H5a2 2 0 00-2 2v16m-1 0h13M3 7h11"/><path d="M9 11l-2 3h3l-2 3"/>`
...
<template>
  ...
  >
    ...
    <path d="M14 13h2a2 2 0 012 2v2a2 2 0 004 0v-6.998a2 2 0 00-.59-1.42L18 5m-4 16V5a2 2 0 00-2-2H5a2 2 0 00-2 2v16m-1 0h13M3 7h11"/><path d="M9 11l-2 3h3l-2 3"/>
  </svg>
  <!-- #endif -->
