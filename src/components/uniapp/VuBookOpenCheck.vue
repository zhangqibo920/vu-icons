...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 21V7m4 5l2 2 4-4"/><path d="M22 6V4a1 1 0 00-1-1h-5a4 4 0 00-4 4 4 4 0 00-4-4H3a1 1 0 00-1 1v13a1 1 0 001 1h6a3 3 0 013 3 3 3 0 013-3h6a1 1 0 001-1v-1.3"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 21V7m4 5l2 2 4-4"/><path d="M22 6V4a1 1 0 00-1-1h-5a4 4 0 00-4 4 4 4 0 00-4-4H3a1 1 0 00-1 1v13a1 1 0 001 1h6a3 3 0 013 3 3 3 0 013-3h6a1 1 0 001-1v-1.3"/>
  </svg>
  <!-- #endif -->
