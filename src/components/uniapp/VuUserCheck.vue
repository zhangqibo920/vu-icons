...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M16 11l2 2 4-4m-6 12v-2a4 4 0 00-4-4H6a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/>`
...
<template>
  ...
  >
    ...
    <path d="M16 11l2 2 4-4m-6 12v-2a4 4 0 00-4-4H6a4 4 0 00-4 4v2"/><circle cx="9" cy="7" r="4"/>
  </svg>
  <!-- #endif -->
