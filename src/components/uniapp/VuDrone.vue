...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M10 10L7 7m3 7l-3 3m7-7l3-3m-3 7l3 3M14.205 4.139a4 4 0 115.439 5.863M19.637 14a4 4 0 11-5.432 5.868M4.367 10a4 4 0 115.438-5.862m-.01 15.724a4 4 0 11-5.429-5.873"/><rect width="4" height="8" x="10" y="8" rx="1"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 10L7 7m3 7l-3 3m7-7l3-3m-3 7l3 3M14.205 4.139a4 4 0 115.439 5.863M19.637 14a4 4 0 11-5.432 5.868M4.367 10a4 4 0 115.438-5.862m-.01 15.724a4 4 0 11-5.429-5.873"/><rect width="4" height="8" x="10" y="8" rx="1"/>
  </svg>
  <!-- #endif -->
