...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M10 10v4m4-4v4m8 0v-4M6 10v4"/><rect width="16" height="12" x="2" y="6" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 10v4m4-4v4m8 0v-4M6 10v4"/><rect width="16" height="12" x="2" y="6" rx="2"/>
  </svg>
  <!-- #endif -->
