...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 22v-5.172a2 2 0 00-.586-1.414L9.5 13.5m5 1L12 17"/><path d="M17 8.8A6 6 0 0113.8 20H10A6.5 6.5 0 017 8a5 5 0 0110 0z"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 22v-5.172a2 2 0 00-.586-1.414L9.5 13.5m5 1L12 17"/><path d="M17 8.8A6 6 0 0113.8 20H10A6.5 6.5 0 017 8a5 5 0 0110 0z"/>
  </svg>
  <!-- #endif -->
