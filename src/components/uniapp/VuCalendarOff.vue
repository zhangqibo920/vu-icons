...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M4.2 4.2A2 2 0 003 6v14a2 2 0 002 2h14a2 2 0 001.82-1.18M21 15.5V6a2 2 0 00-2-2H9.5M16 2v4M3 10h7m11 0h-5.5M2 2l20 20"/>`
...
<template>
  ...
  >
    ...
    <path d="M4.2 4.2A2 2 0 003 6v14a2 2 0 002 2h14a2 2 0 001.82-1.18M21 15.5V6a2 2 0 00-2-2H9.5M16 2v4M3 10h7m11 0h-5.5M2 2l20 20"/>
  </svg>
  <!-- #endif -->
