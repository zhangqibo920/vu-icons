...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M21 17a9 9 0 00-15-6.7L3 13"/><path d="M3 7v6h6"/><circle cx="12" cy="17" r="1"/>`
...
<template>
  ...
  >
    ...
    <path d="M21 17a9 9 0 00-15-6.7L3 13"/><path d="M3 7v6h6"/><circle cx="12" cy="17" r="1"/>
  </svg>
  <!-- #endif -->
