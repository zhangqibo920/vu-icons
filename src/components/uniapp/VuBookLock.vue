...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M18 6V4a2 2 0 10-4 0v2m6 9v6a1 1 0 01-1 1H6.5a1 1 0 010-5H20"/><path d="M4 19.5v-15A2.5 2.5 0 016.5 2H10"/><rect width="8" height="5" x="12" y="6" rx="1"/>`
...
<template>
  ...
  >
    ...
    <path d="M18 6V4a2 2 0 10-4 0v2m6 9v6a1 1 0 01-1 1H6.5a1 1 0 010-5H20"/><path d="M4 19.5v-15A2.5 2.5 0 016.5 2H10"/><rect width="8" height="5" x="12" y="6" rx="1"/>
  </svg>
  <!-- #endif -->
