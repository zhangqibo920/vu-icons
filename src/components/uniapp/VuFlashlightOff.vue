...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M11.652 6H18m-6 7v1m4 2v4a2 2 0 01-2 2h-4a2 2 0 01-2-2v-8a4 4 0 00-.8-2.4l-.6-.8A3 3 0 016 7V6M2 2l20 20M7.649 2H17a1 1 0 011 1v4a3 3 0 01-.6 1.8l-.6.8a4 4 0 00-.55 1.007"/>`
...
<template>
  ...
  >
    ...
    <path d="M11.652 6H18m-6 7v1m4 2v4a2 2 0 01-2 2h-4a2 2 0 01-2-2v-8a4 4 0 00-.8-2.4l-.6-.8A3 3 0 016 7V6M2 2l20 20M7.649 2H17a1 1 0 011 1v4a3 3 0 01-.6 1.8l-.6.8a4 4 0 00-.55 1.007"/>
  </svg>
  <!-- #endif -->
