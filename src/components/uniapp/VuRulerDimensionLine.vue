...
const name = 'VuRulerDimensionLine'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M10 15v-3m4 3v-3m4 3v-3M2 8V4m20 2H2m20 2V4M6 15v-3"/><rect width="20" height="8" x="2" y="12" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 15v-3m4 3v-3m4 3v-3M2 8V4m20 2H2m20 2V4M6 15v-3"/><rect width="20" height="8" x="2" y="12" rx="2"/>
  </svg>
  <!-- #endif -->
