...
const name = 'VuDecimalsArrowLeft'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M13 21l-3-3 3-3m7 3H10m-7-7h.01"/><rect width="5" height="8" x="6" y="3" rx="2.5"/>`
...
<template>
  ...
  >
    ...
    <path d="M13 21l-3-3 3-3m7 3H10m-7-7h.01"/><rect width="5" height="8" x="6" y="3" rx="2.5"/>
  </svg>
  <!-- #endif -->
