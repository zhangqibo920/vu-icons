...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M20 10V8a2.4 2.4 0 00-.706-1.704l-3.588-3.588A2.4 2.4 0 0014 2H6a2 2 0 00-2 2v16a2 2 0 002 2h4.35"/><path d="M14 2v5a1 1 0 001 1h5m-4 6a2 2 0 00-2 2m2 6a2 2 0 01-2-2m6-6a2 2 0 012 2m-2 6a2 2 0 002-2"/>`
...
<template>
  ...
  >
    ...
    <path d="M20 10V8a2.4 2.4 0 00-.706-1.704l-3.588-3.588A2.4 2.4 0 0014 2H6a2 2 0 00-2 2v16a2 2 0 002 2h4.35"/><path d="M14 2v5a1 1 0 001 1h5m-4 6a2 2 0 00-2 2m2 6a2 2 0 01-2-2m6-6a2 2 0 012 2m-2 6a2 2 0 002-2"/>
  </svg>
  <!-- #endif -->
