...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M20 13.7l-2.1-2.1a2 2 0 00-2.8 0L9.7 17"/><path d="M4 19.5v-15A2.5 2.5 0 016.5 2H19a1 1 0 011 1v18a1 1 0 01-1 1H6.5a1 1 0 010-5H20"/><circle cx="10" cy="8" r="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M20 13.7l-2.1-2.1a2 2 0 00-2.8 0L9.7 17"/><path d="M4 19.5v-15A2.5 2.5 0 016.5 2H19a1 1 0 011 1v18a1 1 0 01-1 1H6.5a1 1 0 010-5H20"/><circle cx="10" cy="8" r="2"/>
  </svg>
  <!-- #endif -->
