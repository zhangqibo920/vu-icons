...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M8 11l2 2 4-4"/><circle cx="11" cy="11" r="8"/><path d="M21 21l-4.3-4.3"/>`
...
<template>
  ...
  >
    ...
    <path d="M8 11l2 2 4-4"/><circle cx="11" cy="11" r="8"/><path d="M21 21l-4.3-4.3"/>
  </svg>
  <!-- #endif -->
