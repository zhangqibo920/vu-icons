...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M2 2l20 20M8.35 2.69A10 10 0 0121.3 15.65m-2.22 3.43A10 10 0 114.92 4.92"/>`
...
<template>
  ...
  >
    ...
    <path d="M2 2l20 20M8.35 2.69A10 10 0 0121.3 15.65m-2.22 3.43A10 10 0 114.92 4.92"/>
  </svg>
  <!-- #endif -->
