...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M3.704 14.467a10 8 0 113.115 2.375M7 22a5 5 0 01-2-3.994"/><circle cx="5" cy="16" r="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M3.704 14.467a10 8 0 113.115 2.375M7 22a5 5 0 01-2-3.994"/><circle cx="5" cy="16" r="2"/>
  </svg>
  <!-- #endif -->
