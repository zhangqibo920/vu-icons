...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M3.85 8.62a4 4 0 014.78-4.77 4 4 0 016.74 0 4 4 0 014.78 4.78 4 4 0 010 6.74 4 4 0 01-4.77 4.78 4 4 0 01-6.75 0 4 4 0 01-4.78-4.77 4 4 0 010-6.76"/><path d="M16 8h-6a2 2 0 100 4h4a2 2 0 110 4H8m4 2V6"/>`
...
<template>
  ...
  >
    ...
    <path d="M3.85 8.62a4 4 0 014.78-4.77 4 4 0 016.74 0 4 4 0 014.78 4.78 4 4 0 010 6.74 4 4 0 01-4.77 4.78 4 4 0 01-6.75 0 4 4 0 01-4.78-4.77 4 4 0 010-6.76"/><path d="M16 8h-6a2 2 0 100 4h4a2 2 0 110 4H8m4 2V6"/>
  </svg>
  <!-- #endif -->
