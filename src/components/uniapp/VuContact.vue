...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M16 2v2M7 22v-2a2 2 0 012-2h6a2 2 0 012 2v2M8 2v2"/><circle cx="12" cy="11" r="3"/><rect width="18" height="18" x="3" y="4" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M16 2v2M7 22v-2a2 2 0 012-2h6a2 2 0 012 2v2M8 2v2"/><circle cx="12" cy="11" r="3"/><rect width="18" height="18" x="3" y="4" rx="2"/>
  </svg>
  <!-- #endif -->
