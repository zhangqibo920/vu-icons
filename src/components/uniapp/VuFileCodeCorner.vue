...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M4 12.15V4a2 2 0 012-2h8a2.4 2.4 0 011.706.706l3.588 3.588A2.4 2.4 0 0120 8v12a2 2 0 01-2 2h-3.35"/><path d="M14 2v5a1 1 0 001 1h5M5 16l-3 3 3 3m4 0l3-3-3-3"/>`
...
<template>
  ...
  >
    ...
    <path d="M4 12.15V4a2 2 0 012-2h8a2.4 2.4 0 011.706.706l3.588 3.588A2.4 2.4 0 0120 8v12a2 2 0 01-2 2h-3.35"/><path d="M14 2v5a1 1 0 001 1h5M5 16l-3 3 3 3m4 0l3-3-3-3"/>
  </svg>
  <!-- #endif -->
