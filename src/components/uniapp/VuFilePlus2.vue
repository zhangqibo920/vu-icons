...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M4 22h14a2 2 0 002-2V7l-5-5H6a2 2 0 00-2 2v4"/><path d="M14 2v4a2 2 0 002 2h4M3 15h6m-3-3v6"/>`
...
<template>
  ...
  >
    ...
    <path d="M4 22h14a2 2 0 002-2V7l-5-5H6a2 2 0 00-2 2v4"/><path d="M14 2v4a2 2 0 002 2h4M3 15h6m-3-3v6"/>
  </svg>
  <!-- #endif -->
