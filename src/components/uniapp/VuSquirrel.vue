...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M15.236 22a3 3 0 00-2.2-5M16 20a3 3 0 013-3h1a2 2 0 002-2v-2a4 4 0 00-4-4V4m0 9h.01"/><path d="M18 6a4 4 0 00-4 4 7 7 0 00-7 7c0-5 4-5 4-10.5a4.5 4.5 0 10-9 0 2.5 2.5 0 005 0C7 10 3 11 3 17c0 2.8 2.2 5 5 5h10"/>`
...
<template>
  ...
  >
    ...
    <path d="M15.236 22a3 3 0 00-2.2-5M16 20a3 3 0 013-3h1a2 2 0 002-2v-2a4 4 0 00-4-4V4m0 9h.01"/><path d="M18 6a4 4 0 00-4 4 7 7 0 00-7 7c0-5 4-5 4-10.5a4.5 4.5 0 10-9 0 2.5 2.5 0 005 0C7 10 3 11 3 17c0 2.8 2.2 5 5 5h10"/>
  </svg>
  <!-- #endif -->
