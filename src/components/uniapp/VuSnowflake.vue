...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M10 20l-1.25-2.5L6 18m4-14L8.75 6.5 6 6m8 14l1.25-2.5L18 18M14 4l1.25 2.5L18 6"/><path d="M17 21l-3-6h-4m7-12l-3 6 1.5 3M2 12h6.5L10 9m10 1l-1.5 2 1.5 2"/><path d="M22 12h-6.5L14 15M4 10l1.5 2L4 14m3 7l3-6-1.5-3M7 3l3 6h4"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 20l-1.25-2.5L6 18m4-14L8.75 6.5 6 6m8 14l1.25-2.5L18 18M14 4l1.25 2.5L18 6"/><path d="M17 21l-3-6h-4m7-12l-3 6 1.5 3M2 12h6.5L10 9m10 1l-1.5 2 1.5 2"/><path d="M22 12h-6.5L14 15M4 10l1.5 2L4 14m3 7l3-6-1.5-3M7 3l3 6h4"/>
  </svg>
  <!-- #endif -->
