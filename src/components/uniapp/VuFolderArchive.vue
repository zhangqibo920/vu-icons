...
const bgStyle = computed(() => {
  ...
  const svgContent = `<circle cx="15" cy="19" r="2"/><path d="M20.9 19.8A2 2 0 0022 18V8a2 2 0 00-2-2h-7.9a2 2 0 01-1.69-.9L9.6 3.9A2 2 0 007.93 3H4a2 2 0 00-2 2v13a2 2 0 002 2h5.1m5.9-9v-1m0 7v-2"/>`
...
<template>
  ...
  >
    ...
    <circle cx="15" cy="19" r="2"/><path d="M20.9 19.8A2 2 0 0022 18V8a2 2 0 00-2-2h-7.9a2 2 0 01-1.69-.9L9.6 3.9A2 2 0 007.93 3H4a2 2 0 00-2 2v13a2 2 0 002 2h5.1m5.9-9v-1m0 7v-2"/>
  </svg>
  <!-- #endif -->
