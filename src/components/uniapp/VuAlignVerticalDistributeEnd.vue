...
const name = 'VuAlignVerticalDistributeEnd'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<rect width="14" height="6" x="5" y="14" rx="2"/><rect width="10" height="6" x="7" y="4" rx="2"/><path d="M2 20h20M2 10h20"/>`
...
<template>
  ...
  >
    ...
    <rect width="14" height="6" x="5" y="14" rx="2"/><rect width="10" height="6" x="7" y="4" rx="2"/><path d="M2 20h20M2 10h20"/>
  </svg>
  <!-- #endif -->
