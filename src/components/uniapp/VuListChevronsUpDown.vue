...
const name = 'VuListChevronsUpDown'
...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M3 5h8m-8 7h8m-8 7h8m4-11l3-3 3 3m-6 8l3 3 3-3"/>`
...
<template>
  ...
  >
    ...
    <path d="M3 5h8m-8 7h8m-8 7h8m4-11l3-3 3 3m-6 8l3 3 3-3"/>
  </svg>
  <!-- #endif -->
