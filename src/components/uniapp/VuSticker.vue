...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M21 9a2.4 2.4 0 00-.706-1.706l-3.588-3.588A2.4 2.4 0 0015 3H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2z"/><path d="M15 3v5a1 1 0 001 1h5M8 13h.01M16 13h.01M10 16s.8 1 2 1c1.3 0 2-1 2-1"/>`
...
<template>
  ...
  >
    ...
    <path d="M21 9a2.4 2.4 0 00-.706-1.706l-3.588-3.588A2.4 2.4 0 0015 3H5a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2z"/><path d="M15 3v5a1 1 0 001 1h5M8 13h.01M16 13h.01M10 16s.8 1 2 1c1.3 0 2-1 2-1"/>
  </svg>
  <!-- #endif -->
