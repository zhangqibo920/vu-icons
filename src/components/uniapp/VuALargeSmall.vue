...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M15 16l2.536-7.328a1.02 1.02 1 011.928 0L22 16m-6.303-2h5.606M2 16l4.039-9.69a.5.5 0 01.923 0L11 16m-7.696-3h6.392"/>`
...
<template>
  ...
  >
    ...
    <path d="M15 16l2.536-7.328a1.02 1.02 1 011.928 0L22 16m-6.303-2h5.606M2 16l4.039-9.69a.5.5 0 01.923 0L11 16m-7.696-3h6.392"/>
  </svg>
  <!-- #endif -->
