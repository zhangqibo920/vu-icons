...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 10V2m-7.07 8.93l1.41 1.41M2 18h2m16 0h2m-2.93-7.07l-1.41 1.41M22 22H2M16 6l-4 4-4-4m8 12a4 4 0 00-8 0"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 10V2m-7.07 8.93l1.41 1.41M2 18h2m16 0h2m-2.93-7.07l-1.41 1.41M22 22H2M16 6l-4 4-4-4m8 12a4 4 0 00-8 0"/>
  </svg>
  <!-- #endif -->
