...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M8 19a4 4 0 01-2.24-7.32A3.5 3.5 0 019 6.03V6a3 3 0 116 0v.04a3.5 3.5 0 013.24 5.65A4 4 0 0116 19zm4 0v3"/>`
...
<template>
  ...
  >
    ...
    <path d="M8 19a4 4 0 01-2.24-7.32A3.5 3.5 0 019 6.03V6a3 3 0 116 0v.04a3.5 3.5 0 013.24 5.65A4 4 0 0116 19zm4 0v3"/>
  </svg>
  <!-- #endif -->
