...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M6 3v12m12-6a3 3 0 100-6 3 3 0 000 6M6 21a3 3 0 100-6 3 3 0 000 6"/><path d="M15 6a9 9 0 00-9 9m12 0v6m3-3h-6"/>`
...
<template>
  ...
  >
    ...
    <path d="M6 3v12m12-6a3 3 0 100-6 3 3 0 000 6M6 21a3 3 0 100-6 3 3 0 000 6"/><path d="M15 6a9 9 0 00-9 9m12 0v6m3-3h-6"/>
  </svg>
  <!-- #endif -->
