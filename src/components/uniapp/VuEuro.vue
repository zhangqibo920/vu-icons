...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M4 10h12M4 14h9m6-8a7.7 7.7 0 00-5.2-2A7.9 7.9 0 006 12c0 4.4 3.5 8 7.8 8 2 0 3.8-.8 5.2-2"/>`
...
<template>
  ...
  >
    ...
    <path d="M4 10h12M4 14h9m6-8a7.7 7.7 0 00-5.2-2A7.9 7.9 0 006 12c0 4.4 3.5 8 7.8 8 2 0 3.8-.8 5.2-2"/>
  </svg>
  <!-- #endif -->
