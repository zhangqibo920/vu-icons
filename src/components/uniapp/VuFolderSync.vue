...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M9 20H4a2 2 0 01-2-2V5a2 2 0 012-2h3.9a2 2 0 011.69.9l.81 1.2a2 2 0 001.67.9H20a2 2 0 012 2v.5"/><path d="M12 10v4h4"/><path d="M12 14l1.535-1.605a5 5 0 018 1.5M22 22v-4h-4"/><path d="M22 18l-1.535 1.605a5 5 0 01-8-1.5"/>`
...
<template>
  ...
  >
    ...
    <path d="M9 20H4a2 2 0 01-2-2V5a2 2 0 012-2h3.9a2 2 0 011.69.9l.81 1.2a2 2 0 001.67.9H20a2 2 0 012 2v.5"/><path d="M12 10v4h4"/><path d="M12 14l1.535-1.605a5 5 0 018 1.5M22 22v-4h-4"/><path d="M22 18l-1.535 1.605a5 5 0 01-8-1.5"/>
  </svg>
  <!-- #endif -->
