...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M14 9.536V7a4 4 0 014-4h1.5a.5.5 0 01.5.5V5a4 4 0 01-4 4 4 4 0 00-4 4c0 2 1 3 1 5a5 5 0 01-1 3M4 9a5 5 0 018 4 5 5 0 01-8-4m1 12h14"/>`
...
<template>
  ...
  >
    ...
    <path d="M14 9.536V7a4 4 0 014-4h1.5a.5.5 0 01.5.5V5a4 4 0 01-4 4 4 4 0 00-4 4c0 2 1 3 1 5a5 5 0 01-1 3M4 9a5 5 0 018 4 5 5 0 01-8-4m1 12h14"/>
  </svg>
  <!-- #endif -->
