...
const bgStyle = computed(() => {
  ...
  const svgContent = `<rect width="18" height="12" x="3" y="8" rx="1"/><path d="M10 8V5c0-.6-.4-1-1-1H6a1 1 0 00-1 1v3m14 0V5c0-.6-.4-1-1-1h-3a1 1 0 00-1 1v3"/>`
...
<template>
  ...
  >
    ...
    <rect width="18" height="12" x="3" y="8" rx="1"/><path d="M10 8V5c0-.6-.4-1-1-1H6a1 1 0 00-1 1v3m14 0V5c0-.6-.4-1-1-1h-3a1 1 0 00-1 1v3"/>
  </svg>
  <!-- #endif -->
