...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M4 12V4a2 2 0 012-2h8a2.4 2.4 0 011.706.706l3.588 3.588A2.4 2.4 0 0120 8v12a2 2 0 01-2 2"/><path d="M14 2v5a1 1 0 001 1h5m-10 8h2v6m-2 0h4"/><rect width="4" height="6" x="2" y="16" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M4 12V4a2 2 0 012-2h8a2.4 2.4 0 011.706.706l3.588 3.588A2.4 2.4 0 0120 8v12a2 2 0 01-2 2"/><path d="M14 2v5a1 1 0 001 1h5m-10 8h2v6m-2 0h4"/><rect width="4" height="6" x="2" y="16" rx="2"/>
  </svg>
  <!-- #endif -->
