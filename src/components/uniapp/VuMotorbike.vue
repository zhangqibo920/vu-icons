...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M18 14l-1-3M3 9l6 2a2 2 0 012-2h2a2 2 0 011.99 1.81"/><path d="M8 17h3a1 1 0 001-1 6 6 0 016-6 1 1 0 001-1v-.75A5 5 0 0017 5"/><circle cx="19" cy="17" r="3"/><circle cx="5" cy="17" r="3"/>`
...
<template>
  ...
  >
    ...
    <path d="M18 14l-1-3M3 9l6 2a2 2 0 012-2h2a2 2 0 011.99 1.81"/><path d="M8 17h3a1 1 0 001-1 6 6 0 016-6 1 1 0 001-1v-.75A5 5 0 0017 5"/><circle cx="19" cy="17" r="3"/><circle cx="5" cy="17" r="3"/>
  </svg>
  <!-- #endif -->
