...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M2 20v-8a2 2 0 012-2h16a2 2 0 012 2v8M4 10V6a2 2 0 012-2h12a2 2 0 012 2v4m-8-6v6M2 18h20"/>`
...
<template>
  ...
  >
    ...
    <path d="M2 20v-8a2 2 0 012-2h16a2 2 0 012 2v8M4 10V6a2 2 0 012-2h12a2 2 0 012 2v4m-8-6v6M2 18h20"/>
  </svg>
  <!-- #endif -->
