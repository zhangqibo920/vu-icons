...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M20.9 18.55l-8-15.98a1 1 0 00-1.8 0l-8 15.98"/><ellipse cx="12" cy="19" rx="9" ry="3"/>`
...
<template>
  ...
  >
    ...
    <path d="M20.9 18.55l-8-15.98a1 1 0 00-1.8 0l-8 15.98"/><ellipse cx="12" cy="19" rx="9" ry="3"/>
  </svg>
  <!-- #endif -->
