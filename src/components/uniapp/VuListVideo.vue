...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M21 5H3m7 7H3m7 7H3m12-6.997a1 1 0 011.517-.859l4.997 2.997a1 1 0 010 1.718l-4.997 2.997a1 1 0 01-1.517-.86z"/>`
...
<template>
  ...
  >
    ...
    <path d="M21 5H3m7 7H3m7 7H3m12-6.997a1 1 0 011.517-.859l4.997 2.997a1 1 0 010 1.718l-4.997 2.997a1 1 0 01-1.517-.86z"/>
  </svg>
  <!-- #endif -->
