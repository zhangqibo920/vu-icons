...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M10 20a1 1 0 00.553.895l2 1A1 1 0 0014 21v-7a2 2 0 01.517-1.341L21.74 4.67A1 1 0 0021 3H3a1 1 0 00-.742 1.67l7.225 7.989A2 2 0 0110 14z"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 20a1 1 0 00.553.895l2 1A1 1 0 0014 21v-7a2 2 0 01.517-1.341L21.74 4.67A1 1 0 0021 3H3a1 1 0 00-.742 1.67l7.225 7.989A2 2 0 0110 14z"/>
  </svg>
  <!-- #endif -->
