...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M3 11l19-9-9 19-2-8-8-2z"/><path d="M12 22L22 2v8L12 22h0z"/>`
...
<template>
  ...
  >
    ...
    <path d="M3 11l19-9-9 19-2-8-8-2z"/><path d="M12 22L22 2v8L12 22h0z"/>
  </svg>
  <!-- #endif -->
