...
const name = 'VuCircleArrowOutDownLeft'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M2 12a10 10 0 1110 10M2 22l10-10M8 22H2v-6"/>`
...
<template>
  ...
  >
    ...
    <path d="M2 12a10 10 0 1110 10M2 22l10-10M8 22H2v-6"/>
  </svg>
  <!-- #endif -->
