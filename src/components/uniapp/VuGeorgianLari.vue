...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M11.5 21a7.5 7.5 0 117.35-9M13 12V3M4 21h16M9 12V3"/>`
...
<template>
  ...
  >
    ...
    <path d="M11.5 21a7.5 7.5 0 117.35-9M13 12V3M4 21h16M9 12V3"/>
  </svg>
  <!-- #endif -->
