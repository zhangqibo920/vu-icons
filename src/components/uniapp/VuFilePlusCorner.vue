...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M11.35 22H6a2 2 0 01-2-2V4a2 2 0 012-2h8a2.4 2.4 0 011.706.706l3.588 3.588A2.4 2.4 0 0120 8v5.35"/><path d="M14 2v5a1 1 0 001 1h5m-6 11h6m-3-3v6"/>`
...
<template>
  ...
  >
    ...
    <path d="M11.35 22H6a2 2 0 01-2-2V4a2 2 0 012-2h8a2.4 2.4 0 011.706.706l3.588 3.588A2.4 2.4 0 0120 8v5.35"/><path d="M14 2v5a1 1 0 001 1h5m-6 11h6m-3-3v6"/>
  </svg>
  <!-- #endif -->
