...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M14 3v11m0-5h-3a3 3 0 010-6h9m-2 0v11m4 4H2l4-4m0 8l-4-4"/>`
...
<template>
  ...
  >
    ...
    <path d="M14 3v11m0-5h-3a3 3 0 010-6h9m-2 0v11m4 4H2l4-4m0 8l-4-4"/>
  </svg>
  <!-- #endif -->
