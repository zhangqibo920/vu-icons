...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M17 15l-5.5 5.5L9 18"/><path d="M5 17.743A7 7 0 1115.71 10h1.79a4.5 4.5 0 011.5 8.742"/>`
...
<template>
  ...
  >
    ...
    <path d="M17 15l-5.5 5.5L9 18"/><path d="M5 17.743A7 7 0 1115.71 10h1.79a4.5 4.5 0 011.5 8.742"/>
  </svg>
  <!-- #endif -->
