...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M7 12h2l2 5 2-10h4"/><rect width="18" height="18" x="3" y="3" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M7 12h2l2 5 2-10h4"/><rect width="18" height="18" x="3" y="3" rx="2"/>
  </svg>
  <!-- #endif -->
