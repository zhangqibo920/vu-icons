...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M4 7V4h16v3M5 20h6m2-16L8 20m7-5l5 5m0-5l-5 5"/>`
...
<template>
  ...
  >
    ...
    <path d="M4 7V4h16v3M5 20h6m2-16L8 20m7-5l5 5m0-5l-5 5"/>
  </svg>
  <!-- #endif -->
