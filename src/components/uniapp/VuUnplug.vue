...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M19 5l3-3M2 22l3-3m1.3 1.3a2.4 2.4 0 003.4 0L12 18l-6-6-2.3 2.3a2.4 2.4 0 000 3.4zm1.2-6.8L10 11m.5 5.5L13 14m-1-8l6 6 2.3-2.3a2.4 2.4 0 000-3.4l-2.6-2.6a2.4 2.4 0 00-3.4 0z"/>`
...
<template>
  ...
  >
    ...
    <path d="M19 5l3-3M2 22l3-3m1.3 1.3a2.4 2.4 0 003.4 0L12 18l-6-6-2.3 2.3a2.4 2.4 0 000 3.4zm1.2-6.8L10 11m.5 5.5L13 14m-1-8l6 6 2.3-2.3a2.4 2.4 0 000-3.4l-2.6-2.6a2.4 2.4 0 00-3.4 0z"/>
  </svg>
  <!-- #endif -->
