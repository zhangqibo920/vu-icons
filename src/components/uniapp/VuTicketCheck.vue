...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M2 9a3 3 0 010 6v2a2 2 0 002 2h16a2 2 0 002-2v-2a3 3 0 010-6V7a2 2 0 00-2-2H4a2 2 0 00-2 2z"/><path d="M9 12l2 2 4-4"/>`
...
<template>
  ...
  >
    ...
    <path d="M2 9a3 3 0 010 6v2a2 2 0 002 2h16a2 2 0 002-2v-2a3 3 0 010-6V7a2 2 0 00-2-2H4a2 2 0 00-2 2z"/><path d="M9 12l2 2 4-4"/>
  </svg>
  <!-- #endif -->
