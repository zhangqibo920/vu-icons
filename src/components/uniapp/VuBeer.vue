...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M17 11h1a3 3 0 010 6h-1m-8-5v6m4-6v6m1-10.5c-1 0-1.44.5-3 .5s-2-.5-3-.5-1.72.5-2.5.5a2.5 2.5 0 010-5c.78 0 1.57.5 2.5.5S9.44 2 11 2s2 1.5 3 1.5 1.72-.5 2.5-.5a2.5 2.5 0 010 5c-.78 0-1.5-.5-2.5-.5"/><path d="M5 8v12a2 2 0 002 2h8a2 2 0 002-2V8"/>`
...
<template>
  ...
  >
    ...
    <path d="M17 11h1a3 3 0 010 6h-1m-8-5v6m4-6v6m1-10.5c-1 0-1.44.5-3 .5s-2-.5-3-.5-1.72.5-2.5.5a2.5 2.5 0 010-5c.78 0 1.57.5 2.5.5S9.44 2 11 2s2 1.5 3 1.5 1.72-.5 2.5-.5a2.5 2.5 0 010 5c-.78 0-1.5-.5-2.5-.5"/><path d="M5 8v12a2 2 0 002 2h8a2 2 0 002-2V8"/>
  </svg>
  <!-- #endif -->
