...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M15 15.003a1 1 0 011.517-.859l4.997 2.997a1 1 0 010 1.718l-4.997 2.997a1 1 0 01-1.517-.86z"/><path d="M21 12.17V5a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2h6m-5 0l5-5"/><circle cx="9" cy="9" r="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M15 15.003a1 1 0 011.517-.859l4.997 2.997a1 1 0 010 1.718l-4.997 2.997a1 1 0 01-1.517-.86z"/><path d="M21 12.17V5a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2h6m-5 0l5-5"/><circle cx="9" cy="9" r="2"/>
  </svg>
  <!-- #endif -->
