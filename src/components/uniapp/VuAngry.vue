...
const bgStyle = computed(() => {
  ...
  const svgContent = `<circle cx="12" cy="12" r="10"/><path d="M16 16s-1.5-2-4-2-4 2-4 2m-.5-8L10 9m4 0l2.5-1M9 10h.01M15 10h.01"/>`
...
<template>
  ...
  >
    ...
    <circle cx="12" cy="12" r="10"/><path d="M16 16s-1.5-2-4-2-4 2-4 2m-.5-8L10 9m4 0l2.5-1M9 10h.01M15 10h.01"/>
  </svg>
  <!-- #endif -->
