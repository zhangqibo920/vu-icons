...
const bgStyle = computed(() => {
  ...
  const svgContent = `<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M12 8l-4 4 4 4m4-4H8"/>`
...
<template>
  ...
  >
    ...
    <rect width="18" height="18" x="3" y="3" rx="2"/><path d="M12 8l-4 4 4 4m4-4H8"/>
  </svg>
  <!-- #endif -->
