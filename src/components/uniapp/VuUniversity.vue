...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M14 21v-3a2 2 0 00-4 0v3m8-9h.01M18 16h.01"/><path d="M22 7a1 1 0 00-1-1h-2a2 2 0 01-1.143-.359L13.143 2.36a2 2 0 00-2.286-.001L6.143 5.64A2 2 0 015 6H3a1 1 0 00-1 1v12a2 2 0 002 2h16a2 2 0 002-2zM6 12h.01M6 16h.01"/><circle cx="12" cy="10" r="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M14 21v-3a2 2 0 00-4 0v3m8-9h.01M18 16h.01"/><path d="M22 7a1 1 0 00-1-1h-2a2 2 0 01-1.143-.359L13.143 2.36a2 2 0 00-2.286-.001L6.143 5.64A2 2 0 015 6H3a1 1 0 00-1 1v12a2 2 0 002 2h16a2 2 0 002-2zM6 12h.01M6 16h.01"/><circle cx="12" cy="10" r="2"/>
  </svg>
  <!-- #endif -->
