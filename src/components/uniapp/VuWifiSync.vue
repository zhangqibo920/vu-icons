...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M11.965 10.105v4L13.5 12.5a5 5 0 018 1.5m-9.535.105h4m2 4h4L20.43 19.71a5 5 0 01-8-1.5M2 8.82a15 15 0 0120 0m-.035 13.285v-4M5 12.86a10 10 0 013-2.032m.5 5.601h.01"/>`
...
<template>
  ...
  >
    ...
    <path d="M11.965 10.105v4L13.5 12.5a5 5 0 018 1.5m-9.535.105h4m2 4h4L20.43 19.71a5 5 0 01-8-1.5M2 8.82a15 15 0 0120 0m-.035 13.285v-4M5 12.86a10 10 0 013-2.032m.5 5.601h.01"/>
  </svg>
  <!-- #endif -->
