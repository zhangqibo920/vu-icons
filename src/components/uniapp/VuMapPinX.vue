...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M19.752 11.901A7.8 7.8 0 0020 10a8 8 0 00-16 0c0 4.993 5.539 10.193 7.399 11.799a1 1 0 001.202 0l.09-.077"/><circle cx="12" cy="10" r="3"/><path d="M21.5 15.5l-5 5m5 0l-5-5"/>`
...
<template>
  ...
  >
    ...
    <path d="M19.752 11.901A7.8 7.8 0 0020 10a8 8 0 00-16 0c0 4.993 5.539 10.193 7.399 11.799a1 1 0 001.202 0l.09-.077"/><circle cx="12" cy="10" r="3"/><path d="M21.5 15.5l-5 5m5 0l-5-5"/>
  </svg>
  <!-- #endif -->
