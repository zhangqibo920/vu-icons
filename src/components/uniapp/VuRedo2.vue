...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M15 14l5-5-5-5"/><path d="M20 9H9.5A5.5 5.5 0 004 14.5 5.5 5.5 0 009.5 20H13"/>`
...
<template>
  ...
  >
    ...
    <path d="M15 14l5-5-5-5"/><path d="M20 9H9.5A5.5 5.5 0 004 14.5 5.5 5.5 0 009.5 20H13"/>
  </svg>
  <!-- #endif -->
