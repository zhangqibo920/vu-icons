...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 13v7a2 2 0 004 0M12 2v2m6.656 9h2.336a1 1 0 00.97-1.274 10.284 10.284 0 00-12.07-7.51M2 2l20 20"/><path d="M5.961 5.957a10.28 10.28 0 00-3.922 5.769A1 1 0 003 13h10"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 13v7a2 2 0 004 0M12 2v2m6.656 9h2.336a1 1 0 00.97-1.274 10.284 10.284 0 00-12.07-7.51M2 2l20 20"/><path d="M5.961 5.957a10.28 10.28 0 00-3.922 5.769A1 1 0 003 13h10"/>
  </svg>
  <!-- #endif -->
