...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 6v6l4 2m4-2v5m0 4h.01M21.25 8.2A10 10 0 1016 21.16"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 6v6l4 2m4-2v5m0 4h.01M21.25 8.2A10 10 0 1016 21.16"/>
  </svg>
  <!-- #endif -->
