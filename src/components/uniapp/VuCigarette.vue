...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M17 12H3a1 1 0 00-1 1v2a1 1 0 001 1h14m1-8c0-2.5-2-2.5-2-5m5 13a1 1 0 001-1v-2a1 1 0 00-1-1m1-4c0-2.5-2-2.5-2-5M7 12v4"/>`
...
<template>
  ...
  >
    ...
    <path d="M17 12H3a1 1 0 00-1 1v2a1 1 0 001 1h14m1-8c0-2.5-2-2.5-2-5m5 13a1 1 0 001-1v-2a1 1 0 00-1-1m1-4c0-2.5-2-2.5-2-5M7 12v4"/>
  </svg>
  <!-- #endif -->
