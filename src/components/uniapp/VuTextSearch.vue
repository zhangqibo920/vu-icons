...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M21 5H3m7 7H3m7 7H3"/><circle cx="17" cy="15" r="3"/><path d="M21 19l-1.9-1.9"/>`
...
<template>
  ...
  >
    ...
    <path d="M21 5H3m7 7H3m7 7H3"/><circle cx="17" cy="15" r="3"/><path d="M21 19l-1.9-1.9"/>
  </svg>
  <!-- #endif -->
