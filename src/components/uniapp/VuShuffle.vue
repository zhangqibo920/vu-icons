...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M18 14l4 4-4 4m0-20l4 4-4 4"/><path d="M2 18h1.973a4 4 0 003.3-1.7l5.454-8.6a4 4 0 013.3-1.7H22M2 6h1.972a4 4 0 013.6 2.2M22 18h-6.041a4 4 0 01-3.3-1.8l-.359-.45"/>`
...
<template>
  ...
  >
    ...
    <path d="M18 14l4 4-4 4m0-20l4 4-4 4"/><path d="M2 18h1.973a4 4 0 003.3-1.7l5.454-8.6a4 4 0 013.3-1.7H22M2 6h1.972a4 4 0 013.6 2.2M22 18h-6.041a4 4 0 01-3.3-1.8l-.359-.45"/>
  </svg>
  <!-- #endif -->
