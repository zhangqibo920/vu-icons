...
const name = 'VuBriefcaseConveyorBelt'
...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M10 20v2m4-2v2m4-2v2m3-2H3m3 0v2m2-6V4a2 2 0 012-2h4a2 2 0 012 2v12"/><rect width="16" height="10" x="4" y="6" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 20v2m4-2v2m4-2v2m3-2H3m3 0v2m2-6V4a2 2 0 012-2h4a2 2 0 012 2v12"/><rect width="16" height="10" x="4" y="6" rx="2"/>
  </svg>
  <!-- #endif -->
