...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<circle cx="12" cy="12" r="10"/><path d="M18 13a6 6 0 01-6 5 6 6 0 01-6-5zM9 9h.01M15 9h.01"/>`
...
<template>
  ...
  >
    ...
    <circle cx="12" cy="12" r="10"/><path d="M18 13a6 6 0 01-6 5 6 6 0 01-6-5zM9 9h.01M15 9h.01"/>
  </svg>
  <!-- #endif -->
