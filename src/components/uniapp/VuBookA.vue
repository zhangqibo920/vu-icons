...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M4 19.5v-15A2.5 2.5 0 016.5 2H19a1 1 0 011 1v18a1 1 0 01-1 1H6.5a1 1 0 010-5H20"/><path d="M8 13l4-7 4 7m-6.9-2h5.7"/>`
...
<template>
  ...
  >
    ...
    <path d="M4 19.5v-15A2.5 2.5 0 016.5 2H19a1 1 0 011 1v18a1 1 0 01-1 1H6.5a1 1 0 010-5H20"/><path d="M8 13l4-7 4 7m-6.9-2h5.7"/>
  </svg>
  <!-- #endif -->
