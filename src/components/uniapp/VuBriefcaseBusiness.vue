...
const name = 'VuBriefcaseBusiness'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 12h.01M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m14 7a18.15 18.15 0 01-20 0"/><rect width="20" height="14" x="2" y="6" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 12h.01M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m14 7a18.15 18.15 0 01-20 0"/><rect width="20" height="14" x="2" y="6" rx="2"/>
  </svg>
  <!-- #endif -->
