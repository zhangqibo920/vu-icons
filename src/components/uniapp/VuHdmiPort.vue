...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M22 9a1 1 0 00-1-1H3a1 1 0 00-1 1v4a1 1 0 001 1h1l2 2h12l2-2h1a1 1 0 001-1zM7.5 12h9"/>`
...
<template>
  ...
  >
    ...
    <path d="M22 9a1 1 0 00-1-1H3a1 1 0 00-1 1v4a1 1 0 001 1h1l2 2h12l2-2h1a1 1 0 001-1zM7.5 12h9"/>
  </svg>
  <!-- #endif -->
