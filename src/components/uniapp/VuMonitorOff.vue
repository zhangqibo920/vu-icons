...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 17v4m5-4H4a2 2 0 01-2-2V5a2 2 0 011.184-1.826M2 2l20 20M8 21h8M8.656 3H20a2 2 0 012 2v10a2 2 0 01-.293 1.042"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 17v4m5-4H4a2 2 0 01-2-2V5a2 2 0 011.184-1.826M2 2l20 20M8 21h8M8.656 3H20a2 2 0 012 2v10a2 2 0 01-.293 1.042"/>
  </svg>
  <!-- #endif -->
