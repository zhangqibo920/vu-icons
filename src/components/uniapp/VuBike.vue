...
const bgStyle = computed(() => {
  ...
  const svgContent = `<circle cx="5.5" cy="17.5" r="2.5"/><circle cx="18.5" cy="17.5" r="2.5"/><path d="M15 6a1 1 0 100-2 1 1 0 000 2zm-3 11.5V14l-3-3 4-3 4 3-3 3v3.5a2.5 2.5 0 11-5 0V10L6.79 7.79A2 2 0 016 6.5v-1"/>`
...
<template>
  ...
  >
    ...
    <circle cx="5.5" cy="17.5" r="2.5"/><circle cx="18.5" cy="17.5" r="2.5"/><path d="M15 6a1 1 0 100-2 1 1 0 000 2zm-3 11.5V14l-3-3 4-3 4 3-3 3v3.5a2.5 2.5 0 11-5 0V10L6.79 7.79A2 2 0 016 6.5v-1"/>
  </svg>
  <!-- #endif -->
