...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M5 12.55a11 11 0 0114.08-5.17M12 16v-4h0M1.42 9h2.15M1.42 15h2.15M20.42 9h2.15M20.42 15h2.15"/>`
...
<template>
  ...
  >
    ...
    <path d="M5 12.55a11 11 0 0114.08-5.17M12 16v-4h0M1.42 9h2.15M1.42 15h2.15M20.42 9h2.15M20.42 15h2.15"/>
  </svg>
  <!-- #endif -->
