...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M10 2h4m-9.4 9a8 8 0 001.7 8.7 8 8 0 008.7 1.7m-7.6-14a8 8 0 0110.3 1 8 8 0 01.9 10.2M2 2l20 20M12 12v-2"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 2h4m-9.4 9a8 8 0 001.7 8.7 8 8 0 008.7 1.7m-7.6-14a8 8 0 0110.3 1 8 8 0 01.9 10.2M2 2l20 20M12 12v-2"/>
  </svg>
  <!-- #endif -->
