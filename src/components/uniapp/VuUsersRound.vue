...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M18 21a8 8 0 00-16 0"/><circle cx="10" cy="8" r="5"/><path d="M22 20c0-3.37-2-6.5-4-8a5 5 0 00-.45-8.3"/>`
...
<template>
  ...
  >
    ...
    <path d="M18 21a8 8 0 00-16 0"/><circle cx="10" cy="8" r="5"/><path d="M22 20c0-3.37-2-6.5-4-8a5 5 0 00-.45-8.3"/>
  </svg>
  <!-- #endif -->
