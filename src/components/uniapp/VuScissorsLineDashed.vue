...
const name = 'VuScissorsLineDashed'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M5.42 9.42L8 12"/><circle cx="4" cy="8" r="2"/><path d="M14 6l-8.58 8.58"/><circle cx="4" cy="16" r="2"/><path d="M10.8 14.8L14 18m2-6h-2m8 0h-2"/>`
