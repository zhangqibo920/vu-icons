...
const bgStyle = computed(() => {
  ...
  const svgContent = `<rect width="8" height="8" x="14" y="14" rx="2"/><rect width="8" height="8" x="2" y="2" rx="2"/><path d="M7 14v1a2 2 0 002 2h1m4-10h1a2 2 0 012 2v1"/>`
...
<template>
  ...
  >
    ...
    <rect width="8" height="8" x="14" y="14" rx="2"/><rect width="8" height="8" x="2" y="2" rx="2"/><path d="M7 14v1a2 2 0 002 2h1m4-10h1a2 2 0 012 2v1"/>
  </svg>
  <!-- #endif -->
