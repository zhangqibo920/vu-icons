...
const name = 'VuListChevronsDownUp'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M3 5h8m-8 7h8m-8 7h8m4-14l3 3 3-3m-6 14l3-3 3 3"/>`
...
<template>
  ...
  >
    ...
    <path d="M3 5h8m-8 7h8m-8 7h8m4-14l3 3 3-3m-6 14l3-3 3 3"/>
  </svg>
  <!-- #endif -->
