...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M16 12h3m-1.5 0a8 8 0 01-8 8A4.5 4.5 0 015 15.5c0-6 8-4 8-8.5a3 3 0 10-6 0c0 3 2.5 8.5 12 13"/>`
...
<template>
  ...
  >
    ...
    <path d="M16 12h3m-1.5 0a8 8 0 01-8 8A4.5 4.5 0 015 15.5c0-6 8-4 8-8.5a3 3 0 10-6 0c0 3 2.5 8.5 12 13"/>
  </svg>
  <!-- #endif -->
