...
const name = 'VuGitPullRequestCreateArrow'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<circle cx="5" cy="6" r="3"/><path d="M5 9v12M15 9l-3-3 3-3"/><path d="M12 6h5a2 2 0 012 2v3m0 4v6m3-3h-6"/>`
...
<template>
  ...
  >
    ...
    <circle cx="5" cy="6" r="3"/><path d="M5 9v12M15 9l-3-3 3-3"/><path d="M12 6h5a2 2 0 012 2v3m0 4v6m3-3h-6"/>
  </svg>
  <!-- #endif -->
