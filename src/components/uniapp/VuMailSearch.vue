...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M22 12.5V6a2 2 0 00-2-2H4a2 2 0 00-2 2v12c0 1.1.9 2 2 2h7.5"/><path d="M22 7l-8.97 5.7a1.94 1.94 0 01-2.06 0L2 7m16 14a3 3 0 100-6 3 3 0 000 6"/><circle cx="18" cy="18" r="3"/><path d="M22 22l-1.5-1.5"/>`
...
<template>
  ...
  >
    ...
    <path d="M22 12.5V6a2 2 0 00-2-2H4a2 2 0 00-2 2v12c0 1.1.9 2 2 2h7.5"/><path d="M22 7l-8.97 5.7a1.94 1.94 0 01-2.06 0L2 7m16 14a3 3 0 100-6 3 3 0 000 6"/><circle cx="18" cy="18" r="3"/><path d="M22 22l-1.5-1.5"/>
  </svg>
  <!-- #endif -->
