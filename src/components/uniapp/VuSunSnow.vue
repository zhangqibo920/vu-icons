...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M10 21v-1m0-16V3m0 6a3 3 0 000 6m4 5l1.25-2.5L18 18M14 4l1.25 2.5L18 6"/><path d="M17 21l-3-6 1.5-3H22m-5-9l-3 6 1.5 3M2 12h1"/><path d="M20 10l-1.5 2 1.5 2M3.64 18.36l.7-.7m0-11.32l-.7-.7"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 21v-1m0-16V3m0 6a3 3 0 000 6m4 5l1.25-2.5L18 18M14 4l1.25 2.5L18 6"/><path d="M17 21l-3-6 1.5-3H22m-5-9l-3 6 1.5 3M2 12h1"/><path d="M20 10l-1.5 2 1.5 2M3.64 18.36l.7-.7m0-11.32l-.7-.7"/>
  </svg>
  <!-- #endif -->
