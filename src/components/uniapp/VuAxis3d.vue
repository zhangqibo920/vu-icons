...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M13.5 10.5L15 9M4 4v15a1 1 0 001 1h15m-15.707-.293L6 18m3-3l1.5-1.5"/>`
...
<template>
  ...
  >
    ...
    <path d="M13.5 10.5L15 9M4 4v15a1 1 0 001 1h15m-15.707-.293L6 18m3-3l1.5-1.5"/>
  </svg>
  <!-- #endif -->
