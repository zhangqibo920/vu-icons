...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M14.5 2v17.5c0 1.4-1.1 2.5-2.5 2.5s-2.5-1.1-2.5-2.5V2m-1 0h7m-1 14h-5"/>`
...
<template>
  ...
  >
    ...
    <path d="M14.5 2v17.5c0 1.4-1.1 2.5-2.5 2.5s-2.5-1.1-2.5-2.5V2m-1 0h7m-1 14h-5"/>
  </svg>
  <!-- #endif -->
