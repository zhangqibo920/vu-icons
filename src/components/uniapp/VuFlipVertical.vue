...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M21 8V5a2 2 0 00-2-2H5a2 2 0 00-2 2v3m18 8v3a2 2 0 01-2 2H5a2 2 0 01-2-2v-3m1-4H2m8 0H8m8 0h-2m8 0h-2"/>`
...
<template>
  ...
  >
    ...
    <path d="M21 8V5a2 2 0 00-2-2H5a2 2 0 00-2 2v3m18 8v3a2 2 0 01-2 2H5a2 2 0 01-2-2v-3m1-4H2m8 0H8m8 0h-2m8 0h-2"/>
  </svg>
  <!-- #endif -->
