...
const name = 'VuBetweenVerticalStart'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<rect width="7" height="13" x="3" y="8" rx="1"/><path d="M15 2l-3 3-3-3"/><rect width="7" height="13" x="14" y="8" rx="1"/>`
...
<template>
  ...
  >
    ...
    <rect width="7" height="13" x="3" y="8" rx="1"/><path d="M15 2l-3 3-3-3"/><rect width="7" height="13" x="14" y="8" rx="1"/>
  </svg>
  <!-- #endif -->
