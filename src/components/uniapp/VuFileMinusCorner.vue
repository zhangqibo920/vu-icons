...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M20 14V8a2.4 2.4 0 00-.706-1.706l-3.588-3.588A2.4 2.4 0 0014 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12"/><path d="M14 2v5a1 1 0 001 1h5m-6 10h6"/>`
...
<template>
  ...
  >
    ...
    <path d="M20 14V8a2.4 2.4 0 00-.706-1.706l-3.588-3.588A2.4 2.4 0 0014 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12"/><path d="M14 2v5a1 1 0 001 1h5m-6 10h6"/>
  </svg>
  <!-- #endif -->
