...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path fill="currentColor" d="M13 17a1 1 0 10-2 0l.5 4.5a.5.5 0 001 0z"/><path d="M16.85 18.58a9 9 0 10-9.7 0M8 14a5 5 0 118 0"/><circle cx="12" cy="11" r="1" fill="currentColor"/>`
...
<template>
  ...
  >
    ...
    <path fill="currentColor" d="M13 17a1 1 0 10-2 0l.5 4.5a.5.5 0 001 0z"/><path d="M16.85 18.58a9 9 0 10-9.7 0M8 14a5 5 0 118 0"/><circle cx="12" cy="11" r="1" fill="currentColor"/>
  </svg>
  <!-- #endif -->
