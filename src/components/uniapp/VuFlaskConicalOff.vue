...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M10 2v2.343M14 2v6.343M2 2l20 20m-2-2a2 2 0 01-2 2H6a2 2 0 01-1.755-2.96l5.227-9.563M6.453 15H15M8.5 2h7"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 2v2.343M14 2v6.343M2 2l20 20m-2-2a2 2 0 01-2 2H6a2 2 0 01-1.755-2.96l5.227-9.563M6.453 15H15M8.5 2h7"/>
  </svg>
  <!-- #endif -->
