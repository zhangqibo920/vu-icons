...
const name = 'VuPaintbrushVertical'
...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M10 2v2m4-2v4m3-4a1 1 0 011 1v9H6V3a1 1 0 011-1zM6 12a1 1 0 00-1 1v1a2 2 0 002 2h2a1 1 0 011 1v2.9a2 2 0 104 0V17a1 1 0 011-1h2a2 2 0 002-2v-1a1 1 0 00-1-1"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 2v2m4-2v4m3-4a1 1 0 011 1v9H6V3a1 1 0 011-1zM6 12a1 1 0 00-1 1v1a2 2 0 002 2h2a1 1 0 011 1v2.9a2 2 0 104 0V17a1 1 0 011-1h2a2 2 0 002-2v-1a1 1 0 00-1-1"/>
  </svg>
  <!-- #endif -->
