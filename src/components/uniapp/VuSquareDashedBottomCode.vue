...
const name = 'VuSquareDashedBottomCode'
...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M10 9.5L8 12l2 2.5m4 6.5h1M14 9.5l2 2.5-2 2.5"/><path d="M5 21a2 2 0 01-2-2V5a2 2 0 012-2h14a2 2 0 012 2v14a2 2 0 01-2 2M9 21h1"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 9.5L8 12l2 2.5m4 6.5h1M14 9.5l2 2.5-2 2.5"/><path d="M5 21a2 2 0 01-2-2V5a2 2 0 012-2h14a2 2 0 012 2v14a2 2 0 01-2 2M9 21h1"/>
  </svg>
  <!-- #endif -->
