...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<circle cx="12" cy="12" r="10"/><path d="M9.17 14.83a4 4 0 100-5.66"/>`
...
<template>
  ...
  >
    ...
    <circle cx="12" cy="12" r="10"/><path d="M9.17 14.83a4 4 0 100-5.66"/>
  </svg>
  <!-- #endif -->
