...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M8 21s-4-3-4-9 4-9 4-9m8 0s4 3 4 9-4 9-4 9M15 9l-6 6m0-6l6 6"/>`
...
<template>
  ...
  >
    ...
    <path d="M8 21s-4-3-4-9 4-9 4-9m8 0s4 3 4 9-4 9-4 9M15 9l-6 6m0-6l6 6"/>
  </svg>
  <!-- #endif -->
