...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M3 8l4-4 4 4M7 4v16m10-10V4h-2m0 6h4"/><rect width="4" height="6" x="15" y="14" ry="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M3 8l4-4 4 4M7 4v16m10-10V4h-2m0 6h4"/><rect width="4" height="6" x="15" y="14" ry="2"/>
  </svg>
  <!-- #endif -->
