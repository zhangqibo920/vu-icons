...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M8 2v4m8-4v4m5 7V6a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2h8M3 10h18m-4 12l5-5m-5 0l5 5"/>`
...
<template>
  ...
  >
    ...
    <path d="M8 2v4m8-4v4m5 7V6a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2h8M3 10h18m-4 12l5-5m-5 0l5 5"/>
  </svg>
  <!-- #endif -->
