...
const name = 'VuAlignHorizontalSpaceAround'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<rect width="6" height="10" x="9" y="7" rx="2"/><path d="M4 22V2m16 20V2"/>`
...
<template>
  ...
  >
    ...
    <rect width="6" height="10" x="9" y="7" rx="2"/><path d="M4 22V2m16 20V2"/>
  </svg>
  <!-- #endif -->
