...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M17.971 4.285A2 2 0 0121 6v12a2 2 0 01-3.029 1.715l-9.997-5.998a2 2 0 01-.003-3.432zM3 20V4"/>`
...
<template>
  ...
  >
    ...
    <path d="M17.971 4.285A2 2 0 0121 6v12a2 2 0 01-3.029 1.715l-9.997-5.998a2 2 0 01-.003-3.432zM3 20V4"/>
  </svg>
  <!-- #endif -->
