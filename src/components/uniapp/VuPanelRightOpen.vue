...
const bgStyle = computed(() => {
  ...
  const svgContent = `<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M15 3v18m-5-6l-3-3 3-3"/>`
...
<template>
  ...
  >
    ...
    <rect width="18" height="18" x="3" y="3" rx="2"/><path d="M15 3v18m-5-6l-3-3 3-3"/>
  </svg>
  <!-- #endif -->
