...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M6.87 6.87a8 8 0 1011.26 11.26m1.77-3.88a8 8 0 00-9.15-9.15M22 6l-3-3M6.26 18.67L4 21M2 2l20 20M4 4L2 6"/>`
...
<template>
  ...
  >
    ...
    <path d="M6.87 6.87a8 8 0 1011.26 11.26m1.77-3.88a8 8 0 00-9.15-9.15M22 6l-3-3M6.26 18.67L4 21M2 2l20 20M4 4L2 6"/>
  </svg>
  <!-- #endif -->
