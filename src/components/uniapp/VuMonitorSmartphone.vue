...
const name = 'VuMonitorSmartphone'
...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M18 8V6a2 2 0 00-2-2H4a2 2 0 00-2 2v7a2 2 0 002 2h8m-2 4v-3.96 3.15M7 19h5"/><rect width="6" height="10" x="16" y="12" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M18 8V6a2 2 0 00-2-2H4a2 2 0 00-2 2v7a2 2 0 002 2h8m-2 4v-3.96 3.15M7 19h5"/><rect width="6" height="10" x="16" y="12" rx="2"/>
  </svg>
  <!-- #endif -->
