...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M5 17H4a2 2 0 01-2-2V5a2 2 0 012-2h16a2 2 0 012 2v10a2 2 0 01-2 2h-1"/><path d="M12 15l5 6H7z"/>`
...
<template>
  ...
  >
    ...
    <path d="M5 17H4a2 2 0 01-2-2V5a2 2 0 012-2h16a2 2 0 012 2v10a2 2 0 01-2 2h-1"/><path d="M12 15l5 6H7z"/>
  </svg>
  <!-- #endif -->
