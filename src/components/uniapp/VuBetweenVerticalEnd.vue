...
const name = 'VuBetweenVerticalEnd'
...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<rect width="7" height="13" x="3" y="3" rx="1"/><path d="M9 22l3-3 3 3"/><rect width="7" height="13" x="14" y="3" rx="1"/>`
...
<template>
  ...
  >
    ...
    <rect width="7" height="13" x="3" y="3" rx="1"/><path d="M9 22l3-3 3 3"/><rect width="7" height="13" x="14" y="3" rx="1"/>
  </svg>
  <!-- #endif -->
