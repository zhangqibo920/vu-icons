...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M4 20h16a2 2 0 002-2V8a2 2 0 00-2-2h-7.93a2 2 0 01-1.66-.9l-.82-1.2A2 2 0 007.93 3H4a2 2 0 00-2 2v13c0 1.1.9 2 2 2m4-10v4m4-4v2m4-2v6"/>`
...
<template>
  ...
  >
    ...
    <path d="M4 20h16a2 2 0 002-2V8a2 2 0 00-2-2h-7.93a2 2 0 01-1.66-.9l-.82-1.2A2 2 0 007.93 3H4a2 2 0 00-2 2v13c0 1.1.9 2 2 2m4-10v4m4-4v2m4-2v6"/>
  </svg>
  <!-- #endif -->
