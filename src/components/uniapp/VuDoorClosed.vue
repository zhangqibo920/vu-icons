...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M10 12h.01M18 20V6a2 2 0 00-2-2H8a2 2 0 00-2 2v14m-4 0h20"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 12h.01M18 20V6a2 2 0 00-2-2H8a2 2 0 00-2 2v14m-4 0h20"/>
  </svg>
  <!-- #endif -->
