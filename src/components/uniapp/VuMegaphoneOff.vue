...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M11.636 6A13 13 0 0019.4 3.2 1 1 0 0121 4v11.344m-6.622-.987A13 13 0 0011 14H5a2 2 0 01-2-2V8a2 2 0 012-2h1M2 2l20 20"/><path d="M6 14a12 12 0 002.4 7.2 2 2 0 003.2-2.4A8 8 0 0110 14M8 8v6"/>`
...
<template>
  ...
  >
    ...
    <path d="M11.636 6A13 13 0 0019.4 3.2 1 1 0 0121 4v11.344m-6.622-.987A13 13 0 0011 14H5a2 2 0 01-2-2V8a2 2 0 012-2h1M2 2l20 20"/><path d="M6 14a12 12 0 002.4 7.2 2 2 0 003.2-2.4A8 8 0 0110 14M8 8v6"/>
  </svg>
  <!-- #endif -->
