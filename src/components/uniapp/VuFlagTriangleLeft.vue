...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M18 22V2.8a.8.8 0 00-1.17-.71L5.45 7.78a.8.8 0 000 1.44L18 15.5"/>`
...
<template>
  ...
  >
    ...
    <path d="M18 22V2.8a.8.8 0 00-1.17-.71L5.45 7.78a.8.8 0 000 1.44L18 15.5"/>
  </svg>
  <!-- #endif -->
