...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M20 20a2 2 0 002-2V8a2 2 0 00-2-2h-7.9a2 2 0 01-1.69-.9L9.6 3.9A2 2 0 007.93 3H4a2 2 0 00-2 2v13a2 2 0 002 2zm-8-10v6"/><path d="M9 13l3-3 3 3"/>`
...
<template>
  ...
  >
    ...
    <path d="M20 20a2 2 0 002-2V8a2 2 0 00-2-2h-7.9a2 2 0 01-1.69-.9L9.6 3.9A2 2 0 007.93 3H4a2 2 0 00-2 2v13a2 2 0 002 2zm-8-10v6"/><path d="M9 13l3-3 3 3"/>
  </svg>
  <!-- #endif -->
