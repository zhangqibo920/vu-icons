...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M15 12h6m-6-6h6M3 13l3.553-7.724a.5.5 0 01.894 0L11 13m-8 5h18M3.92 11h6.16"/>`
...
<template>
  ...
  >
    ...
    <path d="M15 12h6m-6-6h6M3 13l3.553-7.724a.5.5 0 01.894 0L11 13m-8 5h18M3.92 11h6.16"/>
  </svg>
  <!-- #endif -->
