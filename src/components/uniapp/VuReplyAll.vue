...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 17l-5-5 5-5"/><path d="M22 18v-2a4 4 0 00-4-4H7m0 5l-5-5 5-5"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 17l-5-5 5-5"/><path d="M22 18v-2a4 4 0 00-4-4H7m0 5l-5-5 5-5"/>
  </svg>
  <!-- #endif -->
