...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M10 9.17a3 3 0 100 5.66m7-5.66a3 3 0 100 5.66"/><rect width="20" height="14" x="2" y="5" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 9.17a3 3 0 100 5.66m7-5.66a3 3 0 100 5.66"/><rect width="20" height="14" x="2" y="5" rx="2"/>
  </svg>
  <!-- #endif -->
