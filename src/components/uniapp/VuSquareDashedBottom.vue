...
const name = 'VuSquareDashedBottom'
...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M5 21a2 2 0 01-2-2V5a2 2 0 012-2h14a2 2 0 012 2v14a2 2 0 01-2 2M9 21h1m4 0h1"/>`
...
<template>
  ...
  >
    ...
    <path d="M5 21a2 2 0 01-2-2V5a2 2 0 012-2h14a2 2 0 012 2v14a2 2 0 01-2 2M9 21h1m4 0h1"/>
  </svg>
  <!-- #endif -->
