...
const bgStyle = computed(() => {
  ...
  const svgContent = `<rect width="18" height="18" x="3" y="3" rx="2"/><rect width="8" height="8" x="8" y="8" rx="1"/>`
...
<template>
  ...
  >
    ...
    <rect width="18" height="18" x="3" y="3" rx="2"/><rect width="8" height="8" x="8" y="8" rx="1"/>
  </svg>
  <!-- #endif -->
