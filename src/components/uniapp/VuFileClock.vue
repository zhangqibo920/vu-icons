...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M16 22h2a2 2 0 002-2V8a2.4 2.4 0 00-.706-1.706l-3.588-3.588A2.4 2.4 0 0014 2H6a2 2 0 00-2 2v2.85"/><path d="M14 2v5a1 1 0 001 1h5M8 14v2.2l1.6 1"/><circle cx="8" cy="16" r="6"/>`
...
<template>
  ...
  >
    ...
    <path d="M16 22h2a2 2 0 002-2V8a2.4 2.4 0 00-.706-1.706l-3.588-3.588A2.4 2.4 0 0014 2H6a2 2 0 00-2 2v2.85"/><path d="M14 2v5a1 1 0 001 1h5M8 14v2.2l1.6 1"/><circle cx="8" cy="16" r="6"/>
  </svg>
  <!-- #endif -->
