...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M15 3v18M3 12h18M9 3v18"/><rect width="18" height="18" x="3" y="3" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M15 3v18M3 12h18M9 3v18"/><rect width="18" height="18" x="3" y="3" rx="2"/>
  </svg>
  <!-- #endif -->
