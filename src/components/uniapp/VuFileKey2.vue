...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M4 22h14a2 2 0 002-2V7l-5-5H6a2 2 0 00-2 2v6"/><path d="M14 2v4a2 2 0 002 2h4"/><circle cx="4" cy="16" r="2"/><path d="M10 10l-4.5 4.5M9 11l1 1"/>`
...
<template>
  ...
  >
    ...
    <path d="M4 22h14a2 2 0 002-2V7l-5-5H6a2 2 0 00-2 2v6"/><path d="M14 2v4a2 2 0 002 2h4"/><circle cx="4" cy="16" r="2"/><path d="M10 10l-4.5 4.5M9 11l1 1"/>
  </svg>
  <!-- #endif -->
