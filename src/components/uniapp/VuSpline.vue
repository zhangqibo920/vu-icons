...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<circle cx="19" cy="5" r="2"/><circle cx="5" cy="19" r="2"/><path d="M5 17A12 12 0 0117 5"/>`
...
<template>
  ...
  >
    ...
    <circle cx="19" cy="5" r="2"/><circle cx="5" cy="19" r="2"/><path d="M5 17A12 12 0 0117 5"/>
  </svg>
  <!-- #endif -->
