...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M22 11v1a10 10 0 11-9-10"/><path d="M8 14s1.5 2 4 2 4-2 4-2M9 9h.01M15 9h.01M16 5h6m-3-3v6"/>`
...
<template>
  ...
  >
    ...
    <path d="M22 11v1a10 10 0 11-9-10"/><path d="M8 14s1.5 2 4 2 4-2 4-2M9 9h.01M15 9h.01M16 5h6m-3-3v6"/>
  </svg>
  <!-- #endif -->
