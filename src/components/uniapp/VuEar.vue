...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M6 8.5a6.5 6.5 0 1113 0c0 6-6 6-6 10a3.5 3.5 0 11-7 0"/><path d="M15 8.5a2.5 2.5 0 00-5 0v1a2 2 0 110 4"/>`
...
<template>
  ...
  >
    ...
    <path d="M6 8.5a6.5 6.5 0 1113 0c0 6-6 6-6 10a3.5 3.5 0 11-7 0"/><path d="M15 8.5a2.5 2.5 0 00-5 0v1a2 2 0 110 4"/>
  </svg>
  <!-- #endif -->
