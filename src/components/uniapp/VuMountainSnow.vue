...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M8 3l4 8 5-5 5 15H2z"/><path d="M4.14 15.08q3.93-2.355 7.86.42c2.74 1.94 5.49 2 8.23.19"/>`
...
<template>
  ...
  >
    ...
    <path d="M8 3l4 8 5-5 5 15H2z"/><path d="M4.14 15.08q3.93-2.355 7.86.42c2.74 1.94 5.49 2 8.23.19"/>
  </svg>
  <!-- #endif -->
