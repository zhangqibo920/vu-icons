...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M3 7V5a2 2 0 012-2h2m10 0h2a2 2 0 012 2v2m0 10v2a2 2 0 01-2 2h-2M7 21H5a2 2 0 01-2-2v-2m5-3s1.5 2 4 2 4-2 4-2M9 9h.01M15 9h.01"/>`
...
<template>
  ...
  >
    ...
    <path d="M3 7V5a2 2 0 012-2h2m10 0h2a2 2 0 012 2v2m0 10v2a2 2 0 01-2 2h-2M7 21H5a2 2 0 01-2-2v-2m5-3s1.5 2 4 2 4-2 4-2M9 9h.01M15 9h.01"/>
  </svg>
  <!-- #endif -->
