...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 3V2m3.4 15.4l3.2-2.8a2 2 0 112.8 2.9l-3.6 3.3c-.7.8-1.7 1.2-2.8 1.2h-4c-1.1 0-2.1-.4-2.8-1.2l-1.302-1.464A1 1 0 006.151 19H5"/><path d="M2 14h12a2 2 0 010 4h-2m-8-8h16M5 10a7 7 0 0114 0"/><path d="M5 14v6a1 1 0 01-1 1H2"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 3V2m3.4 15.4l3.2-2.8a2 2 0 112.8 2.9l-3.6 3.3c-.7.8-1.7 1.2-2.8 1.2h-4c-1.1 0-2.1-.4-2.8-1.2l-1.302-1.464A1 1 0 006.151 19H5"/><path d="M2 14h12a2 2 0 010 4h-2m-8-8h16M5 10a7 7 0 0114 0"/><path d="M5 14v6a1 1 0 01-1 1H2"/>
  </svg>
  <!-- #endif -->
