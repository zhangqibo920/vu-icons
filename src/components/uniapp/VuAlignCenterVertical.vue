...
const name = 'VuAlignCenterVertical'
...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 2v20M8 10H4a2 2 0 01-2-2V6c0-1.1.9-2 2-2h4m8 6h4a2 2 0 002-2V6a2 2 0 00-2-2h-4M8 20H7a2 2 0 01-2-2v-2c0-1.1.9-2 2-2h1m8 0h1a2 2 0 012 2v2a2 2 0 01-2 2h-1"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 2v20M8 10H4a2 2 0 01-2-2V6c0-1.1.9-2 2-2h4m8 6h4a2 2 0 002-2V6a2 2 0 00-2-2h-4M8 20H7a2 2 0 01-2-2v-2c0-1.1.9-2 2-2h1m8 0h1a2 2 0 012 2v2a2 2 0 01-2 2h-1"/>
  </svg>
  <!-- #endif -->
