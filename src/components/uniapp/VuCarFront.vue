...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M21 8l-2 2-1.5-3.7A2 2 0 0015.646 5H8.4a2 2 0 00-1.903 1.257L5 10 3 8m4 6h.01M17 14h.01"/><rect width="18" height="8" x="3" y="10" rx="2"/><path d="M5 18v2m14-2v2"/>`
...
<template>
  ...
  >
    ...
    <path d="M21 8l-2 2-1.5-3.7A2 2 0 0015.646 5H8.4a2 2 0 00-1.903 1.257L5 10 3 8m4 6h.01M17 14h.01"/><rect width="18" height="8" x="3" y="10" rx="2"/><path d="M5 18v2m14-2v2"/>
  </svg>
  <!-- #endif -->
