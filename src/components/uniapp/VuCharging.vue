...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<rect width="18" height="12" x="1" y="6" rx="2" ry="2"/><path d="M23 13v-2M11 6V4v2"/>`
...
<template>
  ...
  >
    ...
    <rect width="18" height="12" x="1" y="6" rx="2" ry="2"/><path d="M23 13v-2M11 6V4v2"/>
  </svg>
  <!-- #endif -->
