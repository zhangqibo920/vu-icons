...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M9 13h6m5 7a2 2 0 002-2V8a2 2 0 00-2-2h-7.9a2 2 0 01-1.69-.9L9.6 3.9A2 2 0 007.93 3H4a2 2 0 00-2 2v13a2 2 0 002 2z"/>`
...
<template>
  ...
  >
    ...
    <path d="M9 13h6m5 7a2 2 0 002-2V8a2 2 0 00-2-2h-7.9a2 2 0 01-1.69-.9L9.6 3.9A2 2 0 007.93 3H4a2 2 0 00-2 2v13a2 2 0 002 2z"/>
  </svg>
  <!-- #endif -->
