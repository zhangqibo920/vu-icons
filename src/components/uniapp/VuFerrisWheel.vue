...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<circle cx="12" cy="12" r="2"/><path d="M12 2v4m-5.2 9l-3.5 2M20.7 7l-3.5 2M6.8 9L3.3 7m17.4 10l-3.5-2M9 22l3-8 3 8m-7 0h8M18 18.7a9 9 0 10-12 0"/>`
...
<template>
  ...
  >
    ...
    <circle cx="12" cy="12" r="2"/><path d="M12 2v4m-5.2 9l-3.5 2M20.7 7l-3.5 2M6.8 9L3.3 7m17.4 10l-3.5-2M9 22l3-8 3 8m-7 0h8M18 18.7a9 9 0 10-12 0"/>
  </svg>
  <!-- #endif -->
