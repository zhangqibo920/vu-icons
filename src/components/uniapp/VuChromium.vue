...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M10.88 21.94L15.46 14m5.71-6H12M3.95 6.06L8.54 14"/><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="4"/>`
...
<template>
  ...
  >
    ...
    <path d="M10.88 21.94L15.46 14m5.71-6H12M3.95 6.06L8.54 14"/><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="4"/>
  </svg>
  <!-- #endif -->
