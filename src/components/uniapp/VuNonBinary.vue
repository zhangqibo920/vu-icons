...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 2v10M8.5 4l7 4m-7 0l7-4"/><circle cx="12" cy="17" r="5"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 2v10M8.5 4l7 4m-7 0l7-4"/><circle cx="12" cy="17" r="5"/>
  </svg>
  <!-- #endif -->
