...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M11.1 7.1a16.55 16.55 0 0110.9 4M12 12a12.6 12.6 0 01-8.7 5m13.5-3.4a16.55 16.55 0 01-9 7.5"/><path d="M20.7 17a12.8 12.8 0 00-8.7-5 13.3 13.3 0 010-10M6.3 3.8a16.55 16.55 0 001.9 11.5"/><circle cx="12" cy="12" r="10"/>`
...
<template>
  ...
  >
    ...
    <path d="M11.1 7.1a16.55 16.55 0 0110.9 4M12 12a12.6 12.6 0 01-8.7 5m13.5-3.4a16.55 16.55 0 01-9 7.5"/><path d="M20.7 17a12.8 12.8 0 00-8.7-5 13.3 13.3 0 010-10M6.3 3.8a16.55 16.55 0 001.9 11.5"/><circle cx="12" cy="12" r="10"/>
  </svg>
  <!-- #endif -->
