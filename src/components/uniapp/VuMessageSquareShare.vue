...
const name = 'VuMessageSquareShare'
...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 3H4a2 2 0 00-2 2v16.286a.71.71 0 001.212.502l2.202-2.202A2 2 0 016.828 19H20a2 2 0 002-2v-4M16 3h6v6m-6 0l6-6"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 3H4a2 2 0 00-2 2v16.286a.71.71 0 001.212.502l2.202-2.202A2 2 0 016.828 19H20a2 2 0 002-2v-4M16 3h6v6m-6 0l6-6"/>
  </svg>
  <!-- #endif -->
