...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M15 6.5V3a1 1 0 00-1-1h-2a1 1 0 00-1 1v3.5M9 18h8m1-15h-3"/><path d="M11 3a6 6 0 00-6 6v11m0-7h4m8-3a4 4 0 00-8 0v10a2 2 0 002 2h4a2 2 0 002-2z"/>`
