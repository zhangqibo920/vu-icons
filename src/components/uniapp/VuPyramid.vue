...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M2.5 16.88a1 1 0 01-.32-1.43l9-13.02a1 1 0 011.64 0l9 13.01a1 1 0 01-.32 1.44l-8.51 4.86a2 2 0 01-1.98 0zM12 2v20"/>`
...
<template>
  ...
  >
    ...
    <path d="M2.5 16.88a1 1 0 01-.32-1.43l9-13.02a1 1 0 011.64 0l9 13.01a1 1 0 01-.32 1.44l-8.51 4.86a2 2 0 01-1.98 0zM12 2v20"/>
  </svg>
  <!-- #endif -->
