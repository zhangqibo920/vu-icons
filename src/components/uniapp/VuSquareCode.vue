...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M10 9l-3 3 3 3m4 0l3-3-3-3"/><rect width="18" height="18" x="3" y="3" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 9l-3 3 3 3m4 0l3-3-3-3"/><rect width="18" height="18" x="3" y="3" rx="2"/>
  </svg>
  <!-- #endif -->
