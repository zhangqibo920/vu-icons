...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M9 13a1 1 0 00-1-1H5.061a1 1 0 01-.75-1.811l6.836-6.835a1.207 1.207 0 011.707 0l6.835 6.835a1 1 0 01-.75 1.811H16a1 1 0 00-1 1v2a1 1 0 01-1 1h-4a1 1 0 01-1-1zm0 7h6"/>`
...
<template>
  ...
  >
    ...
    <path d="M9 13a1 1 0 00-1-1H5.061a1 1 0 01-.75-1.811l6.836-6.835a1.207 1.207 0 011.707 0l6.835 6.835a1 1 0 01-.75 1.811H16a1 1 0 00-1 1v2a1 1 0 01-1 1h-4a1 1 0 01-1-1zm0 7h6"/>
  </svg>
  <!-- #endif -->
