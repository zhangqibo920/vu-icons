...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M22 13V6a2 2 0 00-2-2H4a2 2 0 00-2 2v12c0 1.1.9 2 2 2h8"/><path d="M22 7l-8.97 5.7a1.94 1.94 0 01-2.06 0L2 7m14 12l2 2 4-4"/>`
...
<template>
  ...
  >
    ...
    <path d="M22 13V6a2 2 0 00-2-2H4a2 2 0 00-2 2v12c0 1.1.9 2 2 2h8"/><path d="M22 7l-8.97 5.7a1.94 1.94 0 01-2.06 0L2 7m14 12l2 2 4-4"/>
  </svg>
  <!-- #endif -->
