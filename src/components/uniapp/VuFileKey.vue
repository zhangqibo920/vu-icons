...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M10.65 22H18a2 2 0 002-2V8a2.4 2.4 0 00-.706-1.706l-3.588-3.588A2.4 2.4 0 0014 2H6a2 2 0 00-2 2v10.1"/><path d="M14 2v5a1 1 0 001 1h5m-10 7l1 1m0-2l-4.586 4.586"/><circle cx="5" cy="20" r="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M10.65 22H18a2 2 0 002-2V8a2.4 2.4 0 00-.706-1.706l-3.588-3.588A2.4 2.4 0 0014 2H6a2 2 0 00-2 2v10.1"/><path d="M14 2v5a1 1 0 001 1h5m-10 7l1 1m0-2l-4.586 4.586"/><circle cx="5" cy="20" r="2"/>
  </svg>
  <!-- #endif -->
