...
const name = 'VuAlignVerticalDistributeStart'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<rect width="14" height="6" x="5" y="14" rx="2"/><rect width="10" height="6" x="7" y="4" rx="2"/><path d="M2 14h20M2 4h20"/>`
...
<template>
  ...
  >
    ...
    <rect width="14" height="6" x="5" y="14" rx="2"/><rect width="10" height="6" x="7" y="4" rx="2"/><path d="M2 14h20M2 4h20"/>
  </svg>
  <!-- #endif -->
