...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M2 21a8 8 0 0113.292-6"/><circle cx="10" cy="8" r="5"/><path d="M16 19l2 2 4-4"/>`
...
<template>
  ...
  >
    ...
    <path d="M2 21a8 8 0 0113.292-6"/><circle cx="10" cy="8" r="5"/><path d="M16 19l2 2 4-4"/>
  </svg>
  <!-- #endif -->
