...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M18 11h-4a1 1 0 00-1 1v5a1 1 0 001 1h4"/><path d="M6 7v13a2 2 0 002 2h8a2 2 0 002-2V7"/><rect width="16" height="5" x="4" y="2" rx="1"/>`
...
<template>
  ...
  >
    ...
    <path d="M18 11h-4a1 1 0 00-1 1v5a1 1 0 001 1h4"/><path d="M6 7v13a2 2 0 002 2h8a2 2 0 002-2V7"/><rect width="16" height="5" x="4" y="2" rx="1"/>
  </svg>
  <!-- #endif -->
