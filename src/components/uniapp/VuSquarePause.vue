...
const bgStyle = computed(() => {
  ...
  const svgContent = `<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M10 15V9m4 6V9"/>`
...
<template>
  ...
  >
    ...
    <rect width="18" height="18" x="3" y="3" rx="2"/><path d="M10 15V9m4 6V9"/>
  </svg>
  <!-- #endif -->
