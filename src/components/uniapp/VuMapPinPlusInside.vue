...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 01-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0116 0m-8-3v6m-3-3h6"/>`
...
<template>
  ...
  >
    ...
    <path d="M20 10c0 4.993-5.539 10.193-7.399 11.799a1 1 0 01-1.202 0C9.539 20.193 4 14.993 4 10a8 8 0 0116 0m-8-3v6m-3-3h6"/>
  </svg>
  <!-- #endif -->
