...
const name = 'VuMessageSquareReply'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M22 17a2 2 0 01-2 2H6.828a2 2 0 00-1.414.586l-2.202 2.202A.71.71 0 012 21.286V5a2 2 0 012-2h16a2 2 0 012 2z"/><path d="M10 8l-3 3 3 3"/><path d="M17 14v-1a2 2 0 00-2-2H7"/>`
...
<template>
  ...
  >
    ...
    <path d="M22 17a2 2 0 01-2 2H6.828a2 2 0 00-1.414.586l-2.202 2.202A.71.71 0 012 21.286V5a2 2 0 012-2h16a2 2 0 012 2z"/><path d="M10 8l-3 3 3 3"/><path d="M17 14v-1a2 2 0 00-2-2H7"/>
  </svg>
  <!-- #endif -->
