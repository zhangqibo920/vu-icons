...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M3 3v16a2 2 0 002 2h16"/><rect width="9" height="4" x="7" y="13" rx="1"/><rect width="12" height="4" x="7" y="5" rx="1"/>`
...
<template>
  ...
  >
    ...
    <path d="M3 3v16a2 2 0 002 2h16"/><rect width="9" height="4" x="7" y="13" rx="1"/><rect width="12" height="4" x="7" y="5" rx="1"/>
  </svg>
  <!-- #endif -->
