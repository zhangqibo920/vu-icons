...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 13V2l8 4-8 4M20.561 10.222a9 9 0 11-12.55-5.29M8.002 9.997a5 5 0 108.9 2.02"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 13V2l8 4-8 4M20.561 10.222a9 9 0 11-12.55-5.29M8.002 9.997a5 5 0 108.9 2.02"/>
  </svg>
  <!-- #endif -->
