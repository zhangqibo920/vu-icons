...
const bgStyle = computed(() => {
  ...
  const svgContent = `<circle cx="10" cy="7" r="4"/><path d="M10.3 15H7a4 4 0 00-4 4v2m12-5.5V14a2 2 0 014 0v1.5"/><rect width="8" height="5" x="13" y="16" rx=".899"/>`
...
<template>
  ...
  >
    ...
    <circle cx="10" cy="7" r="4"/><path d="M10.3 15H7a4 4 0 00-4 4v2m12-5.5V14a2 2 0 014 0v1.5"/><rect width="8" height="5" x="13" y="16" rx=".899"/>
  </svg>
  <!-- #endif -->
