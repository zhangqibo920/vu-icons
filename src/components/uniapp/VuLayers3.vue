...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12.83 2.18a2 2 0 00-1.66 0L2.6 6.08a1 1 0 000 1.83l8.58 3.91a2 2 0 001.66 0l8.58-3.9a1 1 0 000-1.83z"/><path d="M6.08 9.5l-3.5 1.6a1 1 0 000 1.81l8.6 3.91a2 2 0 001.65 0l8.58-3.9a1 1 0 000-1.83l-3.5-1.59"/><path d="M6.08 14.5l-3.5 1.6a1 1 0 000 1.81l8.6 3.91a2 2 0 001.65 0l8.58-3.9a1 1 0 000-1.83l-3.5-1.59"/>`
...
<template>
  ...
  >
    ...
    <path d="M12.83 2.18a2 2 0 00-1.66 0L2.6 6.08a1 1 0 000 1.83l8.58 3.91a2 2 0 001.66 0l8.58-3.9a1 1 0 000-1.83z"/><path d="M6.08 9.5l-3.5 1.6a1 1 0 000 1.81l8.6 3.91a2 2 0 001.65 0l8.58-3.9a1 1 0 000-1.83l-3.5-1.59"/><path d="M6.08 14.5l-3.5 1.6a1 1 0 000 1.81l8.6 3.91a2 2 0 001.65 0l8.58-3.9a1 1 0 000-1.83l-3.5-1.59"/>
  </svg>
  <!-- #endif -->
