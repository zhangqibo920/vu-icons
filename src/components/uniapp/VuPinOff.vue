...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 17v5m3-12.66V7a1 1 0 011-1 2 2 0 000-4H7.89M2 2l20 20M9 9v1.76a2 2 0 01-1.11 1.79l-1.78.9A2 2 0 005 15.24V16a1 1 0 001 1h11"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 17v5m3-12.66V7a1 1 0 011-1 2 2 0 000-4H7.89M2 2l20 20M9 9v1.76a2 2 0 01-1.11 1.79l-1.78.9A2 2 0 005 15.24V16a1 1 0 001 1h11"/>
  </svg>
  <!-- #endif -->
