...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<rect width="12" height="12" x="2" y="10" rx="2" ry="2"/><path d="M17.92 14l3.5-3.5a2.24 2.24 0 000-3l-5-4.92a2.24 2.24 0 00-3 0L10 6M6 18h.01M10 14h.01M15 6h.01M18 9h.01"/>`
...
<template>
  ...
  >
    ...
    <rect width="12" height="12" x="2" y="10" rx="2" ry="2"/><path d="M17.92 14l3.5-3.5a2.24 2.24 0 000-3l-5-4.92a2.24 2.24 0 00-3 0L10 6M6 18h.01M10 14h.01M15 6h.01M18 9h.01"/>
  </svg>
  <!-- #endif -->
