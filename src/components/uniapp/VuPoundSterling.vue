...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M18 7c0-5.333-8-5.333-8 0m0 0v14m-4 0h12M6 13h10"/>`
...
<template>
  ...
  >
    ...
    <path d="M18 7c0-5.333-8-5.333-8 0m0 0v14m-4 0h12M6 13h10"/>
  </svg>
  <!-- #endif -->
