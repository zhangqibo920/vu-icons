...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M4 19.5v-15A2.5 2.5 0 016.5 2H19a1 1 0 011 1v18a1 1 0 01-1 1H6.5a1 1 0 010-5H20"/><path d="M9 9.5l2 2 4-4"/>`
...
<template>
  ...
  >
    ...
    <path d="M4 19.5v-15A2.5 2.5 0 016.5 2H19a1 1 0 011 1v18a1 1 0 01-1 1H6.5a1 1 0 010-5H20"/><path d="M9 9.5l2 2 4-4"/>
  </svg>
  <!-- #endif -->
