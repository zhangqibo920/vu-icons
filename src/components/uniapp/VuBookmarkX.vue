...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M14.5 7.5l-5 5M17 3a2 2 0 012 2v15a1 1 0 01-1.496.868l-4.512-2.578a2 2 0 00-1.984 0l-4.512 2.578A1 1 0 015 20V5a2 2 0 012-2zM9.5 7.5l5 5"/>`
...
<template>
  ...
  >
    ...
    <path d="M14.5 7.5l-5 5M17 3a2 2 0 012 2v15a1 1 0 01-1.496.868l-4.512-2.578a2 2 0 00-1.984 0l-4.512 2.578A1 1 0 015 20V5a2 2 0 012-2zM9.5 7.5l5 5"/>
  </svg>
  <!-- #endif -->
