...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M2 9.35V5a2 2 0 012-2h3.9a2 2 0 011.69.9l.81 1.2a2 2 0 001.67.9H20a2 2 0 012 2v10a2 2 0 01-2 2H4a2 2 0 01-2-2v-3a2 2 0 012-2h7"/><path d="M8 16l3-3-3-3"/>`
...
<template>
  ...
  >
    ...
    <path d="M2 9.35V5a2 2 0 012-2h3.9a2 2 0 011.69.9l.81 1.2a2 2 0 001.67.9H20a2 2 0 012 2v10a2 2 0 01-2 2H4a2 2 0 01-2-2v-3a2 2 0 012-2h7"/><path d="M8 16l3-3-3-3"/>
  </svg>
  <!-- #endif -->
