...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M15 13a3 3 0 10-6 0M4 19.5v-15A2.5 2.5 0 016.5 2H19a1 1 0 011 1v18a1 1 0 01-1 1H6.5a1 1 0 010-5H20"/><circle cx="12" cy="8" r="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M15 13a3 3 0 10-6 0M4 19.5v-15A2.5 2.5 0 016.5 2H19a1 1 0 011 1v18a1 1 0 01-1 1H6.5a1 1 0 010-5H20"/><circle cx="12" cy="8" r="2"/>
  </svg>
  <!-- #endif -->
