...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<rect width="20" height="16" x="2" y="4" rx="2"/><path d="M12 9v11M2 9h13a2 2 0 012 2v9"/>`
...
<template>
  ...
  >
    ...
    <rect width="20" height="16" x="2" y="4" rx="2"/><path d="M12 9v11M2 9h13a2 2 0 012 2v9"/>
  </svg>
  <!-- #endif -->
