...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M5 20a2 2 0 012-2h10a2 2 0 012 2v1a1 1 0 01-1 1H6a1 1 0 01-1-1zm5-18v2m4-2v2m3 14l-1-9M6 2v5a2 2 0 002 2h8a2 2 0 002-2V2M6 4h12M7 18l1-9"/>`
...
<template>
  ...
  >
    ...
    <path d="M5 20a2 2 0 012-2h10a2 2 0 012 2v1a1 1 0 01-1 1H6a1 1 0 01-1-1zm5-18v2m4-2v2m3 14l-1-9M6 2v5a2 2 0 002 2h8a2 2 0 002-2V2M6 4h12M7 18l1-9"/>
  </svg>
  <!-- #endif -->
