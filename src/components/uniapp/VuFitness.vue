...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M6.5 6.5h11M6 20v-2a6 6 0 1112 0v2"/><circle cx="12" cy="13" r="3"/><path d="M6 20a2 2 0 002 2h8a2 2 0 002-2"/>`
...
<template>
  ...
  >
    ...
    <path d="M6.5 6.5h11M6 20v-2a6 6 0 1112 0v2"/><circle cx="12" cy="13" r="3"/><path d="M6 20a2 2 0 002 2h8a2 2 0 002-2"/>
  </svg>
  <!-- #endif -->
