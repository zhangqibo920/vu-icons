...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<circle cx="12" cy="5" r="1"/><path d="M9 20l3-6 3 6M6 8l6 2 6-2m-6 2v4"/>`
...
<template>
  ...
  >
    ...
    <circle cx="12" cy="5" r="1"/><path d="M9 20l3-6 3 6M6 8l6 2 6-2m-6 2v4"/>
  </svg>
  <!-- #endif -->
