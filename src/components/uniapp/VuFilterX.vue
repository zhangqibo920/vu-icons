...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M13.013 3H2l8 9.46V19l4 2v-8.54l.9-1.055M22 3l-5 5m0-5l5 5"/>`
...
<template>
  ...
  >
    ...
    <path d="M13.013 3H2l8 9.46V19l4 2v-8.54l.9-1.055M22 3l-5 5m0-5l5 5"/>
  </svg>
  <!-- #endif -->
