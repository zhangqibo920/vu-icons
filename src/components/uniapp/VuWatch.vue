...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 10v2.2l1.6 1m2.53-5.54l-.81-4.05a2 2 0 00-2-1.61h-2.68a2 2 0 00-2 1.61l-.78 4.05m.02 8.7l.8 4a2 2 0 002 1.61h2.72a2 2 0 002-1.61l.81-4.05"/><circle cx="12" cy="12" r="6"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 10v2.2l1.6 1m2.53-5.54l-.81-4.05a2 2 0 00-2-1.61h-2.68a2 2 0 00-2 1.61l-.78 4.05m.02 8.7l.8 4a2 2 0 002 1.61h2.72a2 2 0 002-1.61l.81-4.05"/><circle cx="12" cy="12" r="6"/>
  </svg>
  <!-- #endif -->
