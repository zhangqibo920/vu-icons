...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 8l6-3-6-3v10"/><path d="M8 11.99l-5.5 3.14a1 1 0 000 1.74l8.5 4.86a2 2 0 002 0l8.5-4.86a1 1 0 000-1.74L16 12m-9.51.85l11.02 6.3m0-6.3L6.5 19.15"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 8l6-3-6-3v10"/><path d="M8 11.99l-5.5 3.14a1 1 0 000 1.74l8.5 4.86a2 2 0 002 0l8.5-4.86a1 1 0 000-1.74L16 12m-9.51.85l11.02 6.3m0-6.3L6.5 19.15"/>
  </svg>
  <!-- #endif -->
