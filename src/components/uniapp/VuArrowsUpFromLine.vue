...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M4 6l3-3 3 3M7 17V3m7 3l3-3 3 3m-3 11V3M4 21h16"/>`
...
<template>
  ...
  >
    ...
    <path d="M4 6l3-3 3 3M7 17V3m7 3l3-3 3 3m-3 11V3M4 21h16"/>
  </svg>
  <!-- #endif -->
