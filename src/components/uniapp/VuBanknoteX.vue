...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M13 18H4a2 2 0 01-2-2V8a2 2 0 012-2h16a2 2 0 012 2v5m-5 4l5 5m-4-10h.01M22 17l-5 5M6 12h.01"/><circle cx="12" cy="12" r="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M13 18H4a2 2 0 01-2-2V8a2 2 0 012-2h16a2 2 0 012 2v5m-5 4l5 5m-4-10h.01M22 17l-5 5M6 12h.01"/><circle cx="12" cy="12" r="2"/>
  </svg>
  <!-- #endif -->
