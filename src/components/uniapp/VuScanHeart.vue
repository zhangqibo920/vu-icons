...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M17 3h2a2 2 0 012 2v2m0 10v2a2 2 0 01-2 2h-2M3 7V5a2 2 0 012-2h2m0 18H5a2 2 0 01-2-2v-2m4.828-3.93A3 3 0 0112 8.764a3 3 0 014.172 4.306l-3.447 3.62a1 1 0 01-1.449 0z"/>`
...
<template>
  ...
  >
    ...
    <path d="M17 3h2a2 2 0 012 2v2m0 10v2a2 2 0 01-2 2h-2M3 7V5a2 2 0 012-2h2m0 18H5a2 2 0 01-2-2v-2m4.828-3.93A3 3 0 0112 8.764a3 3 0 014.172 4.306l-3.447 3.62a1 1 0 01-1.449 0z"/>
  </svg>
  <!-- #endif -->
