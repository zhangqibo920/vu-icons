...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M5 7a2 2 0 00-2 2v11"/><path d="M5.803 18H5a2 2 0 000 4h9.5a.5.5 0 00.5-.5V21m-6-6V4a2 2 0 012-2h9.5a.5.5 0 01.5.5v14a.5.5 0 01-.5.5H11a2 2 0 010-4h10"/>`
...
<template>
  ...
  >
    ...
    <path d="M5 7a2 2 0 00-2 2v11"/><path d="M5.803 18H5a2 2 0 000 4h9.5a.5.5 0 00.5-.5V21m-6-6V4a2 2 0 012-2h9.5a.5.5 0 01.5.5v14a.5.5 0 01-.5.5H11a2 2 0 010-4h10"/>
  </svg>
  <!-- #endif -->
