...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12.531 3H3a1 1 0 00-.742 1.67l7.225 7.989A2 2 0 0110 14v6a1 1 0 00.553.895l2 1A1 1 0 0014 21v-7a2 2 0 01.517-1.341l.427-.473M16.5 3.5l5 5m0-5l-5 5"/>`
...
<template>
  ...
  >
    ...
    <path d="M12.531 3H3a1 1 0 00-.742 1.67l7.225 7.989A2 2 0 0110 14v6a1 1 0 00.553.895l2 1A1 1 0 0014 21v-7a2 2 0 01.517-1.341l.427-.473M16.5 3.5l5 5m0-5l-5 5"/>
  </svg>
  <!-- #endif -->
