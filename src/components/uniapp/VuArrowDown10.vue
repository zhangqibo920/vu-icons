...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M3 16l4 4 4-4m-4 4V4m10 6V4h-2m0 6h4"/><rect width="4" height="6" x="15" y="14" ry="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M3 16l4 4 4-4m-4 4V4m10 6V4h-2m0 6h4"/><rect width="4" height="6" x="15" y="14" ry="2"/>
  </svg>
  <!-- #endif -->
