...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M9 2v17.5A2.5 2.5 0 016.5 22 2.5 2.5 0 014 19.5V2m16 0v17.5a2.5 2.5 0 01-2.5 2.5 2.5 2.5 0 01-2.5-2.5V2M3 2h7m4 0h7M9 16H4m16 0h-5"/>`
...
<template>
  ...
  >
    ...
    <path d="M9 2v17.5A2.5 2.5 0 016.5 22 2.5 2.5 0 014 19.5V2m16 0v17.5a2.5 2.5 0 01-2.5 2.5 2.5 2.5 0 01-2.5-2.5V2M3 2h7m4 0h7M9 16H4m16 0h-5"/>
  </svg>
  <!-- #endif -->
