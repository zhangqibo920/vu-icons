...
const bgStyle = computed(() => {
  ...
  const svgContent = `<circle cx="11" cy="11" r="8"/><path d="M21 21l-4.3-4.3M11 7v4m0 4h.01"/>`
...
<template>
  ...
  >
    ...
    <circle cx="11" cy="11" r="8"/><path d="M21 21l-4.3-4.3M11 7v4m0 4h.01"/>
  </svg>
  <!-- #endif -->
