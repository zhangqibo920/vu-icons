...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M2 13a2 2 0 002-2V7a2 2 0 014 0v13a2 2 0 004 0V4a2 2 0 014 0v13a2 2 0 004 0v-4a2 2 0 012-2"/>`
...
<template>
  ...
  >
    ...
    <path d="M2 13a2 2 0 002-2V7a2 2 0 014 0v13a2 2 0 004 0V4a2 2 0 014 0v13a2 2 0 004 0v-4a2 2 0 012-2"/>
  </svg>
  <!-- #endif -->
