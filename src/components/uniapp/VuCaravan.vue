...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M18 19V9a4 4 0 00-4-4H6a4 4 0 00-4 4v8a2 2 0 002 2h2"/><path d="M2 9h3a1 1 0 011 1v2a1 1 0 01-1 1H2m20 4v1a1 1 0 01-1 1H10v-9a1 1 0 011-1h2a1 1 0 011 1v9"/><circle cx="8" cy="19" r="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M18 19V9a4 4 0 00-4-4H6a4 4 0 00-4 4v8a2 2 0 002 2h2"/><path d="M2 9h3a1 1 0 011 1v2a1 1 0 01-1 1H2m20 4v1a1 1 0 01-1 1H10v-9a1 1 0 011-1h2a1 1 0 011 1v9"/><circle cx="8" cy="19" r="2"/>
  </svg>
  <!-- #endif -->
