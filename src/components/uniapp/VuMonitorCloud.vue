...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M11 13a3 3 0 112.83-4H14a2 2 0 010 4zm1 4v4m-4 0h8"/><rect width="20" height="14" x="2" y="3" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M11 13a3 3 0 112.83-4H14a2 2 0 010 4zm1 4v4m-4 0h8"/><rect width="20" height="14" x="2" y="3" rx="2"/>
  </svg>
  <!-- #endif -->
