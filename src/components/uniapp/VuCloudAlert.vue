...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 12v4m0 4h.01M17 18h.5a1 1 0 000-9h-1.79A7 7 0 107 17.708"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 12v4m0 4h.01M17 18h.5a1 1 0 000-9h-1.79A7 7 0 107 17.708"/>
  </svg>
  <!-- #endif -->
