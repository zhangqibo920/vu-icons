...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M8 6l4-4 4 4"/><path d="M12 2v10.3a4 4 0 01-1.172 2.872L4 22m16 0l-5-5"/>`
...
<template>
  ...
  >
    ...
    <path d="M8 6l4-4 4 4"/><path d="M12 2v10.3a4 4 0 01-1.172 2.872L4 22m16 0l-5-5"/>
  </svg>
  <!-- #endif -->
