...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M18 17.5a2.5 2.5 0 11-4 2.03V12m-8 0H4a2 2 0 01-2-2V5a2 2 0 012-2h16a2 2 0 012 2v5a2 2 0 01-2 2h-2M6 8h12M6.6 15.572A2 2 0 1010 17v-5"/>`
...
<template>
  ...
  >
    ...
    <path d="M18 17.5a2.5 2.5 0 11-4 2.03V12m-8 0H4a2 2 0 01-2-2V5a2 2 0 012-2h16a2 2 0 012 2v5a2 2 0 01-2 2h-2M6 8h12M6.6 15.572A2 2 0 1010 17v-5"/>
  </svg>
  <!-- #endif -->
