...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M16 16c-3 0-5-2-8-2a6 6 0 00-4 1.528M2 2l20 20M4 22V4m3.656-2H8c3 0 5 2 7.333 2q2 0 3.067-.8A1 1 0 0120 4v10.347"/>`
...
<template>
  ...
  >
    ...
    <path d="M16 16c-3 0-5-2-8-2a6 6 0 00-4 1.528M2 2l20 20M4 22V4m3.656-2H8c3 0 5 2 7.333 2q2 0 3.067-.8A1 1 0 0120 4v10.347"/>
  </svg>
  <!-- #endif -->
