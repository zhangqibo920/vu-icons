...
const name = 'VuAlignVerticalDistributeCenter'
...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M22 17h-3m3-10h-5M5 17H2M7 7H2"/><rect width="14" height="6" x="5" y="14" rx="2"/><rect width="10" height="6" x="7" y="4" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M22 17h-3m3-10h-5M5 17H2M7 7H2"/><rect width="14" height="6" x="5" y="14" rx="2"/><rect width="10" height="6" x="7" y="4" rx="2"/>
  </svg>
  <!-- #endif -->
