...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M16 6l-4-4-4 4m4-4v8"/><rect width="20" height="8" x="2" y="14" rx="2"/><path d="M6 18h.01M10 18h.01"/>`
...
<template>
  ...
  >
    ...
    <path d="M16 6l-4-4-4 4m4-4v8"/><rect width="20" height="8" x="2" y="14" rx="2"/><path d="M6 18h.01M10 18h.01"/>
  </svg>
  <!-- #endif -->
