...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M16 5h6m-3-3v6m2 3.5V19a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h7.5"/><path d="M21 15l-3.086-3.086a2 2 0 00-2.828 0L6 21"/><circle cx="9" cy="9" r="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M16 5h6m-3-3v6m2 3.5V19a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2h7.5"/><path d="M21 15l-3.086-3.086a2 2 0 00-2.828 0L6 21"/><circle cx="9" cy="9" r="2"/>
  </svg>
  <!-- #endif -->
