...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M5 16v2m14-2v2"/><rect width="20" height="8" x="2" y="8" rx="2"/><path d="M18 12h.01"/>`
...
<template>
  ...
  >
    ...
    <path d="M5 16v2m14-2v2"/><rect width="20" height="8" x="2" y="8" rx="2"/><path d="M18 12h.01"/>
  </svg>
  <!-- #endif -->
