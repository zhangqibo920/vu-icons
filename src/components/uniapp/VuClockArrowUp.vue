...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 6v6l1.56.78M13.227 21.925a10 10 0 118.767-9.588"/><path d="M14 18l4-4 4 4m-4 4v-8"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 6v6l1.56.78M13.227 21.925a10 10 0 118.767-9.588"/><path d="M14 18l4-4 4 4m-4 4v-8"/>
  </svg>
  <!-- #endif -->
