...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<rect width="18" height="4" x="3" y="8" rx="1"/><path d="M12 8v13m7-9v7a2 2 0 01-2 2H7a2 2 0 01-2-2v-7m2.5-4a2.5 2.5 0 010-5A4.8 8 0 0112 8a4.8 8 0 014.5-5 2.5 2.5 0 010 5"/>`
...
<template>
  ...
  >
    ...
    <rect width="18" height="4" x="3" y="8" rx="1"/><path d="M12 8v13m7-9v7a2 2 0 01-2 2H7a2 2 0 01-2-2v-7m2.5-4a2.5 2.5 0 010-5A4.8 8 0 0112 8a4.8 8 0 014.5-5 2.5 2.5 0 010 5"/>
  </svg>
  <!-- #endif -->
