...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M16 7h.01M3.4 18H12a8 8 0 008-8V7a4 4 0 00-7.28-2.3L2 20"/><path d="M20 7l2 .5-2 .5M10 18v3m4-3.25V21m-7-3a6 6 0 003.84-10.61"/>`
...
<template>
  ...
  >
    ...
    <path d="M16 7h.01M3.4 18H12a8 8 0 008-8V7a4 4 0 00-7.28-2.3L2 20"/><path d="M20 7l2 .5-2 .5M10 18v3m4-3.25V21m-7-3a6 6 0 003.84-10.61"/>
  </svg>
  <!-- #endif -->
