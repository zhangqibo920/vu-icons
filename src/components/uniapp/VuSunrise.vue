...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 2v8m-7.07.93l1.41 1.41M2 18h2m16 0h2m-2.93-7.07l-1.41 1.41M22 22H2M8 6l4-4 4 4m0 12a4 4 0 00-8 0"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 2v8m-7.07.93l1.41 1.41M2 18h2m16 0h2m-2.93-7.07l-1.41 1.41M22 22H2M8 6l4-4 4 4m0 12a4 4 0 00-8 0"/>
  </svg>
  <!-- #endif -->
