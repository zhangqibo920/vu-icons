...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M14.5 9.5l1 1m0-2l-4 4M3 12a9 9 0 109-9 9.74 9.74 0 00-6.74 2.74L3 8"/><path d="M3 3v5h5"/><circle cx="10" cy="14" r="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M14.5 9.5l1 1m0-2l-4 4M3 12a9 9 0 109-9 9.74 9.74 0 00-6.74 2.74L3 8"/><path d="M3 3v5h5"/><circle cx="10" cy="14" r="2"/>
  </svg>
  <!-- #endif -->
