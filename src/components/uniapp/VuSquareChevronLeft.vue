...
const name = 'VuSquareChevronLeft'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<rect width="18" height="18" x="3" y="3" rx="2"/><path d="M14 16l-4-4 4-4"/>`
...
<template>
  ...
  >
    ...
    <rect width="18" height="18" x="3" y="3" rx="2"/><path d="M14 16l-4-4 4-4"/>
  </svg>
  <!-- #endif -->
