...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M9 14L4 9l5-5"/><path d="M4 9h10.5a5.5 5.5 0 015.5 5.5 5.5 5.5 0 01-5.5 5.5H11"/>`
...
<template>
  ...
  >
    ...
    <path d="M9 14L4 9l5-5"/><path d="M4 9h10.5a5.5 5.5 0 015.5 5.5 5.5 5.5 0 01-5.5 5.5H11"/>
  </svg>
  <!-- #endif -->
