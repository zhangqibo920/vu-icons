...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M16 16l-2 2 2 2"/><path d="M3 12h15a3 3 0 110 6h-4M3 18h7M3 6h18"/>`
...
<template>
  ...
  >
    ...
    <path d="M16 16l-2 2 2 2"/><path d="M3 12h15a3 3 0 110 6h-4M3 18h7M3 6h18"/>
  </svg>
  <!-- #endif -->
