...
const name = 'VuCalendarArrowDown'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M14 18l4 4 4-4M16 2v4m2 8v8"/><path d="M21 11.354V6a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2h7.343M3 10h18M8 2v4"/>`
...
<template>
  ...
  >
    ...
    <path d="M14 18l4 4 4-4M16 2v4m2 8v8"/><path d="M21 11.354V6a2 2 0 00-2-2H5a2 2 0 00-2 2v14a2 2 0 002 2h7.343M3 10h18M8 2v4"/>
  </svg>
  <!-- #endif -->
