...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 20v-8m2.12-8.12L16 2m-1 5.13V6a3 3 0 00-5.14-2.1L8 2"/><path d="M18 12.34V11a4 4 0 00-4-4h-1.3M2 2l20 20"/><path d="M21 5a4 4 0 01-3.55 3.97M22 13h-3.34M3 21a4 4 0 013.81-4M6 13H2"/><path d="M7.7 7.7A4 4 0 006 11v3a6 6 0 0011.13 3.13"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 20v-8m2.12-8.12L16 2m-1 5.13V6a3 3 0 00-5.14-2.1L8 2"/><path d="M18 12.34V11a4 4 0 00-4-4h-1.3M2 2l20 20"/><path d="M21 5a4 4 0 01-3.55 3.97M22 13h-3.34M3 21a4 4 0 013.81-4M6 13H2"/><path d="M7.7 7.7A4 4 0 006 11v3a6 6 0 0011.13 3.13"/>
  </svg>
  <!-- #endif -->
