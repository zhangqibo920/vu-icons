...
const bgStyle = computed(() => {
  ...
  const svgContent = `<circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="3"/><circle cx="12" cy="12" r="6"/>`
...
<template>
  ...
  >
    ...
    <circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="3"/><circle cx="12" cy="12" r="6"/>
  </svg>
  <!-- #endif -->
