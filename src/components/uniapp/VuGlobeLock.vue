...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M15.686 15A14.5 14.5 0 0112 22a14.5 14.5 0 010-20 10 10 0 109.542 13M2 12h8.5M20 6V4a2 2 0 10-4 0v2"/><rect width="8" height="5" x="14" y="6" rx="1"/>`
...
<template>
  ...
  >
    ...
    <path d="M15.686 15A14.5 14.5 0 0112 22a14.5 14.5 0 010-20 10 10 0 109.542 13M2 12h8.5M20 6V4a2 2 0 10-4 0v2"/><rect width="8" height="5" x="14" y="6" rx="1"/>
  </svg>
  <!-- #endif -->
