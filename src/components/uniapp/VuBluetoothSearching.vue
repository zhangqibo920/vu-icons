...
const name = 'VuBluetoothSearching'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M7 7l10 10-5 5V2l5 5L7 17m13.83-2.17a4 4 0 000-5.66M18 12h.01"/>`
...
<template>
  ...
  >
    ...
    <path d="M7 7l10 10-5 5V2l5 5L7 17m13.83-2.17a4 4 0 000-5.66M18 12h.01"/>
  </svg>
  <!-- #endif -->
