...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 12v6m-7.923-7.385A1 1 0 005 12h14a1 1 0 00.923-1.385l-3.077-7.384A2 2 0 0015 2H9a2 2 0 00-1.846 1.23zM8 20a2 2 0 012-2h4a2 2 0 012 2v1a1 1 0 01-1 1H9a1 1 0 01-1-1z"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 12v6m-7.923-7.385A1 1 0 005 12h14a1 1 0 00.923-1.385l-3.077-7.384A2 2 0 0015 2H9a2 2 0 00-1.846 1.23zM8 20a2 2 0 012-2h4a2 2 0 012 2v1a1 1 0 01-1 1H9a1 1 0 01-1-1z"/>
  </svg>
  <!-- #endif -->
