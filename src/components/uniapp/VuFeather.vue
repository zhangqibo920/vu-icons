...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12.67 19a2 2 0 001.416-.588l6.154-6.172a6 6 0 00-8.49-8.49L5.586 9.914A2 2 0 005 11.328V18a1 1 0 001 1zM16 8L2 22m15.5-7H9"/>`
...
<template>
  ...
  >
    ...
    <path d="M12.67 19a2 2 0 001.416-.588l6.154-6.172a6 6 0 00-8.49-8.49L5.586 9.914A2 2 0 005 11.328V18a1 1 0 001 1zM16 8L2 22m15.5-7H9"/>
  </svg>
  <!-- #endif -->
