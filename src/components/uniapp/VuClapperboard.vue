...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M20.2 6L3 11l-.9-2.4c-.3-1.1.3-2.2 1.3-2.5l13.5-4c1.1-.3 2.2.3 2.5 1.3zm-14-.7l3.1 3.9m3.1-5.8l3.1 4M3 11h18v8a2 2 0 01-2 2H5a2 2 0 01-2-2z"/>`
...
<template>
  ...
  >
    ...
    <path d="M20.2 6L3 11l-.9-2.4c-.3-1.1.3-2.2 1.3-2.5l13.5-4c1.1-.3 2.2.3 2.5 1.3zm-14-.7l3.1 3.9m3.1-5.8l3.1 4M3 11h18v8a2 2 0 01-2 2H5a2 2 0 01-2-2z"/>
  </svg>
  <!-- #endif -->
