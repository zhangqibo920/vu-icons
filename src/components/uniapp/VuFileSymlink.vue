...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M4 11V4a2 2 0 012-2h8a2.4 2.4 0 011.706.706l3.588 3.588A2.4 2.4 0 0120 8v12a2 2 0 01-2 2H6a2 2 0 01-2-2v-3a2 2 0 012-2h7"/><path d="M14 2v5a1 1 0 001 1h5M10 18l3-3-3-3"/>`
...
<template>
  ...
  >
    ...
    <path d="M4 11V4a2 2 0 012-2h8a2.4 2.4 0 011.706.706l3.588 3.588A2.4 2.4 0 0120 8v12a2 2 0 01-2 2H6a2 2 0 01-2-2v-3a2 2 0 012-2h7"/><path d="M14 2v5a1 1 0 001 1h5M10 18l3-3-3-3"/>
  </svg>
  <!-- #endif -->
