...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M11 22H6a2 2 0 01-2-2V4a2 2 0 012-2h8a2.4 2.4 0 011.706.706l3.588 3.588A2.4 2.4 0 0120 8v5"/><path d="M14 2v5a1 1 0 001 1h5m-5 9l5 5m0-5l-5 5"/>`
...
<template>
  ...
  >
    ...
    <path d="M11 22H6a2 2 0 01-2-2V4a2 2 0 012-2h8a2.4 2.4 0 011.706.706l3.588 3.588A2.4 2.4 0 0120 8v5"/><path d="M14 2v5a1 1 0 001 1h5m-5 9l5 5m0-5l-5 5"/>
  </svg>
  <!-- #endif -->
