...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M6 22a2 2 0 01-2-2V4a2 2 0 012-2h8a2.4 2.4 0 011.704.706l3.588 3.588A2.4 2.4 0 0120 8v12a2 2 0 01-2 2z"/><path d="M14 2v5a1 1 0 001 1h5M9 15l2 2 4-4"/>`
...
<template>
  ...
  >
    ...
    <path d="M6 22a2 2 0 01-2-2V4a2 2 0 012-2h8a2.4 2.4 0 011.704.706l3.588 3.588A2.4 2.4 0 0120 8v12a2 2 0 01-2 2z"/><path d="M14 2v5a1 1 0 001 1h5M9 15l2 2 4-4"/>
  </svg>
  <!-- #endif -->
