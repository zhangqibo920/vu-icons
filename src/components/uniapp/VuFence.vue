...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M4 3L2 5v15c0 .6.4 1 1 1h2c.6 0 1-.4 1-1V5zm2 5h4M6 18h4m2-15l-2 2v15c0 .6.4 1 1 1h2c.6 0 1-.4 1-1V5zm2 5h4m-4 10h4m2-15l-2 2v15c0 .6.4 1 1 1h2c.6 0 1-.4 1-1V5z"/>`
