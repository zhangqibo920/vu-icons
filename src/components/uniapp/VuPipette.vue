...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 9l-8.414 8.414A2 2 0 003 18.828v1.344a2 2 0 01-.586 1.414A2 2 0 013.828 21h1.344a2 2 0 001.414-.586L15 12"/><path d="M18 9l.4.4a1 1 0 11-3 3l-3.8-3.8a1 1 0 113-3l.4.4 3.4-3.4a1 1 0 113 3zM2 22l.414-.414"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 9l-8.414 8.414A2 2 0 003 18.828v1.344a2 2 0 01-.586 1.414A2 2 0 013.828 21h1.344a2 2 0 001.414-.586L15 12"/><path d="M18 9l.4.4a1 1 0 11-3 3l-3.8-3.8a1 1 0 113-3l.4.4 3.4-3.4a1 1 0 113 3zM2 22l.414-.414"/>
  </svg>
  <!-- #endif -->
