...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M20 9V7a2 2 0 00-2-2h-6"/><path d="M15 2l-3 3 3 3m5 5v5a2 2 0 01-2 2H6a2 2 0 01-2-2V7a2 2 0 012-2h2"/>`
...
<template>
  ...
  >
    ...
    <path d="M20 9V7a2 2 0 00-2-2h-6"/><path d="M15 2l-3 3 3 3m5 5v5a2 2 0 01-2 2H6a2 2 0 01-2-2V7a2 2 0 012-2h2"/>
  </svg>
  <!-- #endif -->
