...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M3 3v16a2 2 0 002 2h16"/><path d="M7 16c.5-2 1.5-7 4-7 2 0 2 3 4 3 2.5 0 4.5-5 5-7"/>`
...
<template>
  ...
  >
    ...
    <path d="M3 3v16a2 2 0 002 2h16"/><path d="M7 16c.5-2 1.5-7 4-7 2 0 2 3 4 3 2.5 0 4.5-5 5-7"/>
  </svg>
  <!-- #endif -->
