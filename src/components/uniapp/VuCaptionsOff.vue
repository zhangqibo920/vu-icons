...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M10.5 5H19a2 2 0 012 2v8.5M17 11h-.5m2.5 8H5a2 2 0 01-2-2V7a2 2 0 012-2M2 2l20 20M7 11h4m-4 4h2.5"/>`
...
<template>
  ...
  >
    ...
    <path d="M10.5 5H19a2 2 0 012 2v8.5M17 11h-.5m2.5 8H5a2 2 0 01-2-2V7a2 2 0 012-2M2 2l20 20M7 11h4m-4 4h2.5"/>
  </svg>
  <!-- #endif -->
