...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M10 10.01h.01m-.01 4h.01m3.99-4h.01m-.01 4h.01M18 6v11.5M6 6v12"/><rect width="20" height="12" x="2" y="6" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M10 10.01h.01m-.01 4h.01m3.99-4h.01m-.01 4h.01M18 6v11.5M6 6v12"/><rect width="20" height="12" x="2" y="6" rx="2"/>
  </svg>
  <!-- #endif -->
