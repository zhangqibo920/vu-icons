...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M21.2 8.4c.5.38.8.97.8 1.6v10a2 2 0 01-2 2H4a2 2 0 01-2-2V10a2 2 0 01.8-1.6l8-6a2 2 0 012.4 0z"/><path d="M22 10l-8.97 5.7a1.94 1.94 0 01-2.06 0L2 10"/>`
...
<template>
  ...
  >
    ...
    <path d="M21.2 8.4c.5.38.8.97.8 1.6v10a2 2 0 01-2 2H4a2 2 0 01-2-2V10a2 2 0 01.8-1.6l8-6a2 2 0 012.4 0z"/><path d="M22 10l-8.97 5.7a1.94 1.94 0 01-2.06 0L2 10"/>
  </svg>
  <!-- #endif -->
