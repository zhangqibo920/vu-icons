...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M19.929 18.629A1 1 0 0119 20H9a1 1 0 01-.928-1.371l2-5A1 1 0 0111 13h6a1 1 0 01.928.629zM6 3a2 2 0 012 2v2a2 2 0 01-2 2H5a1 1 0 01-1-1V4a1 1 0 011-1zm2 3h4a2 2 0 012 2v5"/>`
...
<template>
  ...
  >
    ...
    <path d="M19.929 18.629A1 1 0 0119 20H9a1 1 0 01-.928-1.371l2-5A1 1 0 0111 13h6a1 1 0 01.928.629zM6 3a2 2 0 012 2v2a2 2 0 01-2 2H5a1 1 0 01-1-1V4a1 1 0 011-1zm2 3h4a2 2 0 012 2v5"/>
  </svg>
  <!-- #endif -->
