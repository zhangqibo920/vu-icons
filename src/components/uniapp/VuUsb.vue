...
const bgStyle = computed(() => {
  ...
  const svgContent = `<circle cx="10" cy="7" r="1"/><circle cx="4" cy="20" r="1"/><path d="M4.7 19.3L19 5m2-2l-3 1 2 2zM9.26 7.68L5 12l2 5m3-3l5 2 3.5-3.5"/><path d="M18 12l1-1 1 1-1 1z"/>`
...
<template>
  ...
  >
    ...
    <circle cx="10" cy="7" r="1"/><circle cx="4" cy="20" r="1"/><path d="M4.7 19.3L19 5m2-2l-3 1 2 2zM9.26 7.68L5 12l2 5m3-3l5 2 3.5-3.5"/><path d="M18 12l1-1 1 1-1 1z"/>
  </svg>
  <!-- #endif -->
