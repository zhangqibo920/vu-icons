...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 6v6l3.644 1.822M16 19h6m-3-3v6M21.92 13.267a10 10 0 10-8.653 8.653"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 6v6l3.644 1.822M16 19h6m-3-3v6M21.92 13.267a10 10 0 10-8.653 8.653"/>
  </svg>
  <!-- #endif -->
