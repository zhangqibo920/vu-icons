...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M4 9.8V4a2 2 0 012-2h8a2.4 2.4 0 011.706.706l3.588 3.588A2.4 2.4 0 0120 8v12a2 2 0 01-2 2h-3"/><path d="M14 2v5a1 1 0 001 1h5M9 17v-2a2 2 0 00-4 0v2"/><rect width="8" height="5" x="3" y="17" rx="1"/>`
...
<template>
  ...
  >
    ...
    <path d="M4 9.8V4a2 2 0 012-2h8a2.4 2.4 0 011.706.706l3.588 3.588A2.4 2.4 0 0120 8v12a2 2 0 01-2 2h-3"/><path d="M14 2v5a1 1 0 001 1h5M9 17v-2a2 2 0 00-4 0v2"/><rect width="8" height="5" x="3" y="17" rx="1"/>
  </svg>
  <!-- #endif -->
