...
const name = 'VuArrowBigRightDash'
...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M11 9a1 1 0 001-1V5.061a1 1 0 011.811-.75l6.836 6.836a1.207 1.207 0 010 1.707l-6.836 6.835a1 1 0 01-1.811-.75V16a1 1 0 00-1-1H9a1 1 0 01-1-1v-4a1 1 0 011-1zM4 9v6"/>`
...
<template>
  ...
  >
    ...
    <path d="M11 9a1 1 0 001-1V5.061a1 1 0 011.811-.75l6.836 6.836a1.207 1.207 0 010 1.707l-6.836 6.835a1 1 0 01-1.811-.75V16a1 1 0 00-1-1H9a1 1 0 01-1-1v-4a1 1 0 011-1zM4 9v6"/>
  </svg>
  <!-- #endif -->
