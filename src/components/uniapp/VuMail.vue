...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M22 7l-8.991 5.727a2 2 0 01-2.009 0L2 7"/><rect width="20" height="16" x="2" y="4" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M22 7l-8.991 5.727a2 2 0 01-2.009 0L2 7"/><rect width="20" height="16" x="2" y="4" rx="2"/>
  </svg>
  <!-- #endif -->
