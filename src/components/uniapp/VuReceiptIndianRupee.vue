...
const name = 'VuReceiptIndianRupee'
...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1zm4 5h8"/><path d="M12 17.5L8 15h1a4 4 0 000-8m-1 4h8"/>`
...
<template>
  ...
  >
    ...
    <path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1zm4 5h8"/><path d="M12 17.5L8 15h1a4 4 0 000-8m-1 4h8"/>
  </svg>
  <!-- #endif -->
