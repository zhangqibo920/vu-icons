...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 22v-5m3-9V2m2 6a1 1 0 011 1v4a4 4 0 01-4 4h-4a4 4 0 01-4-4V9a1 1 0 011-1zM9 8V2"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 22v-5m3-9V2m2 6a1 1 0 011 1v4a4 4 0 01-4 4h-4a4 4 0 01-4-4V9a1 1 0 011-1zM9 8V2"/>
  </svg>
  <!-- #endif -->
