...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M2.37 11.223l8.372-6.777a2 2 0 012.516 0l8.371 6.777M21 15a1 1 0 011 1v2a1 1 0 01-1 1h-5.25M3 15a1 1 0 00-1 1v2a1 1 0 001 1h9"/><path d="M6.67 15l6.13 4.6a2 2 0 002.8-.4l3.15-4.2"/><rect width="20" height="4" x="2" y="11" rx="1"/>`
...
<template>
  ...
  >
    ...
    <path d="M2.37 11.223l8.372-6.777a2 2 0 012.516 0l8.371 6.777M21 15a1 1 0 011 1v2a1 1 0 01-1 1h-5.25M3 15a1 1 0 00-1 1v2a1 1 0 001 1h9"/><path d="M6.67 15l6.13 4.6a2 2 0 002.8-.4l3.15-4.2"/><rect width="20" height="4" x="2" y="11" rx="1"/>
  </svg>
  <!-- #endif -->
