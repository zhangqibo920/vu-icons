...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M14 6l4 4m-1-7h4v4m0-4l-7.75 7.75"/><circle cx="9" cy="15" r="6"/>`
...
<template>
  ...
  >
    ...
    <path d="M14 6l4 4m-1-7h4v4m0-4l-7.75 7.75"/><circle cx="9" cy="15" r="6"/>
  </svg>
  <!-- #endif -->
