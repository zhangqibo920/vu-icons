...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 22v-6m0-8V2M4 12H2m8 0H8m8 0h-2m8 0h-2m-5 7l-3 3-3-3m6-14l-3-3-3 3"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 22v-6m0-8V2M4 12H2m8 0H8m8 0h-2m8 0h-2m-5 7l-3 3-3-3m6-14l-3-3-3 3"/>
  </svg>
  <!-- #endif -->
