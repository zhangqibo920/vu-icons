...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M12 17v4m-4 0h8m-7-4l6.1-6.1a2 2 0 012.81.01L22 15"/><circle cx="8" cy="9" r="2"/><rect width="20" height="14" x="2" y="3" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 17v4m-4 0h8m-7-4l6.1-6.1a2 2 0 012.81.01L22 15"/><circle cx="8" cy="9" r="2"/><rect width="20" height="14" x="2" y="3" rx="2"/>
  </svg>
  <!-- #endif -->
