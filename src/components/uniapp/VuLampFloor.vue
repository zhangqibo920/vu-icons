...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 10v12m5.929-14.371A1 1 0 0117 9H7a1 1 0 01-.928-1.371l2-5A1 1 0 019 2h6a1 1 0 01.928.629zM9 22h6"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 10v12m5.929-14.371A1 1 0 0117 9H7a1 1 0 01-.928-1.371l2-5A1 1 0 019 2h6a1 1 0 01.928.629zM9 22h6"/>
  </svg>
  <!-- #endif -->
