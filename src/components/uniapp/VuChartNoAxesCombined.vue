...
const name = 'VuChartNoAxesCombined'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M12 16v5m4-7v7m4-11v11m2-18l-8.646 8.646a.5.5 0 01-.708 0L9.354 8.354a.5.5 0 00-.707 0L2 15m2 3v3m4-7v7"/>`
...
<template>
  ...
  >
    ...
    <path d="M12 16v5m4-7v7m4-11v11m2-18l-8.646 8.646a.5.5 0 01-.708 0L9.354 8.354a.5.5 0 00-.707 0L2 15m2 3v3m4-7v7"/>
  </svg>
  <!-- #endif -->
