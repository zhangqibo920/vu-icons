...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M14 22h4a2 2 0 002-2V8a2.4 2.4 0 00-.706-1.706l-3.588-3.588A2.4 2.4 0 0014 2H6a2 2 0 00-2 2v6"/><path d="M14 2v5a1 1 0 001 1h5M5 14a1 1 0 00-1 1v2a1 1 0 01-1 1 1 1 0 011 1v2a1 1 0 001 1m4 0a1 1 0 001-1v-2a1 1 0 011-1 1 1 0 01-1-1v-2a1 1 0 00-1-1"/>`
...
<template>
  ...
  >
    ...
    <path d="M14 22h4a2 2 0 002-2V8a2.4 2.4 0 00-.706-1.706l-3.588-3.588A2.4 2.4 0 0014 2H6a2 2 0 00-2 2v6"/><path d="M14 2v5a1 1 0 001 1h5M5 14a1 1 0 00-1 1v2a1 1 0 01-1 1 1 1 0 011 1v2a1 1 0 001 1m4 0a1 1 0 001-1v-2a1 1 0 011-1 1 1 0 01-1-1v-2a1 1 0 00-1-1"/>
  </svg>
  <!-- #endif -->
