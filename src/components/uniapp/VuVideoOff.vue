...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M10.66 6H14a2 2 0 012 2v2.5l5.248-3.062A.5.5 0 0122 7.87v8.196M16 16a2 2 0 01-2 2H4a2 2 0 01-2-2V8a2 2 0 012-2h2M2 2l20 20"/>`
...
<template>
  ...
  >
    ...
    <path d="M10.66 6H14a2 2 0 012 2v2.5l5.248-3.062A.5.5 0 0122 7.87v8.196M16 16a2 2 0 01-2 2H4a2 2 0 01-2-2V8a2 2 0 012-2h2M2 2l20 20"/>
  </svg>
  <!-- #endif -->
