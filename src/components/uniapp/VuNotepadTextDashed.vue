...
const name = 'VuNotepadTextDashed'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M8 2v4m4-4v4m4-4v4m0-2h2a2 2 0 012 2v2m0 4v2m0 4v2a2 2 0 01-2 2h-1m-4 0h-2m-4 0H6a2 2 0 01-2-2v-2m0-4v-2m0-4V6a2 2 0 012-2h2m0 6h6m-6 4h8m-8 4h5"/>`
...
<template>
  ...
  >
    ...
    <path d="M8 2v4m4-4v4m4-4v4m0-2h2a2 2 0 012 2v2m0 4v2m0 4v2a2 2 0 01-2 2h-1m-4 0h-2m-4 0H6a2 2 0 01-2-2v-2m0-4v-2m0-4V6a2 2 0 012-2h2m0 6h6m-6 4h8m-8 4h5"/>
  </svg>
  <!-- #endif -->
