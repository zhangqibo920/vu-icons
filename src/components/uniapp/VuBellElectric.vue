...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M18.518 17.347A7 7 0 0114 19m4.8-15A11 11 0 0120 9M9 9h.01"/><circle cx="20" cy="16" r="2"/><circle cx="9" cy="9" r="7"/><rect width="10" height="6" x="4" y="16" rx="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M18.518 17.347A7 7 0 0114 19m4.8-15A11 11 0 0120 9M9 9h.01"/><circle cx="20" cy="16" r="2"/><circle cx="9" cy="9" r="7"/><rect width="10" height="6" x="4" y="16" rx="2"/>
  </svg>
  <!-- #endif -->
