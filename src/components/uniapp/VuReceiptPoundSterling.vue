...
const name = 'VuReceiptPoundSterling'
...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1zm4 11h5"/><path d="M10 17V9.5a2.5 2.5 0 015 0M8 17h7"/>`
...
<template>
  ...
  >
    ...
    <path d="M4 2v20l2-1 2 1 2-1 2 1 2-1 2 1 2-1 2 1V2l-2 1-2-1-2 1-2-1-2 1-2-1-2 1zm4 11h5"/><path d="M10 17V9.5a2.5 2.5 0 015 0M8 17h7"/>
  </svg>
  <!-- #endif -->
