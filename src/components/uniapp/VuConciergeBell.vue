...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M3 20a1 1 0 01-1-1v-1a2 2 0 012-2h16a2 2 0 012 2v1a1 1 0 01-1 1zm17-4a8 8 0 10-16 0m8-12v4m-2-4h4"/>`
...
<template>
  ...
  >
    ...
    <path d="M3 20a1 1 0 01-1-1v-1a2 2 0 012-2h16a2 2 0 012 2v1a1 1 0 01-1 1zm17-4a8 8 0 10-16 0m8-12v4m-2-4h4"/>
  </svg>
  <!-- #endif -->
