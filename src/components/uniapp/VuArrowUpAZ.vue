...
const bgStyle = computed(() => {
  ...
  const svgContent = `<path d="M3 8l4-4 4 4M7 4v16M20 8h-5m0 2V6.5a2.5 2.5 0 015 0V10m-5 4h5l-5 6h5"/>`
...
<template>
  ...
  >
    ...
    <path d="M3 8l4-4 4 4M7 4v16M20 8h-5m0 2V6.5a2.5 2.5 0 015 0V10m-5 4h5l-5 6h5"/>
  </svg>
  <!-- #endif -->
