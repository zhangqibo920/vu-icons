...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<path d="M10.162 3.167A10 10 0 002 13a2 2 0 004 0v-1a2 2 0 014 0v4a2 2 0 004 0v-4a2 2 0 014 0v1a2 2 0 004-.006 10 10 0 00-8.161-9.826M20.804 14.869a9 9 0 01-17.608 0"/><circle cx="12" cy="4" r="2"/>`
...
<template>
  ...
  >
    ...
    <path d="M10.162 3.167A10 10 0 002 13a2 2 0 004 0v-1a2 2 0 014 0v4a2 2 0 004 0v-4a2 2 0 014 0v1a2 2 0 004-.006 10 10 0 00-8.161-9.826M20.804 14.869a9 9 0 01-17.608 0"/><circle cx="12" cy="4" r="2"/>
  </svg>
  <!-- #endif -->
