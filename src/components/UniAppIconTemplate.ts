...
const svgDataUri = computed(() => {
  ...
  const svgContent = `<!-- SVG_PATH_CONTENT -->`
  
  const svg = `<svg viewBox='<!-- VIEW_BOX -->' fill='none' stroke='${props.color}' stroke-width='2' stroke-linecap='round' stroke-linejoin='round' xmlns='http://www.w3.org/2000/svg' style='width:100%;height:100%;'>${spinNode}${svgContent}</svg>`
